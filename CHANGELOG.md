...
- Bug-073106 - Unable to save the banner record if a single language is enabled.
- Bug-073303 - Google Captcha v3 is showing errors continuously on contact us page
