...
('MSG_STRIPE_CONNECT_ACCOUNT_NOT_COMPLETE', 1, 'Your Account Setup Is Incomplete. {click-here} To Complete Your Account Setup.', '') ON DUPLICATE KEY UPDATE label_caption = VALUES(label_caption);
-- ---------Task 86672 Stripe Connect Changes ------ -- 
