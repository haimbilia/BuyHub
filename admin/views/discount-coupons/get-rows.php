            ...
            <li class="timeline-v4__item">
                ...
                <div class="timeline-v4__item-desc">
                    ...
                    <span class="timeline-v4__item-user-name">
                        <a href="javascript:void(0);" onclick="redirectUser(<?php echo $row['user_id']; ?>)" class="link link--dark timeline-v4__item-link" data-bs-toggle="tooltip" data-placement="top" title="<?php echo Labels::getLabel('LBL_BUYER', $siteLangId); ?>">
