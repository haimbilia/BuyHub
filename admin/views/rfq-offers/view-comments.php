...
<div class="modal-body form-edit">
    <div class="form-edit-body loaderContainerJs">
        <span class="lessContent<?php echo $offerId; ?>Js">
            <?php echo 200 < strlen($comments) ? substr($comments, 0, 200) . ' ... <button class="link-underline showMoreJs" data-row-id="' . $offerId . '">' . Labels::getLabel('LBL_SHOW_MORE') . '</button>' : $comments; ?>
        </span>
