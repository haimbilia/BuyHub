...
if (!empty($image) && isset($image['afile_id']) && $image['afile_id'] != -1) {
    ...
    $imgArr = [
        'url' => UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Image', 'testimonial', array($recordId, $image['afile_lang_id'], ImageDimension::VIEW_DEFAULT, $image['afile_id']), CONF_WEBROOT_FRONT_URL) . $uploadedTime, CONF_IMG_CACHE_TIME, '.jpg'),
