...
class UserSearch extends SearchBase
{
    ...
    public function includeAffiliateUserRevenue()
    {
        ...
        $cnd->attachCondition('utxn_type', '=', 'mysql_func_' . Transactions::TYPE_AFFILIATE_REFERRAL_ORDER, 'OR', true);
    ...
    public function addRatingsCount()
    {
        ...
        $srch->doNotCalculateRecords();
        $srch->doNotLimitRecords();
        $srch->addMultipleFields(['stemp.shop_user_id as spreview_seller_user_id', 'stemp.shop_avg_rating as avg_rating']);
