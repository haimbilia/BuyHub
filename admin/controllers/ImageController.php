...
class ImageController extends FatController
{
    ...
    public function product($recordId, $sizeType = '', $afile_id = 0)
    {
        ...
        $image_name = (isset($file_row['afile_physical_path']) && 0 < $file_row['afile_id']) ? AttachedFile::FILETYPE_PRODUCT_IMAGE_PATH . $file_row['afile_physical_path'] : '';
    ...
    {
        $file_row = AttachedFile::getAttachment(AttachedFile::FILETYPE_BADGE_REQUEST, $recordId);
        $image_name = (isset($file_row['afile_physical_path']) && 0 < $file_row['afile_id']) ? AttachedFile::FILETYPE_BADGE_REQUEST_IMAGE_PATH . $file_row['afile_physical_path'] : '';
        $image_name = AttachedFile::setNamePrefix($image_name, $sizeType);
