...
class MpesaSettingsController extends PaymentMethodSettingsController
{
    public static function form(int $langId)
    {
        ...
        $reqShortCodeFld = new FormFieldRequirement('shortcode', Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_SHORTCODE', $langId));
        $reqShortCodeFld->setRequired(true);

        $frm->addTextBox(Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_PASSKEY', $langId), 'passkey');
        $passKeyFld = new FormFieldRequirement('passkey', Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_PASSKEY', $langId));
        $passKeyFld->setRequired(false);
        $reqPassKeyFld = new FormFieldRequirement('passkey', Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_PASSKEY', $langId));
        $reqPassKeyFld->setRequired(true);


        $frm->addTextBox(Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_SHORTCODE', $langId), 'live_shortcode');
        $liveShortCodeFld = new FormFieldRequirement('live_shortcode', Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_SHORTCODE', $langId));
        $liveShortCodeFld->setRequired(false);
        $reqLiveShortCodeFld = new FormFieldRequirement('live_shortcode', Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_SHORTCODE', $langId));
        $reqLiveShortCodeFld->setRequired(true);

        $frm->addTextBox(Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_PASSKEY', $langId), 'live_passkey');
        $livePassKeyFld = new FormFieldRequirement('live_passkey', Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_PASSKEY', $langId));
        $livePassKeyFld->setRequired(false);
        $reqLivePassKeyFld = new FormFieldRequirement('live_passkey', Labels::getLabel('FRM_LIPA_NA_MPESA_ONLINE_PASSKEY', $langId));
