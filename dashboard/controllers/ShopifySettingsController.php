...
class ShopifySettingsController extends DataMigrationSettingsController
{
    ...
    public static function form($langId)
    {
        ...
        $frm->addHtml('info', 'info', '<p class="text-muted">'.Labels::getLabel('LBL_SHOPIFY_SINGLE_VENDOR_PLUGIN_INFO', $langId).'</br>'. strtr(Labels::getLabel('LBL_PLEASE_VISIT_{link}_TO_CREATE_APP', $langId),['{link}'=>'https://{storename}.myshopify.com/admin/apps/private']).'</p></br>');
