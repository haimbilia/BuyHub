...
class ShipStationShippingSettingsController extends ShippingServicesSettingsController
{
    public static function form($langId)
    {
        ...
        $fld = $frm->addHtml('', 'sync_address', HtmlHelper::addButtonHtml(Labels::getLabel("BTN_SYNC_DEFAULT_ADDRESS", $langId), 'button', 'sync_address', 'btn btn-outline-brand', 'syncDefaultAddressId(' . UserAuthentication::getLoggedUserId() . ')'));
