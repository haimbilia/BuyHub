...
class ShippingZoneRatesController extends SellerBaseController
{
    ...
    private function getForm($zoneId = 0, $rateId = 0)
    {
        ...
        $fld = $frm->addRequiredField(Labels::getLabel('FRM_RATE_NAME', $this->siteLangId), 'shiprate_identifier');
        ...
        $fld = $frm->addSubmitButton('', 'btn_submit', Labels::getLabel('BTN_SAVE', $this->siteLangId));
        //$fldCancel = $frm->addButton('', 'btn_cancel', Labels::getLabel('BTN_CANCEL', $this->siteLangId));
        return $frm;
    }
