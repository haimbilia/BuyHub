...
<?php if (!empty($icon)) { ?>
    <div class="uploaded-img ms-2 uploadedImage--js">
        <div class="logothumb">
            ...
            <img src="<?php echo UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Image', 'badgeIcon', array($icon['afile_record_id'], $icon['afile_lang_id'], "THUMB", $icon['afile_screen']), CONF_WEBROOT_FRONTEND) . $uploadedTime, CONF_IMG_CACHE_TIME, '.jpg'); ?>" title="<?php echo $icon['afile_name']; ?>" alt="<?php echo $icon['afile_name']; ?>">
