	...
	<div class="">
		<div class="js-hero-slider hero-slider" dir="<?php echo CommonHelper::getLayoutDirection(); ?>">
			<?php foreach ($slides as $slide) {
					...
					foreach ($slideArr as $slideScreen) {
						...
						switch ($slideScreen['afile_screen']) {
							case applicationConstants::SCREEN_MOBILE:
								$mobile_url = UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Image', 'slide', array($slide['slide_id'], applicationConstants::SCREEN_MOBILE, $siteLangId, 'MOBILE'), CONF_WEBROOT_FRONTEND) . $uploadedTime, CONF_IMG_CACHE_TIME, '.jpg') . ",";
								break;
							case applicationConstants::SCREEN_IPAD:
								$tablet_url = UrlHelper::getCachedUrl(
									UrlHelper::generateFileUrl('Image', 'slide', array($slide['slide_id'], applicationConstants::SCREEN_IPAD, $siteLangId, 'TABLET'), CONF_WEBROOT_FRONTEND) . $uploadedTime,
									CONF_IMG_CACHE_TIME,
									'.jpg'
								) . ",";
								break;
							case applicationConstants::SCREEN_DESKTOP:
								$defaultUrl =  UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Image', 'slide', array($slide['slide_id'], applicationConstants::SCREEN_DESKTOP, $siteLangId, 'DESKTOP'), CONF_WEBROOT_FRONTEND) . $uploadedTime, CONF_IMG_CACHE_TIME, '.jpg');
				...
				if ($defaultUrl == '') {
					$defaultUrl = UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Image', 'slide', array($slide['slide_id'], applicationConstants::SCREEN_DESKTOP, $siteLangId, 'DESKTOP'), CONF_WEBROOT_FRONTEND), CONF_IMG_CACHE_TIME, '.jpg');
				}
