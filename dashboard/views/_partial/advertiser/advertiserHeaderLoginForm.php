...
<?php 
	...
	$loginFrm->addHtml('','forgotPassword','<a class="link forgot" href="'.UrlHelper::generateUrl('GuestUser', 'forgotPasswordForm',[], CONF_WEBROOT_FRONTEND).'">'.Labels::getLabel('LBL_Forgot_Password?',$siteLangId).'</a>');
