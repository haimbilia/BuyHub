                        ...
                        <i class="icn icn--dashboard">
                            <svg class="svg">
                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-header.svg#dashboard"
                                    href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-header.svg#dashboard">
                                </use>
                            </svg></i></a>
                </li>
                        ...
                        href="<?php echo UrlHelper::generateUrl('Home'); ?>"><i class="icn icn--home">
                            <svg class="svg">
                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-header.svg#back-home"
                                    href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-header.svg#back-home">
                                </use>
                            </svg></i></a></li>
                        ...
                        href="<?php echo UrlHelper::generateUrl('Shops', 'view', array($shop_id)); ?>"><i
                            ...
                            <svg class="svg">
                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-header.svg#manage-shop"
                                    href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-header.svg#manage-shop">
                                </use>
                            </svg></i></a></li>
                <?php } ?>
            </ul>
                ...
                <a data-org-url="<?php echo UrlHelper::generateUrl('Account', 'Messages', array(), '', null, false, $getOrgUrl); ?>"
                    ...
                    <i class="icn"><svg class="svg bell-shake-delay">
                            <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-header.svg#notification"
                                href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-header.svg#notification">
                            </use>
                        </svg>
                    </i>
