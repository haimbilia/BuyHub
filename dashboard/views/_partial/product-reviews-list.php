            ...
            <?php if ($canSubmitFeedback) { ?>
                <div class="col-md-4">
                    <div class="box box--white rounded p-3 have-you">
                        ...
                        <a class="btn btn-brand btn-sm" href="<?php echo UrlHelper::generateUrl('Reviews', 'write', array($product_id), CONF_WEBROOT_FRONTEND); ?>"><?php echo Labels::getLabel('Lbl_Write_a_Review', $siteLangId); ?></a>
                    </div>
                </div>
            <?php } ?>
        </div>
