...
<div class="col-md-4">
    <div class="ml-md-4">
                ...
                <ul>
                    ...
                    <li>
                        <span class="label">
                            ...
                            <a class="dotted" href="javascript:void(0)"
                                onclick="loadOpShippingCharges('<?php echo $orderDetail['order_id']; ?>', <?php echo OrderProduct::CHARGE_TYPE_SHIPPING; ?>)">
                    ...
                    <li>
                        <span class="label">
                            ...
                            <a class="dotted" href="javascript:void(0)"
                                onclick="loadOpTaxCharges('<?php echo $orderDetail['order_id']; ?>', <?php echo OrderProduct::CHARGE_TYPE_TAX; ?>)">
                                <?php echo Labels::getLabel('LBL_Tax_Charges', $siteLangId); ?>
                            </a>
                            <?php } ?>
                        </span>
                        <span
                            class="value"><?php echo CommonHelper::displayMoneyFormat($totalTax, true, false, true, false, true); ?></span>
                    </li>
                    <?php } ?>
                    <li>
                    ...
                    <li class="discounted">
                        <span
                            class="label"><?php echo Labels::getLabel('LBL_VOLUME/LOYALTY_DISCOUNT', $siteLangId);  ?></span>
                        <span class="value">
        ...
        <?php } ?>
        <div class="order-block">
            <h4 class="dropdown-toggle-custom collapsed" data-toggle="collapse" data-target="#order-block2"
                aria-expanded="false" aria-controls="order-block2">
                <?php echo Labels::getLabel('LBL_Billing_ADDRESS', $siteLangId); ?>: <i
                    class="dropdown-toggle-custom-arrow"></i></h4>
        ...
        <div class="order-block">
            <h4 class="dropdown-toggle-custom collapsed" data-toggle="collapse" data-target="#order-block3"
                aria-expanded="false" aria-controls="order-block3">
        ...
        ?>
        <div class="order-block">
            <h4 class="dropdown-toggle-custom collapsed" data-toggle="collapse" data-target="#order-block7"
                aria-expanded="false" aria-controls="order-block3">
        ...
        <div class="order-block">
            <h4 class="dropdown-toggle-custom collapsed" data-toggle="collapse" data-target="#order-block5"
                aria-expanded="false" aria-controls="order-block3">
        ...
        ?>
        <div class="order-block">
            <h4 class="dropdown-toggle-custom collapsed" data-toggle="collapse" data-target="#order-block4"
                aria-expanded="false" aria-controls="order-block3">
                ...
                <div class="order-block-data">
                    <div class="list-specification">
                        <ul>
                            <li>
                                <span
                                    class="label"><?php echo Labels::getLabel('LBL_BUSSINESS_NAME', $siteLangId); ?></span>
                            ...
                            <li>
                                <span
                                    class="label"><?php echo Labels::getLabel('LBL_BANK_BRANCH', $siteLangId); ?></span>
                            ...
                            <li>
                                <span
                                    class="label"><?php echo Labels::getLabel('LBL_IFSC_/_MICR', $siteLangId); ?></span>
                            ...
                            <li>
                                <span
                                    class="label"><?php echo Labels::getLabel('LBL_OTHER_NOTES', $siteLangId); ?></span>
        ...
        <div class="order-block">
            <h4 class="dropdown-toggle-custom collapsed" data-toggle="collapse" data-target="#order-block6"
                aria-expanded="false" aria-controls="order-block3">
                ...
                <div class="order-block-data">
                    <div class="list-specification">
                        ...
                        <ul>
                            <li>
                                <span
                                    class="label"><?php echo Labels::getLabel('LBL_Date_Added', $siteLangId); ?></span>
