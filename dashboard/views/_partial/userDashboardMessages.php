	...
	<div class="card-body ">
		<div class="messages-list">
			<ul>
				...
				?>
					<li>
						<div class="msg_db"><img src="<?php echo UrlHelper::generateFileUrl('Image', 'user', array($row['message_from_user_id'], ImageDimension::VIEW_THUMB, true), CONF_WEBROOT_FRONTEND); ?>" alt="<?php echo $row['message_from_name']; ?>"></div>
						<div class="msg__desc">
