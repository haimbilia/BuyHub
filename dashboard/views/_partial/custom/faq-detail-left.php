...
foreach($list as $listItem){
	...
	<div class="faqs-wrapper">
	  ...
	  <div class="gap"> </div>
	  <div class=""><!-- <a href="<?php echo UrlHelper::generateUrl('Custom','faq',[], CONF_WEBROOT_FRONTEND); ?>" class="btn btn-brand ripplelink"><?php echo Labels::getLabel( 'LBL_Track_Refund', $siteLangId)?></a> --></div>
    </div>
