        ...
        <div class="block--empty m-auto text-center">
            ...
            <ul class="links--inline">
                <?php $inc = 0; foreach ($top_searched_keywords as $record) {
                    ...
                    <li><a href="<?php echo UrlHelper::generateUrl('products', 'search', array( 'keyword-'.$record['searchitem_keyword']), CONF_WEBROOT_FRONTEND); ?>"><?php echo $record['searchitem_keyword']?> </a> </li>
                <?php } ?>
            </ul>
            <?php endif; ?>
        </div>
