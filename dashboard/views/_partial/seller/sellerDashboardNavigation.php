            ...
            <ul>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel('LBL_Shop', $siteLangId); ?></span></div>
                </li>
                ...
                <li class="menu__item <?php echo ($controller == 'seller' && $action == 'shop') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Manage_Shop', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#manage-shop"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#manage-shop">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Manage_Shop', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                            ...
                            <i class="icn shop">
                                <svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-products"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-products">
                                    </use>
                                </svg>
                            </i>
                            <span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Shop_Inventory', $siteLangId); ?></span>
                        </a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'producttags') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Product_Tags', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#product-tags"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#product-tags">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Product_Tags', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'options') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Product_Options', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-options"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-options">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Product_Options', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li
                    class="menu__item <?php echo ($controller == 'seller' && ($action == 'taxcategories' || $action == 'taxrules')) ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Tax_Categories', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-tax-category"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-tax-category">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Tax_Categories', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <?php if ($userPrivilege->canViewSellerRequests(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'sellerrequests' && $action == 'index') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Requests', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#requests"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#requests">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Requests', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel('LBL_Shipping', $siteLangId); ?></span></div>
                </li>
                ...
                <li class="menu__item <?php echo ($controller == 'shippingprofile') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner">
                        <a title="<?php echo Labels::getLabel('LBL_Shipping_Profiles', $siteLangId); ?>"
                            ...
                            <i class="icn shop">
                                <svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#shipping-profile"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#shipping-profile">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Shipping_Profiles', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li class="menu__item <?php echo ($controller == 'shippingpackages') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner">
                        <a title="<?php echo Labels::getLabel('LBL_Shipping_Packages', $siteLangId); ?>"
                            ...
                            <i class="icn shop">
                                <svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#shipping-package"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#shipping-package">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Shipping_Packages', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <li class="divider"></li>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel('LBL_Sales', $siteLangId); ?></span></div>
                </li>
                <?php if ($userPrivilege->canViewSales(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'sales') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a title="<?php echo Labels::getLabel('LBL_Orders', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Orders', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <?php if ($userPrivilege->canViewCancellationRequests(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'ordercancellationrequests') ? 'is-active' : '' ?>">
                    <div class="menu__item__inner"><a
                            ...
                            <i class="icn shop"><svg class="svg">
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel("LBL_Order_Cancellation_Requests", $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <?php if ($userPrivilege->canViewReturnRequests(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && ($action == 'orderreturnrequests' || $action == 'vieworderreturnrequest')) ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Order_Return_Requests', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel("LBL_Order_Return_Requests", $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <li class="divider"></li>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel('LBL_Promotions', $siteLangId); ?></span>
                    </div>
                </li>
                <?php if ($userPrivilege->canViewSpecialPrice(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'specialprice') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner">
                        <a title="<?php echo Labels::getLabel('LBL_Special_Price', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#special-price"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#special-price">
                                    </use>
                                </svg>
                            </i>
                            <span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Special_Price', $siteLangId); ?></span>
                        </a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'volumediscount') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Volume_Discount', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('Seller', 'volumeDiscount'); ?>">
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#volume-discount"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#volume-discount">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Volume_Discount', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <?php if ($userPrivilege->canViewBuyTogetherProducts(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'upsellproducts') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Buy_Together_Products', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('Seller', 'upsellProducts'); ?>">
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#buy-together-products"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#buy-together-products">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Buy_Together_Products', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <?php if ($userPrivilege->canViewRelatedProducts(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'relatedproducts') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Related_Products', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('Seller', 'RelatedProducts'); ?>">
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#related-products"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#related-products">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Related_Products', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <?php 
                ...
                <li
                    class="menu__item <?php echo ($controller == strtolower($pluginData['plugin_code'])) ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner">
                        <a title="<?php echo $pluginData['plugin_name']; ?>"
                            ...
                            <i class="icn shop">
                                <svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-promotions"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-promotions">
                                    </use>
                                </svg>
                            </i>
                ...
                <li
                    class="menu__item <?php echo ($controller == 'badges' && current($_GET) == 'badges/list/1') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner">
                        <a title="<?php echo Labels::getLabel('LBL_BADGES_LINKING', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('Badges', 'list', [Badge::TYPE_BADGE]); ?>">
                            <i class="fa fa-award icn"></i>
                            <span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_BADGES', $siteLangId); ?></span>
                        </a>
                    </div>
                </li>
                <li
                    class="menu__item <?php echo ($controller == 'badges' && current($_GET) == 'badges/list/2') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner">
                        <a title="<?php echo Labels::getLabel('LBL_RIBBONS_LINKING', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('Badges', 'list', [Badge::TYPE_RIBBON]); ?>">
                            <i class="fas fa-shapes icn"></i>
                            <span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_RIBBONS', $siteLangId); ?></span>
                        </a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel('LBL_OMNI_CHANNEL_MANAGEMENT', $siteLangId);?></span>
                    </div>
                </li>
                <?php
                    foreach ($marketPlaceChannels as $channel) { 
                        ...
                        ?>
                <li
                    class="menu__item <?php echo ($controller == strtolower($channel['plugin_code'])) ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner">
                        <a title="<?php echo $channel['plugin_name'];?>"
                            href="<?php echo UrlHelper::generateUrl($channel['plugin_code']); ?>">
                            <i class="icn shop">
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel('LBL_SEO', $siteLangId); ?></span></div>
                </li>
                <?php if ($userPrivilege->canViewMetaTags(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'productseo') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner">
                        <a title="<?php echo Labels::getLabel('LBL_Meta_Tags', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#meta-tags"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#meta-tags">
                                    </use>
                                </svg>
                            </i>
                            <span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Meta_Tags', $siteLangId); ?></span>
                        </a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li
                    class="menu__item <?php echo ($controller == 'seller' && $action == 'producturlrewriting') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_URL_Rewriting', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#url-rewriting"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#url-rewriting">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_URL_Rewriting', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <li class="divider"></li>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel('LBL_Subscription', $siteLangId); ?></span>
                    </div>
                </li>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && ($action == 'subscriptions' || $action == 'viewsubscriptionorder')) ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_My_Subscriptions', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-my-subscriptions"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-my-subscriptions">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel("LBL_My_Subscriptions", $siteLangId); ?></span></a>
                    </div>
                </li>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && ($action == 'packages')) ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-subscription-packages"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-subscription-packages">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Subscription_Packages', $siteLangId); ?></span></a>
                    </div>
                </li>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && ($action == 'selleroffers')) ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Subscription_Offers', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Subscription_Offers', $siteLangId); ?></span></a>
                    </div>
                </li>
                <li class="divider"></li>
                <?php } ?>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel("LBL_Sales_Report", $siteLangId); ?></span>
                    </div>
                </li>
                <?php if ($userPrivilege->canViewSalesReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'reports' && $action == 'salesreport') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Sales_Over_Time', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Sales_Over_Time', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <?php if ($userPrivilege->canViewCatalogReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'catalogreport' && $action == 'index') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Products', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('CatalogReport', 'index'); ?>">
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report">
                                    </use>
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Products', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel("LBL_Financial_Report", $siteLangId); ?></span>
                    </div>
                </li>
                <li
                    class="menu__item <?php echo ($controller == 'productprofitreport' && $action == 'index') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Profit_by_products', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('ProductProfitReport'); ?>">
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report">
                                    </use>
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Profit_by_products', $siteLangId); ?></span></a>
                    </div>
                </li>
                <li
                    class="menu__item <?php echo ($controller == 'payoutreport' && $action == 'index') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a title="<?php echo Labels::getLabel('LBL_Payout', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('PayoutReport'); ?>">
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report">
                                    </use>
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Payout', $siteLangId); ?></span></a>
                    </div>
                </li>
                <li
                    class="menu__item <?php echo ($controller == 'transactionreport' && $action == 'index') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Transaction_Report', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('TransactionReport'); ?>">
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-sales-report">
                                    </use>
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Transaction_Report', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel("LBL_INVENTORY_Reports", $siteLangId); ?></span>
                    </div>
                </li>
                <?php if ($userPrivilege->canViewInventoryReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'reports' && $action == 'productsinventory') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Products_Inventory', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-product-inventory"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-product-inventory">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Products_Inventory', $siteLangId); ?></span></a>
                    </div>
                </li>
                <li
                    class="menu__item <?php echo ($controller == 'reports' && $action == 'productsinventorystockstatus') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-product-inventory-stock"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-product-inventory-stock">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Products_Inventory_Stock_Status', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li
                    class="menu__item <?php echo ($controller == 'reports' && $action == 'productsperformance') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Products_Performance', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-product-performance"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-product-performance">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Products_Performance', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li
                    ...
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_My_Account', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel("LBL_My_Account", $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php if ($userParentId == UserAuthentication::getLoggedUserId()) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'seller' && ($action == 'users' || $action == 'userpermissions')) ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Sub_Users', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel("LBL_Sub_Users", $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li
                    ...
                    <div class="menu__item__inner"><a
                            ...
                            <i class="icn shop"><svg class="svg">
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel("LBL_Messages", $siteLangId); ?>
                ...
                <li
                    ...
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_My_Credits', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_My_Credits', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <li
                    ...
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_UPDATE_CREDENTIALS', $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_UPDATE_CREDENTIALS', $siteLangId); ?></span></a>
                    </div>
                </li>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel('LBL_Plugins', $siteLangId); ?></span></div>
                </li>
                <li
                    class="menu__item <?php echo ($controller == 'sellerplugins' && $action == 'index') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_DATA_MIGRATION', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('sellerPlugins', 'index', [Plugin::TYPE_DATA_MIGRATION]); ?>">
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#requests"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#requests">
                                    </use>
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_DATA_MIGRATION', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                ...
                <li class="menu__item">
                    <div class="menu__item__inner"> <span
                            class="menu-head"><?php echo Labels::getLabel('LBL_Import_Export', $siteLangId); ?></span>
                    </div>
                </li>
                <?php if (FatApp::getConfig('CONF_ENABLE_IMPORT_EXPORT', FatUtility::VAR_INT, 0)) { ?>
                <li
                    class="menu__item <?php echo ($controller == 'importexport' && ($action == 'index')) ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel('LBL_Import_Export', $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('ImportExport', 'index'); ?>"><i
                                class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-import-export"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-import-export">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Import_Export', $siteLangId); ?></span></a>
                    </div>
                </li>
                <?php } ?>
                <?php } ?>
