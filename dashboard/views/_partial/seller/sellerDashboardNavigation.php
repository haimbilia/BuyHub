...
<ul class="dashboard-menu">
    <?php if (
        ...
        <li class="dashboard-menu-item">
            ...
            <ul class="menu-sub menu-sub-accordion collapse" id="nav-shop" aria-labelledby="" data-parent="#dashboard-menu">
                <?php if ($userPrivilege->canViewShop(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'shop') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Manage_Shop', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'shop'); ?>">
                ...
                if (0 < $canAddCustomProd && $userPrivilege->canViewProductOptions(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'options') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Product_Options', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'options'); ?>">
                            <span class="menu-sub-title">
                ...
                <?php if (FatApp::getConfig('CONF_ENABLED_SELLER_CUSTOM_PRODUCT', FatUtility::VAR_INT, 0) && $userPrivilege->canViewTaxCategory(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && ($action == 'taxcategories' || $action == 'taxrules')) ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Tax_Categories', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'taxCategories'); ?>">
                ...
                <?php if ($userPrivilege->canViewSellerRequests(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'sellerrequests' && $action == 'index') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Requests', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('SellerRequests'); ?>">
                            <span class="menu-sub-title">
    ...
    <?php if (
        ...
        <li class="dashboard-menu-item">
            ...
            <ul class="menu-sub menu-sub-accordion collapse" id="nav-shipping" aria-labelledby="" data-parent="#dashboard-menu">
                <?php
                ...
                ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'shippingprofile') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Shipping_Profiles', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('shippingProfile'); ?>">
                ...
                <?php if ($userPrivilege->canViewShippingPackages(UserAuthentication::getLoggedUserId(), true) && FatApp::getConfig("CONF_PRODUCT_DIMENSIONS_ENABLE", FatUtility::VAR_INT, 1) && FatApp::getConfig('CONF_ENABLED_SELLER_CUSTOM_PRODUCT', FatUtility::VAR_INT, 0)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'shippingpackages') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Shipping_Packages', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('shippingPackages'); ?>">
                            <span class="menu-sub-title">
    ...
    <?php if (
        ...
        <li class="dashboard-menu-item">
            ...
            <ul class="menu-sub menu-sub-accordion collapse" id="nav-sales" aria-labelledby="" data-parent="#dashboard-menu">
                <?php if ($userPrivilege->canViewSales(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'sales') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Orders', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'Sales'); ?>">
                ...
                <?php if ($userPrivilege->canViewCancellationRequests(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'ordercancellationrequests') ? 'active' : '' ?>" title="<?php echo Labels::getLabel('LBL_Order_Cancellation_Requests', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'orderCancellationRequests'); ?>">
                ...
                <?php if ($userPrivilege->canViewReturnRequests(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && ($action == 'orderreturnrequests' || $action == 'vieworderreturnrequest')) ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Order_Return_Requests', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'orderReturnRequests'); ?>">
        ...
        <li class="dashboard-menu-item">
            ...
            <ul class="menu-sub menu-sub-accordion collapse" id="nav-promotions" aria-labelledby="" data-parent="#dashboard-menu">
                <?php if ($userPrivilege->canViewSpecialPrice(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'specialprice') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Special_Price', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'specialPrice'); ?>">
                ...
                <?php if ($userPrivilege->canViewVolumeDiscount(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'volumediscount') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Volume_Discount', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'volumeDiscount'); ?>">
                ...
                <?php if ($userPrivilege->canViewBuyTogetherProducts(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'upsellproducts') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Buy_Together_Products', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'upsellProducts'); ?>">
                ...
                <?php if ($userPrivilege->canViewRelatedProducts(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'relatedproducts') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Related_Products', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'RelatedProducts'); ?>">
                ...
                if ($userPrivilege->canViewAdvertisementFeed(UserAuthentication::getLoggedUserId(), true) && false !== $pluginData && !empty($pluginData) && 0 < $pluginData['plugin_active'] && $userPrivilege->canViewAdvertisementFeed(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == strtolower($pluginData['plugin_code'])) ? 'active' : ''; ?>" title="<?php echo $pluginData['plugin_name']; ?>" href="<?php echo UrlHelper::generateUrl($pluginData['plugin_code']); ?>">
                ...
                <?php if ($userPrivilege->canViewBadgeLinks(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'badges' && current($_GET) == 'badges/list/1') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_BADGES_LINKING', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Badges', 'list', [Badge::TYPE_BADGE]); ?>">
                            <span class="menu-sub-title"><?php echo Labels::getLabel('LBL_BADGES', $siteLangId); ?></span>
                        </a>

                    </li>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'badges' && current($_GET) == 'badges/list/2') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_RIBBONS_LINKING', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Badges', 'list', [Badge::TYPE_RIBBON]); ?>">
    ...
    if ($userPrivilege->canViewMarketplaceChannel(UserAuthentication::getLoggedUserId(), true) && 0 < count($marketPlaceChannels)) { ?>
        <li class="dashboard-menu-item">
            ...
            <ul class="menu-sub menu-sub-accordion collapse" id="nav-channel" aria-labelledby="" data-parent="#dashboard-menu">
                <?php
                ...
                ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == strtolower($channel['plugin_code'])) ? 'active' : ''; ?>" title="<?php echo $channel['plugin_name']; ?>" href="<?php echo UrlHelper::generateUrl($channel['plugin_code']); ?>">
    ...
    <?php if (
        ...
        <li class="dashboard-menu-item">
            ...
            <ul class="menu-sub menu-sub-accordion collapse" id="nav-seo" aria-labelledby="" data-parent="#dashboard-menu">
                <?php if ($userPrivilege->canViewMetaTags(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'productseo') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Meta_Tags', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'productSeo'); ?>">
                ...
                <?php if ($userPrivilege->canViewUrlRewriting(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && $action == 'producturlrewriting') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_URL_Rewriting', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'productUrlRewriting'); ?>">
    ...
    <?php if (FatApp::getConfig('CONF_ENABLE_SELLER_SUBSCRIPTION_MODULE') && $userPrivilege->canViewSubscription(UserAuthentication::getLoggedUserId(), true)) { ?>
        <li class="dashboard-menu-item">
            ...
            <ul class="menu-sub menu-sub-accordion collapse" id="nav-subscription" aria-labelledby="" data-parent="#dashboard-menu">
                <li class="menu-sub-item">
                    <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && ($action == 'subscriptions' || $action == 'viewsubscriptionorder')) ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_My_Subscriptions', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'subscriptions'); ?>">
                        <span class="menu-sub-title"><?php echo Labels::getLabel("LBL_My_Subscriptions", $siteLangId); ?></span></a>

                </li>
                <li class="menu-sub-item">
                    <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && ($action == 'packages')) ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Subscription_Packages', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('seller', 'Packages'); ?>">
                        <span class="menu-sub-title"><?php echo Labels::getLabel('LBL_Subscription_Packages', $siteLangId); ?></span></a>

                </li>
                <li class="menu-sub-item">
                    <a class="menu-sub-link navLinkJs <?php echo ($controller == 'seller' && ($action == 'selleroffers')) ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Subscription_Offers', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('seller', 'SellerOffers'); ?>">
    ...
    <?php if (
        ...
        <li class="dashboard-menu-item">
            ...
            <ul class="menu-sub menu-sub-accordion collapse" id="nav-sales-report" aria-labelledby="" data-parent="#dashboard-menu">
                <?php if ($userPrivilege->canViewSalesReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'reports' && $action == 'salesreport') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Sales_Over_Time', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Reports', 'SalesReport'); ?>">
        ...
        <?php if ($userPrivilege->canViewFinancialReport(UserAuthentication::getLoggedUserId(), true)) { ?>
            <li class="dashboard-menu-item">
                ...
                <ul class="menu-sub menu-sub-accordion collapse" id="nav-financial-report" aria-labelledby="" data-parent="#dashboard-menu">
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'productprofitreport' && $action == 'index') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Profit_by_products', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('ProductProfitReport'); ?>">
                            <span class="menu-sub-title"><?php echo Labels::getLabel('LBL_Profit_by_products', $siteLangId); ?></span>
                        </a>
                    </li>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'payoutreport' && $action == 'index') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Payout', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('PayoutReport'); ?>">
                            <span class="menu-sub-title"><?php echo Labels::getLabel('LBL_Payout', $siteLangId); ?></span></a>

                    </li>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'transactionreport' && $action == 'index') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Transaction_Report', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('TransactionReport'); ?>">
        ...
        <li class="dashboard-menu-item">
            ...
            <ul class="menu-sub menu-sub-accordion collapse" id="nav-inventory-report" aria-labelledby="" data-parent="#dashboard-menu">
                <?php if ($userPrivilege->canViewInventoryReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'reports' && $action == 'productsinventory') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Products_Inventory', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Reports', 'productsInventory'); ?>">
                            <span class="menu-sub-title"><?php echo Labels::getLabel('LBL_Products_Inventory', $siteLangId); ?></span></a>

                    </li>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'reports' && $action == 'productsinventorystockstatus') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Products_Inventory_Stock_Status', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Reports', 'productsInventoryStockStatus'); ?>">
                ...
                <?php if ($userPrivilege->canViewPerformanceReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="menu-sub-item">
                        <a class="menu-sub-link navLinkJs <?php echo ($controller == 'reports' && $action == 'productsperformance') ? 'active' : ''; ?>" title="<?php echo Labels::getLabel('LBL_Products_Performance', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Reports', 'ProductsPerformance'); ?>">
