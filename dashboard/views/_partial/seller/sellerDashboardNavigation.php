        ...
        <ul class="dashboard-menu">
            ...
            if (
                ...
                <li class="dashboard-menu-item">
                    ...
                    <ul class="dashboard-menu-level collapse" id="nav-shop" aria-labelledby="" data-parent="#nav-shop">
                        <?php if ($userPrivilege->canViewShop(UserAuthentication::getLoggedUserId(), true)) { ?>
                            <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'shop') ? 'is-active' : ''; ?>">
                                <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Manage_Shop', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'shop'); ?>">
                                    <i class="icn shop">
                                        <svg class="svg" width="24" height="24">
                                            <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#manage-shop">
                                            </use>
                        ...
                        <?php } ?>
                        <!-- <li class="dashboard-menu-item"><div class="dashboard-menu-inner"> <a class="dashboard-menu-link"  title="<?php echo Labels::getLabel('LBL_View_Shop', $siteLangId); ?>" target="_blank" href="<?php echo UrlHelper::generateUrl('Shops', 'view', array($shop_id)); ?>"><i class="icn shop"> <svg class="svg" width="24" height="24"><use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-view-shop"></use></svg>
                        ...
                        <?php if ($userPrivilege->canViewProducts(UserAuthentication::getLoggedUserId(), true)) { ?>
                            <li class="dashboard-menu-item <?php echo ($controller == 'seller' && ($action == 'customcatalogproductform' || $action == 'customproductform' || $action == 'catalog' || $action == 'products' || $action == 'customcatalogproducts')) ? 'is-active' : ''; ?>">
                                <div class="dashboard-menu-inner">
                                    <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Products', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('seller', 'products'); //echo UrlHelper::generateUrl('seller', 'catalog'); 
                                                                                                                                                ?>">
                                        <i class="icn shop">
                                            <svg class="svg" width="24" height="24">
                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#inventory">
                                                </use>
                                            </svg>
                                        </i>
                        ...
                        <?php if (User::canAddCustomProduct() && $userPrivilege->canViewProductTags(UserAuthentication::getLoggedUserId(), true)) { ?>
                            <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'producttags') ? 'is-active' : ''; ?>">
                                <div class="dashboard-menu-inner">
                                    <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Product_Tags', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'productTags'); ?>">
                                        <i class="icn shop"> <svg class="svg" width="24" height="24">
                        ...
                        if (0 < $canAddCustomProd && $userPrivilege->canViewProductOptions(UserAuthentication::getLoggedUserId(), true)) { ?>
                            <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'options') ? 'is-active' : ''; ?>">
                                <div class="dashboard-menu-inner">
                                    <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Product_Options', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'options'); ?>">
                                        <i class="icn shop"> <svg class="svg" width="24" height="24">
                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#options">
                                                </use>
                                            </svg>
                        ...
                        <?php if (FatApp::getConfig('CONF_ENABLED_SELLER_CUSTOM_PRODUCT', FatUtility::VAR_INT, 0) && $userPrivilege->canViewTaxCategory(UserAuthentication::getLoggedUserId(), true)) { ?>
                            <li class="dashboard-menu-item <?php echo ($controller == 'seller' && ($action == 'taxcategories' || $action == 'taxrules')) ? 'is-active' : ''; ?>">
                                <div class="dashboard-menu-inner"><a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Tax_Categories', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'taxCategories'); ?>">
                                        <i class="icn shop"> <svg class="svg" width="24" height="24">
                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#tax-categories">
                                                </use>
                                            </svg>
                        ...
                        <?php if ($userPrivilege->canViewSellerRequests(UserAuthentication::getLoggedUserId(), true)) { ?>
                            <li class="dashboard-menu-item <?php echo ($controller == 'sellerrequests' && $action == 'index') ? 'is-active' : ''; ?>">
                                <div class="dashboard-menu-inner"><a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Requests', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('SellerRequests'); ?>">
                                        <i class="icn shop"> <svg class="svg" width="24" height="24">
            ...
            <?php if (
                ...
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel('LBL_Shipping', $siteLangId); ?></span></div>
                </li>
                <?php
                ...
                ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'shippingprofile') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner">
                            <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Shipping_Profiles', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('shippingProfile'); ?>">
                                <i class="icn shop">
                                    <svg class="svg" width="24" height="24">
                ...
                <?php if ($userPrivilege->canViewShippingPackages(UserAuthentication::getLoggedUserId(), true) && FatApp::getConfig("CONF_PRODUCT_DIMENSIONS_ENABLE", FatUtility::VAR_INT, 1) && FatApp::getConfig('CONF_ENABLED_SELLER_CUSTOM_PRODUCT', FatUtility::VAR_INT, 0)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'shippingpackages') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner">
                            <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Shipping_Packages', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('shippingPackages'); ?>">
            ...
            <?php if (
                ...
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel('LBL_Sales', $siteLangId); ?></span></div>
                </li>
                <?php if ($userPrivilege->canViewSales(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'sales') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"><a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Orders', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'Sales'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                ...
                <?php if ($userPrivilege->canViewCancellationRequests(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'ordercancellationrequests') ? 'is-active' : '' ?>">
                        <div class="dashboard-menu-inner"><a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Order_Cancellation_Requests', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'orderCancellationRequests'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                ...
                <?php if ($userPrivilege->canViewReturnRequests(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'seller' && ($action == 'orderreturnrequests' || $action == 'vieworderreturnrequest')) ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"><a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Order_Return_Requests', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'orderReturnRequests'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
            ...
            <?php if (
                ...
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel('LBL_Promotions', $siteLangId); ?></span>
                    </div>
                </li>
                <?php if ($userPrivilege->canViewSpecialPrice(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'specialprice') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner">
                            <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Special_Price', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'specialPrice'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                ...
                <?php if ($userPrivilege->canViewVolumeDiscount(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'volumediscount') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"><a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Volume_Discount', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'volumeDiscount'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                ...
                <?php if ($userPrivilege->canViewBuyTogetherProducts(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'upsellproducts') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"><a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Buy_Together_Products', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'upsellProducts'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                ...
                <?php if ($userPrivilege->canViewRelatedProducts(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'relatedproducts') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"><a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Related_Products', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'RelatedProducts'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                ...
                if ($userPrivilege->canViewAdvertisementFeed(UserAuthentication::getLoggedUserId(), true) && false !== $pluginData && !empty($pluginData) && 0 < $pluginData['plugin_active'] && $userPrivilege->canViewAdvertisementFeed(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == strtolower($pluginData['plugin_code'])) ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner">
                            <a class="dashboard-menu-link" title="<?php echo $pluginData['plugin_name']; ?>" href="<?php echo UrlHelper::generateUrl($pluginData['plugin_code']); ?>">
                                <i class="icn shop">
                                    <svg class="svg" width="24" height="24">
                ...
                <?php if ($userPrivilege->canViewBadgeLinks(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'badges' && current($_GET) == 'badges/list/1') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner">
                            <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_BADGES_LINKING', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Badges', 'list', [Badge::TYPE_BADGE]); ?>">
                                <i class="icn shop">
                                    <svg class="svg" width="24" height="24">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#badges">
                                        </use>
                                    </svg>
                                </i>
                    ...
                    <li class="dashboard-menu-item <?php echo ($controller == 'badges' && current($_GET) == 'badges/list/2') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner">
                            <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_RIBBONS_LINKING', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Badges', 'list', [Badge::TYPE_RIBBON]); ?>">
                                <i class="icn shop">
                                    <svg class="svg" width="24" height="24">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#ribbons">
                                        </use>
                                    </svg>
                                </i>
            ...
            if ($userPrivilege->canViewMarketplaceChannel(UserAuthentication::getLoggedUserId(), true) && 0 < count($marketPlaceChannels)) { ?>
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel('LBL_OMNI_CHANNEL_MANAGEMENT', $siteLangId); ?></span></div>
                </li>
                <?php
                ...
                ?>
                    <li class="dashboard-menu-item <?php echo ($controller == strtolower($channel['plugin_code'])) ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner">
                            <a class="dashboard-menu-link" title="<?php echo $channel['plugin_name']; ?>" href="<?php echo UrlHelper::generateUrl($channel['plugin_code']); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
            ...
            <?php if (
                ...
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel('LBL_SEO', $siteLangId); ?></span></div>
                </li>
                <?php if ($userPrivilege->canViewMetaTags(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'productseo') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner">
                            <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Meta_Tags', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'productSeo'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                ...
                <?php if ($userPrivilege->canViewUrlRewriting(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'seller' && $action == 'producturlrewriting') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_URL_Rewriting', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'productUrlRewriting'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
            ...
            <?php if (FatApp::getConfig('CONF_ENABLE_SELLER_SUBSCRIPTION_MODULE') && $userPrivilege->canViewSubscription(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel('LBL_Subscription', $siteLangId); ?></span>
                    </div>
                </li>
                <li class="dashboard-menu-item <?php echo ($controller == 'seller' && ($action == 'subscriptions' || $action == 'viewsubscriptionorder')) ? 'is-active' : ''; ?>">
                    <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_My_Subscriptions', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'subscriptions'); ?>">
                            <i class="icn shop"> <svg class="svg" width="24" height="24">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#my-subscriptions">
                                    </use>
                                </svg>
                            </i><span class="menu-item__title"><?php echo Labels::getLabel("LBL_My_Subscriptions", $siteLangId); ?></span></a>
                    </div>
                </li>
                <li class="dashboard-menu-item <?php echo ($controller == 'seller' && ($action == 'packages')) ? 'is-active' : ''; ?>">
                    <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Subscription_Packages', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('seller', 'Packages'); ?>">
                            <i class="icn shop"> <svg class="svg" width="24" height="24">
                ...
                <li class="dashboard-menu-item <?php echo ($controller == 'seller' && ($action == 'selleroffers')) ? 'is-active' : ''; ?>">
                    <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Subscription_Offers', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('seller', 'SellerOffers'); ?>">
                            <i class="icn shop"> <svg class="svg" width="24" height="24">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#subscription-offers">
                                    </use>
                                </svg>
            ...
            <?php if (
                ...
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel("LBL_Sales_Report", $siteLangId); ?></span>
                    </div>
                </li>
                <?php if ($userPrivilege->canViewSalesReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'reports' && $action == 'salesreport') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Sales_Over_Time', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Reports', 'SalesReport'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#sales-over-time">
                                        </use>
                                    </svg>
                ...
                <?php if ($userPrivilege->canViewCatalogReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'catalogreport' && $action == 'index') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Products', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('CatalogReport', 'index'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                ...
                <?php if ($userPrivilege->canViewFinancialReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item">
                        <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel("LBL_Financial_Report", $siteLangId); ?></span>
                        </div>
                    </li>
                    <li class="dashboard-menu-item <?php echo ($controller == 'productprofitreport' && $action == 'index') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Profit_by_products', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('ProductProfitReport'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                    ...
                    <li class="dashboard-menu-item <?php echo ($controller == 'payoutreport' && $action == 'index') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Payout', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('PayoutReport'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#payout">
                                        </use>
                                    </svg>
                                </i><span class="menu-item__title"><?php echo Labels::getLabel('LBL_Payout', $siteLangId); ?></span></a>
                        </div>
                    </li>
                    <li class="dashboard-menu-item <?php echo ($controller == 'transactionreport' && $action == 'index') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Transaction_Report', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('TransactionReport'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#transaction-report">
                                        </use>
                                    </svg>
                ...
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel("LBL_INVENTORY_Reports", $siteLangId); ?></span>
                    </div>
                </li>
                <?php if ($userPrivilege->canViewInventoryReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'reports' && $action == 'productsinventory') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Products_Inventory', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Reports', 'productsInventory'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#products-inventory">
                                        </use>
                                    </svg>
                    ...
                    <li class="dashboard-menu-item <?php echo ($controller == 'reports' && $action == 'productsinventorystockstatus') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Products_Inventory_Stock_Status', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Reports', 'productsInventoryStockStatus'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#product-inventory-stock">
                                        </use>
                                    </svg>
                ...
                <?php if ($userPrivilege->canViewPerformanceReport(UserAuthentication::getLoggedUserId(), true)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'reports' && $action == 'productsperformance') ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Products_Performance', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Reports', 'ProductsPerformance'); ?>">
                                <i class="icn shop"> <svg class="svg" width="24" height="24">
            ...
            <?php } ?>
            <li class="dashboard-menu-item">
                <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel("LBL_Profile", $siteLangId); ?></span></div>
            </li>
            <li class="dashboard-menu-item <?php echo ($controller == 'account' && $action == 'profileinfo') ? 'is-active' : ''; ?>">
                <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_My_Account', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Account', 'ProfileInfo'); ?>">
                        <i class="icn shop"> <svg class="svg" width="24" height="24">
            ...
            <?php if ($userParentId == UserAuthentication::getLoggedUserId()) { ?>
                <li class="dashboard-menu-item <?php echo ($controller == 'seller' && ($action == 'users' || $action == 'userpermissions')) ? 'is-active' : ''; ?>">
                    <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Sub_Users', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Seller', 'Users'); ?>">
                            <i class="icn shop"> <svg class="svg" width="24" height="24">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#sub-users">
                                    </use>
                                </svg>
            ...
            <?php if ($userPrivilege->canViewMessages(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li class="dashboard-menu-item <?php echo ($controller == 'account' && ($action == 'messages' || strtolower($action) == 'viewmessages')) ? 'is-active' : ''; ?>">
                    <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Messages', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Account', 'Messages'); ?>">
                            <i class="icn shop"> <svg class="svg" width="24" height="24">
            ...
            <?php if ($userParentId == UserAuthentication::getLoggedUserId()) { ?>
                <li class="dashboard-menu-item <?php echo ($controller == 'account' && $action == 'credits') ? 'is-active' : ''; ?>">
                    <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_My_Credits', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Account', 'credits'); ?>">
                            <i class="icn shop"> <svg class="svg" width="24" height="24">
            ...
            <li class="dashboard-menu-item <?php echo ($controller == 'account' && $action == 'changeemailpassword') ? 'is-active' : ''; ?>">
                <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_UPDATE_CREDENTIALS', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('Account', 'changeEmailPassword'); ?>">
                        <i class="icn shop"> <svg class="svg" width="24" height="24">
            ...
            <?php if ($userPrivilege->canViewSellerPlugins(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li class="divider"></li>
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel('LBL_Plugins', $siteLangId); ?></span></div>
                </li>
                ...
                ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'sellerplugins' && $action == 'index' && is_array($params) && current($params) == $type) ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner">
                            <a class="dashboard-menu-link" title="<?php echo $name; ?>" href="<?php echo UrlHelper::generateUrl('sellerPlugins', 'index', [$type]); ?>">
                                <i class="icn shop">
                                    <svg class="svg" width="24" height="24">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#<?php echo PluginCommon::getPluginTypeIconClass($type); ?>"></use>
                                    </svg>
                                </i>
            ...
            <?php if ($userPrivilege->canViewImportExport(UserAuthentication::getLoggedUserId(), true)) { ?>
                <li class="divider"></li>
                <li class="dashboard-menu-item">
                    <div class="dashboard-menu-inner"> <span class="menu-head"><?php echo Labels::getLabel('LBL_Import_Export', $siteLangId); ?></span>
                    </div>
                </li>
                <?php if (FatApp::getConfig('CONF_ENABLE_IMPORT_EXPORT', FatUtility::VAR_INT, 0)) { ?>
                    <li class="dashboard-menu-item <?php echo ($controller == 'importexport' && ($action == 'index')) ? 'is-active' : ''; ?>">
                        <div class="dashboard-menu-inner"> <a class="dashboard-menu-link" title="<?php echo Labels::getLabel('LBL_Import_Export', $siteLangId); ?>" href="<?php echo UrlHelper::generateUrl('ImportExport', 'index'); ?>"><i class="icn shop"> <svg class="svg" width="24" height="24">
