            ...
            <?php foreach ($collection['categories'] as $category) { ?>
                    ...
                    <div class="top-categories">
                        ...
                        <div class="cat-img"><img loading='lazy' data-ratio="4:1"
                                src="<?php echo UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Category', 'banner', array($category['prodcat_id'] , $siteLangId, 'MEDIUM', applicationConstants::SCREEN_DESKTOP), CONF_WEBROOT_FRONTEND), CONF_IMG_CACHE_TIME, '.jpg'); ?>"
