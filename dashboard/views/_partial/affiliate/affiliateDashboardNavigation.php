    ...
    <div class="sidebar__content custom-scrollbar scroll scroll-y" id="scrollElement-js">
        <nav class="dashboard-menu">
            <ul>
                ...
                <li
                    class="menu__item <?php echo ($controller == 'affiliate' && $action == 'referredbyme') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel("LBL_Sharing", $siteLangId); ?>"
                            href="<?php echo UrlHelper::generateUrl('Affiliate', 'ReferredByMe'); ?>">
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-reffered"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-reffered">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel("LBL_My_Referral", $siteLangId); ?></span></a>
                    </div>
                </li> <?php
        } ?> <li
            ...
            ?> <li
                    class="menu__item <?php echo ($controller == 'account' && $action == 'messages') ? 'is-active' : ''; ?>">
                    <div class="menu__item__inner"><a
                            ...
                            <i class="icn shop"><svg class="svg">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-sidebar.svg#dash-messages"
                                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svgdash-messages">
                                    </use>
                                </svg>
                            </i><span
                                class="menu-item__title"><?php echo Labels::getLabel("LBL_Messages", $siteLangId); ?></span></a>
                    </div>
                </li> <?php
        } ?> <li
            ...
            ?> <li
                    ...
                    <div class="menu__item__inner"><a
                            title="<?php echo Labels::getLabel("LBL_Wishlist/Favorites", $siteLangId); ?>"
                            ...
                            <i class="icn shop"><svg class="svg">
                                ...
                                class="menu-item__title"><?php echo Labels::getLabel('LBL_Wishlist/Favorites', $siteLangId); ?></span></a>
                    </div>
                </li> <?php
        } ?>
                <li
