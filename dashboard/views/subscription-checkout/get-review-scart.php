...
<section class="section-checkout is-completed">
    <div class="selected-panel">
        ...
        <div class="selected-panel-action"><a href="javascript:void(0)" class="btn btn-brand btn-sm ripplelink reviewOrder"><?php echo Labels::getLabel('LBL_Review_Subscription_Details', $siteLangId);?></a></div>
    </div>
</section>
