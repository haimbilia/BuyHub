                        ...
                        <li class="box <?php echo $packageArrClass[$inc]." ".$selectedClass ?>">
                            <div class="box-inner">
                                <div class="name"><?php echo $package['spackage_name']; ?>
                                    <span><?php echo $package['spackage_text']; ?></span></div>
                                <div class="valid">
                                ...
                                <div class="trial">
                                    <ul>
                                        <li><span><?php echo CommonHelper::displayComissionPercentage($package[SellerPackages::DB_TBL_PREFIX.'commission_rate']); ?>%</span>
                                            <?php echo Labels::getLabel('LBL_Commision_rate', $siteLangId); ?></li>
                                ...
                                <div class="after-box">
                                  ...
                                  ?>
                                        <li>
                                            <label class="radio">
                                                <input
                                                    value="<?php echo $plan[SellerPackagePlans::DB_TBL_PREFIX.'id']; ?>"
                                  ...
                                  $buyPlanText = Labels::getLabel('LBL_Buy_Plan', $siteLangId);
                                    ...
                                    <a href="javascript:void(0)	"
                                        data-id="<?php echo $package[SellerPackages::DB_TBL_PREFIX.'id']; ?>"
                                        class="btn btn-brand btn-wide buySubscription--js "><?php echo $buyPlanText; ?></a>
                                </div>
                            </div>
