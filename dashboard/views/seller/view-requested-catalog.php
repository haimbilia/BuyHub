	...
	<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="field-set">
					<div class="caption-wraper">
						<label class="field_label"><h5><?php echo Labels::getLabel('LBL_Content',$siteLangId);?></h5></label>
					</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="field-set">
					<div class="caption-wraper">
						<label class="field_label"><h5><?php echo Labels::getLabel('LBL_Comment',$siteLangId);?></h5></label>
					</div>
					<div class="field-wraper">
						<div class="field_cover">
