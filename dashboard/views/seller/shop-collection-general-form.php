...
<div class="card-head">
    <h5 class="card-title">
        <a title="<?php echo Labels::getLabel('LBL_SHOP_COLLECTIONS', $siteLangId); ?>" class="back" href="javascript:void(0)" onclick="shopCollections()" data-bs-toggle="tootip">
            <svg class="svg" width="24" height="24">
                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-actions.svg#back">
                </use>
            </svg>
        </a>
        <?php echo Labels::getLabel('LBL_BACK_TO_LISTING', $siteLangId); ?>
    </h5>
</div>
<div class="card-body">
    <div class="row ">
