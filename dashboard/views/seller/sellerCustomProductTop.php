...
<ul>
    ...
    <li class="<?php echo ($activeTab == 'LINKS') ? 'is-active' : '';
                echo $inactive; ?>"><a href="javascript:void(0)" <?php if ($product_id > 0) { ?>onclick="customProductLinks(<?php echo $product_id; ?>)" <?php } ?>>
            <?php echo Labels::getLabel('LBL_Links', $siteLangId); ?></a></li>
    <li class="<?php echo ($activeTab == 'OPTIONS') ? 'is-active' : '';
                echo $inactive; ?>">
        <a href="javascript:void(0)" <?php if ($product_id > 0) { ?>onclick="sellerCustomProductOptions(<?php echo $product_id; ?>)" <?php } ?>>
            <?php echo Labels::getLabel('LBL_Options', $siteLangId); ?></a>
    </li>
    <li class="<?php echo ($activeTab == 'SPECIFICATIONS') ? 'is-active' : '';
                echo $inactive; ?>">
        <a href="javascript:void(0)" <?php if ($product_id > 0) { ?>onclick="sellerCustomProductSpecifications(<?php echo $product_id; ?>)" <?php } ?>>
            <?php echo Labels::getLabel('LBL_Specifications', $siteLangId); ?></a>
    </li>
</ul>