...
<div class="modal-header">
    <h5 class="modal-title"><?php echo Labels::getLabel('LBL_Shipping_tab', $siteLangId); ?></h5>
</div>
                    ...
                    <div class="row align-items-center shippingRow--js" id="shipping-row<?php echo $shipping_row; ?>">
                        <div class="col-lg-2">
                            <div class="field-set">
                                ...
                                <input type="text" name="product_shipping[<?php echo $shipping_row; ?>][country_name]" value="<?php echo $shipping["pship_country"] != "1" ? $shipping["country_name"] : "&#8594;" . Labels::getLabel('LBL_EveryWhere_Else', $siteLangId); ?>" placeholder="<?php echo Labels::getLabel('LBL_Destination_Country', $siteLangId) ?>" class="pship_country" data-row="<?php echo $shipping_row; ?>">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="field-set">
                        ...
                        <div class="col-lg-3">
                            <div class="field-set">
                                ...
                                <input type="text" name="product_shipping[<?php echo $shipping_row; ?>][processing_time]" value="<?php echo ShippingDurations::getShippingDurationTitle($shipping, $siteLangId) ?>" placeholder="<?php echo Labels::getLabel('LBL_Shipping_Service_Type', $siteLangId) ?>" class="pship_duration" data-row="<?php echo $shipping_row; ?>">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="field-set">
