                                            ...
                                            <?php if (count($transactions) > 0) {
                                                foreach ($transactions as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="txn__status"><span class="label label-inline <?php echo $txnStatusClassArr[$row['utxn_status']] ?>"><?php echo $txnStatusArr[$row['utxn_status']]; ?></span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php }
                                            ...
                                            <?php if (count($returnRequests) > 0) {
                                                foreach ($returnRequests as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="request__status"> <span class="label label-inline <?php echo $OrderRetReqStatusClassArr[$row['orrequest_status']]; ?>"><?php echo $OrderReturnRequestStatusArr[$row['orrequest_status']]; ?>
                                                                </span></div>
                                                        </td>
                                                        <td> <?php
