    ...
    <div class="content-wrapper content-space">
        <div class="content-header row">
            ...
            <div class="col-auto">
                <div class="btn-group">
                    <?php if (!$isShopActive) { ?>
                    <a href="<?php echo  UrlHelper::generateUrl('Seller', 'shop'); ?>"
                    ...
                    <a href="<?php echo UrlHelper::generateUrl('seller', 'customProductForm'); ?>"
                        class="btn btn-outline-brand btn-sm"><?php echo Labels::getLabel('LBL_Add_new_catalog', $siteLangId); ?></a>
                    <?php } ?>
                    <a href="<?php echo UrlHelper::generateUrl('seller', 'catalog'); ?>"
                        class="btn btn-outline-brand btn-sm"><?php echo Labels::getLabel('LBL_My_products', $siteLangId); ?></a>
                    <a href="<?php echo UrlHelper::generateUrl('seller', 'products'); ?>"
                        class="btn btn-outline-brand btn-sm"><?php echo Labels::getLabel('LBL_Shop_Inventory', $siteLangId); ?></a>
                    <?php } ?>
                </div>
            </div>
        </div>
        <div class="content-body">
            ...
            <div class="js-widget-scroll widget-scroll">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <i class="icn"><svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#my-sales"
                                            href="
                                ...
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Completed_Sales', $siteLangId); ?></span>
                                            ...
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Inprocess_Sales', $siteLangId); ?></span>
                                                <span class="total-numbers">
                                                    <?php
                    ...
                    <a href="<?php echo UrlHelper::generateUrl('Account', 'credits'); ?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <i class="icn"><svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#credits"
                                            href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#Credits">
                                        </use>
                                    </svg>
                                </i>
                            </div>
                                ...
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Total', $siteLangId); ?></span>
                                                <span
                                                    class="total-numbers"><?php echo CommonHelper::displayMoneyFormat($userBalance); ?></span>
                                            </li>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Credits_earned_today', $siteLangId); ?></span>
                                                <span
                                                    class="total-numbers"><?php echo CommonHelper::displayMoneyFormat($txnsSummary['total_earned']); ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <?php if ($userPrivilege->canViewSales(UserAuthentication::getLoggedUserId(), true)) { ?>
                <div class="widget widget-stats">
                    <a onClick="redirectfunc('<?php echo UrlHelper::generateUrl('Seller', 'Sales'); ?>', <?php echo FatApp::getConfig("CONF_DEFAULT_COMPLETED_ORDER_STATUS", null, ''); ?>)"
                        href="javaScript:void(0)">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title"><?php echo Labels::getLabel('LBL_Order', $siteLangId); ?></h5>
                                <i class="icn"><svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#order"
                                            href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#order">
                                        </use>
                                    </svg>
                                </i>
                            </div>
                                ...
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Completed_Orders', $siteLangId); ?></span>
                                                <span class="total-numbers">
                                                    <?php
                                            ...
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Pending_Orders', $siteLangId); ?></span>
                                                <span class="total-numbers">
                    ...
                    <a href="<?php echo UrlHelper::generateUrl('Seller', 'subscriptions'); ?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <i class="icn"><svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#messages"
                                            href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#messages">
                                        </use>
                                    </svg>
                                </i>
                            </div>
                                ...
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            ...
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Remaining', $siteLangId); ?></span>
                                                <span class="total-numbers"><?php echo $pendingDaysForCurrentPlan; ?>
                                                    <?php echo Labels::getLabel('LBL_Days', $siteLangId); ?></span>
                                            </li>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Allowed_Products', $siteLangId); ?></span>
                                                <span
                                                    class="total-numbers"><?php echo ($remainingAllowedProducts > 0) ? $remainingAllowedProducts : 0; ?></span>
                                            </li>
                                            <?php } else { ?>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Subscription_Name', $siteLangId); ?></span>
                                                <span class="total-numbers"><?php echo $subscriptionName; ?></span>
                                            </li>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Expires_On', $siteLangId); ?></span>
                                                <span
                                                    class="total-numbers"><?php echo (isset($subscriptionTillDate)) ? $subscriptionTillDate : ''; ?></span>
                                            </li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                    ...
                    <a href="<?php echo UrlHelper::generateUrl('Seller', 'orderReturnRequests'); ?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <i class="icn"><svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#refund"
                                            href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#refund">
                                        </use>
                                    </svg>
                                </i>
                            </div>
                                ...
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Refunded_Orders', $siteLangId); ?></span>
                                                <span
                                                    class="total-numbers"><?php echo isset($ordersStats['refundedOrderCount']) ? FatUtility::int($ordersStats['refundedOrderCount']) : 0; ?></span>
                                            </li>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Refunded_Amount', $siteLangId); ?></span>
                                                <span class="total-numbers">
                                                    <?php
                ...
                <div class="widget widget-stats">
                    <a onClick="redirectfunc('<?php echo UrlHelper::generateUrl('Seller', 'Sales'); ?>', <?php echo FatApp::getConfig("CONF_DEFAULT_CANCEL_ORDER_STATUS", null, ''); ?>)"
                        href="javaScript:void(0)">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <i class="icn"><svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#cancel"
                                            href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#cancel">
                                        </use>
                                    </svg>
                                </i>
                            </div>
                                ...
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Cancelled_Orders', $siteLangId); ?></span>
                                                <span
                                                    class="total-numbers"><?php echo isset($ordersStats['cancelledOrderCount']) ? FatUtility::int($ordersStats['cancelledOrderCount']) : 0; ?></span>
                                            </li>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Cancelled_Orders_Amount', $siteLangId); ?></span>
                                                <span class="total-numbers">
                                                    <?php
            ...
            <div class="row">
                ...
                <div class="col-xl-6 mb-4">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="action">
                                <a href="<?php echo UrlHelper::generateUrl('seller', 'sales'); ?>"
                                    class="link"><?php echo Labels::getLabel('Lbl_View_All', $siteLangId); ?></a>
                            </div>
                            <?php } ?>
                        </div>
                        <div class="card-body ">
                ...
                $prodName.= $row['op_selprod_title'].'<br/>';
                                            ...
                                            <td>
                                                <div class="item">
                                                    <figure class="item__pic"><a
                                                            href="<?php echo $prodOrBatchUrl; ?>"><img
                                                                src="<?php echo $prodOrBatchImgUrl; ?>"
                                                                title="<?php echo $row['op_product_name']; ?>"
                                                    ...
                                                    <div class="item__description">
                                                        ...
                                                        <div class="item__title">
                                                            <a title="<?php echo $row['op_selprod_title']; ?>"
                                                                href="<?php echo $prodOrBatchUrl; ?>"><?php echo $row['op_selprod_title']; ?></a>
                                                        </div>
                                                        <?php } else { ?>
                                                        <div class="item__sub_title">
                                                            <?php echo $row['op_product_name']; ?>
                                                            <a title="<?php echo $row['op_product_name']; ?>"
                                                                href="<?php echo $prodOrBatchUrl; ?>"><?php echo $row['op_product_name']; ?>
                                                            </a>
                                                        </div>
                                                        <?php } ?>
                                                        ...
                                                        <div class="item__specification">
                                                            <span
                                                                class="label label-inline <?php echo $classArr[$row['orderstatus_color_class']]; ?>">
                                                                <?php
                                            ...
                                            <td>
                                                <ul class="actions">
                                                    <li><a title="<?php echo Labels::getLabel('LBL_View_Order', $siteLangId); ?>"
                                                            href="<?php echo $orderDetailUrl; ?>"><i
                                                                class="fa fa-eye"></i></a></li>
                                                    <?php if (!in_array($row["op_status_id"], $notAllowedStatues)) { ?>
                                                    <li><a href="<?php echo UrlHelper::generateUrl('seller', 'cancelOrder', array($row['op_id'])); ?>"
                                                            title="<?php echo Labels::getLabel('LBL_Cancel_Order', $siteLangId); ?>"><i
                                ...
                                <table class="table table-justified">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="txn__status"><span
                                                        class="label label-inline <?php echo $txnStatusClassArr[$row['utxn_status']] ?>"><?php echo $txnStatusArr[$row['utxn_status']]; ?></span>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php }
                                        ...
                                        <tr>
                                            <td>
                                                <div class="item__description">
                                                    ...
                                                    <div class="item__title">
                                                        <a title="<?php echo Labels::getLabel('LBL_Invoice_number', $siteLangId); ?>"
                                            ...
                                            <td>
                                                <div class="request__status"> <span
                                                        class="label label-inline <?php echo $OrderRetReqStatusClassArr[$row['orrequest_status']]; ?>"><?php echo $OrderReturnRequestStatusArr[$row['orrequest_status']]; ?>
                                                    </span></div>
                                            </td>
                                            <td> <?php
                                                ...
                                                <ul class="actions">
                                                    <li>
                                                        <a title="<?php echo Labels::getLabel('LBL_View_Request', $siteLangId); ?>"
                                                            href="<?php echo $url; ?>">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </li>
                                ...
                                <table class="table table-justified">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="label label-inline <?php echo $cancelReqStatusClassArr[$row['ocrequest_status']]; ?>">
