                    ...
                    <form name="frmProductSpec" method="post" id="frm_fat_id_frmProductSpec" class="form form--horizontal" onsubmit="setupCustomCatalogSpecification(this,<?php echo $preqId; ?>); return(false);">
                        ...
                        if (!empty($translatorSubscriptionKey)) { ?>
                            <div class="row justify-content-end">
                                <div class="col-auto">
                                    <input class="btn btn-outline-gray btn-sm" type="button" value="<?php echo Labels::getLabel('LBL_AUTOFILL_LANGUAGE_DATA', $siteLangId); ?>" onclick="autofillLangData($(this), $('form#frm_fat_id_frmProductSpec'))" data-action="<?php echo UrlHelper::generateUrl('seller', 'getTranslatedData'); ?>">
                                </div>
                            </div>
                            <?php }
                        $totalSpec = 0;
                                                ...
                                                <div class="field-set">
                                                    ...
                                                    <div class="field-wraper">
                                                        <div class="field_cover">
                                                            ...
                                                            ?>
                                                            <input class="psec-name-js <?php echo 'layout--' . Language::getLayoutDirection($langId); ?> <?php echo $class; ?>" title="<?php echo Labels::getLabel('LBL_Specification_Name', $siteLangId) ?>" value="<?php echo $specValue; ?>" type="text" name="prod_spec_name[<?php echo $langId ?>][<?php echo $specKey; ?>]">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="field-set">
                                                    ...
                                                    <div class="field-wraper">
                                                        <div class="field_cover">
                                                            ...
                                                            ?>
                                                            <input class="<?php echo 'layout--' . Language::getLayoutDirection($langId); ?> <?php echo $class; ?>" title="<?php echo Labels::getLabel('LBL_Specification_Value', $siteLangId) ?>" type="text" value="<?php echo $specValue; ?>" name="prod_spec_value[<?php echo $langId ?>][<?php echo $specKey; ?>]">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
