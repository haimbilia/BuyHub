                                ...
                                <?php if (!empty($easyEcomSellerToken)) { ?>
                                    ...
                                    <div class="d-flex justify-content-center mb-3">
                                        ...
                                        <p>
                                            ...
                                            <i class='fa fa-info-circle spn_must_field align-middle' data-bs-toggle='tooltip' data-placement='top' title='<?php echo Labels::getLabel('MSG_YOU_CAN_TURN_OFF_AUTO_SYNC_FEATURE_TO_RESTRICT_SYNCING_PRODUCTS_AND_ORDERS_TO_EASYECOM.', $siteLangId); ?>'></i>
                                        </p>
                                    </div>
                                    <a class="btn btn-primary btn-lg" href="<?php echo $loginUrl; ?>" style="background-color: #27ae60; border-color: #27ae60;">
