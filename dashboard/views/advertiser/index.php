            ...
            <div class="js-widget-scroll widget-scroll">
                                    ...
                                    <div class="stats-number">
                                        <ul>
                                            <li>
                                                ...
                                                <span
                                                    class="total-numbers"><?php echo CommonHelper::displayMoneyFormat($walletBalance);?></span>
                                            </li>
                                            <li>
                                                <span
                ...
                <div class="widget widget-stats">
                    <a href="javascript:void(0)"
                        onClick="redirectToPromotions('<?php echo UrlHelper::generateUrl('advertiser', 'promotions');?>')">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">
                                    <?php echo Labels::getLabel('LBL_Active_Promotions', $siteLangId);?></h5>
                                <i class="icn"><svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite-stats.svg#speaker"
                                            href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite-stats.svg#speaker">
                                        </use>
                                    </svg>
                                </i>
                            </div>
                                ...
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Total_Active_promotions', $siteLangId);?></span>
                                                <span class="total-numbers"><?php echo $totActivePromotions; ?></span>
                                            </li>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Active_promotions_Expense', $siteLangId);?></span>
                                                <span
                                                    class="total-numbers"><?php echo CommonHelper::displayMoneyFormat($activePromotionChargedAmount);?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <a href="<?php echo UrlHelper::generateUrl('advertiser', 'promotionCharges');?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <i class="icn">
                                    <svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite-stats.svg#give-money"
                                            href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite-stats.svg#give-money">
                                        </use>
                                    </svg>
                                </i>
                            </div>
                                ...
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Total_Promotions', $siteLangId);?></span>
                                                <span
                                                    class="total-numbers"><?php echo CommonHelper::displayMoneyFormat($totPromotions); ?></span>
                                            </li>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Total_Expense', $siteLangId);?></span>
                                                <span
                                                    class="total-numbers"><?php echo CommonHelper::displayMoneyFormat($totChargedAmount);?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12 col-md-12 mb-4">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="action">
                                <a href="<?php echo UrlHelper::generateUrl('advertiser', 'promotions');?>"
                                ...
                                <table class="table table-justified">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="actions">
                                                    <li><a title="<?php echo Labels::getLabel('LBL_Analytics', $siteLangId); ?>"
                                                            href="<?php echo UrlHelper::generateUrl('advertiser', 'analytics', array($row['promotion_id'])); ?>"><i
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="label label-inline <?php echo $txnStatusClassArr[$row['utxn_status']];?>">
