...
<div class="modal-body form-edit"> <!-- Closing tag must be added inside the files who include this file. -->
    <div class="form-edit-head">
        <nav class="nav nav-tabs">
            <a class="nav-link <?php echo $activeInstTab; ?>" href="javascript:void(0);" onclick="getInstructions('<?php echo $actionType; ?>'); return false;" title="<?php echo Labels::getLabel('LBL_INSTRUCTIONS', $siteLangId); ?>">
