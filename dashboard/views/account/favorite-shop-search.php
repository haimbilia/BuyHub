    ...
    <div class="card card-tabs">
        <div class="card-head">
            <nav class="nav nav-tabs">
                <a class="nav-link navLinkJs favtProductsJs" onclick="<?php echo $function; ?>" href="javascript:void(0);" id="tab-wishlist">
                    <?php echo $label; ?>
                </a>
                <a class="nav-link active navLinkJs favtShopsJs" onclick="searchFavoriteShop();" href="javascript:void(0);"><?php echo Labels::getLabel('LBL_Shops', $siteLangId); ?></a>
            </nav>
        </div>
        <div class="card-body">
            <div class="featured">
                    ...
                    ?>
                        <div class="featured-item">
                            <div class="featured-item__body">
                                ...
                                <div class="featured_logo"><img src="<?php echo UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('image', 'shopLogo', array($shop['shop_id'], $siteLangId, "THUMB", 0, false), CONF_WEBROOT_FRONTEND) . $uploadedTime, CONF_IMG_CACHE_TIME, '.jpg'); ?>" alt="<?php echo $shop['shop_name']; ?>"></div>
