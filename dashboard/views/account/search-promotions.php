            ...
            switch ($key) {
                case 'promotion_image':
                    if ($row['promotion_type'] == Promotions::PROMOTE_PRODUCT) {
                        ...
                        $td->appendElement('plaintext', array(), '<div class="avtar"><img src="' . UrlHelper::generateUrl('image', 'shop', array($product['promotion_shop_id'], 'MINI', 0, 0, $siteLangId), CONF_WEBROOT_FRONTEND) . '" alt="' . $row["shop_identifier"] . '"></div>', true);
