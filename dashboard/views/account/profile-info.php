                ...
                <div class="col-auto">
                    <div class="btn-group">
                        ...
                        <?php if ($showSellerActivateButton) { ?>
                            <a href="<?php echo UrlHelper::generateUrl('Seller'); ?>" class="btn btn-outline-brand btn-sm panel__head_action" title="<?php echo Labels::getLabel('LBL_Activate_Seller_Account', $siteLangId); ?>">
