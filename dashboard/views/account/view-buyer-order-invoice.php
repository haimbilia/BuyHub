                            ...
                            <td>
                                ...
                                foreach ($childOrderDetail as $childOrder) { ?>
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tbody>
                                            <tr>
                                                <td style="padding:15px;vertical-align: top; border:none;" width="30%">
                                                ...
                                                <td style="text-align: center;  border:none;" width="70%">
                                                    <table width="100%" border="0" cellpadding="10px" cellspacing="0" style="">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="padding:10px;text-align: left;border:1px solid #ddd;border-bottom:none;border-right:none;font-size: 12px;background-color: #f0f0f0;">*<?php echo Labels::getLabel('LBL_Appropriated_product-wise_and_Rate_applicable_thereunder', $siteLangId); ?></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
