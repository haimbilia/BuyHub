				...
				<ul class="image-listing">
					<?php foreach ($batchImgArr as $batchImage) { ?>
						<li><?php echo $language[$batchImage['afile_lang_id']] ?>
							<div class="uploaded--image"><img src="<?php echo UrlHelper::generateFileUrl('Image', 'BatchProduct', array($batchImage['afile_record_id'], $batchImage['afile_lang_id'], ImageDimension::VIEW_THUMB), CONF_WEBROOT_FRONTEND); ?>"></div>
