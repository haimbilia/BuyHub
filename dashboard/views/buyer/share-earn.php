                ...
                <div class="card-body">
                    <div class="invite-box">
                        ...
                        <ul class="social-invites ">
                            <li>
                                <a href="javascript:void(0);" title="<?php echo Labels::getLabel('MSG_COPY_TO_CLIPBOARD', $siteLangId); ?>" onclick="copy($(this))" data-url="<?php echo $referralTrackingUrl; ?>" class="btn">
                                    <span class="icon">
                                        <i class="svg--icon">
                                            <svg class="svg">
