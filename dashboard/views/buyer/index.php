    ...
    <div class="content-wrapper content-space">
        <div class="content-header row">
            <div class="col"> <?php $this->includeTemplate('_partial/dashboardTop.php'); ?> <h2
                    class="content-header-title"><?php echo Labels::getLabel('LBL_Dashboard', $siteLangId); ?></h2>
            </div>
            <div class="col-auto">
                <div class="btn-group">
                    <a href="<?php echo UrlHelper::generateUrl('Account', 'wishlist');?>"
                        class="btn btn-outline-brand btn-sm"><?php echo Labels::getLabel('LBL_Favorites', $siteLangId);?>
                    </a>
                    <a href="<?php echo UrlHelper::generateUrl('Account', 'myAddresses');?>"
                            ...
                            <div class="card-body ">
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li><span
                                                    class="total"><?php echo Labels::getLabel('LBL_Total_Credits', $siteLangId); ?></span>
                                                <span
                            ...
                            <div class="card-body ">
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li><span
                                                    class="total"><?php echo Labels::getLabel('LBL_Total_Orders', $siteLangId); ?></span>
                    ...
                    <a href="<?php echo UrlHelper::generateUrl('buyer', 'rewardPoints'); ?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <i class="icn">
                                    <svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#rewards-change"
                                            href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-stats.svg#rewards-change">
                                        </use>
                                    </svg>
                                </i>
                            </div>
                            <div class="card-body ">
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li><span
                                                    class="total"><?php echo Labels::getLabel('LBL_Current_Reward_Points', $siteLangId); ?></span>
                                                <span class="total-numbers"> <?php echo $totalRewardPoints; ?></span>
                                            </li>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Currency_Value', $siteLangId); ?></span>
                                        ...
                                        <tr>
                                                    ...
                                                    <div class="item__description">
                                                        ...
                                                        <div class="item__title">
                                                            ...
                                                            <a title="<?php echo $row['op_product_name']; ?>"
                                                                href="<?php echo $prodOrBatchUrl; ?>"><?php echo $prodName; ?></a>
                                                        </div>
                                                        ...
                                                        <?php if ($row['op_selprod_options'] != '') { ?> <div
                                                            class="item__specification">
                                            ...
                                            <td>
                                                <div class="item__specification">
                                                    <span
                                                        class="item__price"><?php echo CommonHelper::displayMoneyFormat(CommonHelper::orderProductAmount($row)); ?></span>
                                                    <br>
                                                    <span
                                            ...
                                            <td>
                                                <ul class="actions">
                                                    ...
                                                    <?php if ($canCancelOrder) { ?> <li><a
                                                            href="<?php echo UrlHelper::generateUrl('buyer', 'orderCancellationRequest', array($row['op_id'])); ?>"
                                                            title="<?php echo Labels::getLabel('LBL_Cancel_Order', $siteLangId); ?>"><i
                                                                class="fas fa-times"></i></a></li> <?php } ?>
                                                    <?php if ($canSubmitFeedback && $isValidForReview) { ?> <li><a
                                                            href="<?php echo UrlHelper::generateUrl('Buyer', 'orderFeedback', array($row['op_id'])); ?>"
                                                            title="<?php echo Labels::getLabel('LBL_Feedback', $siteLangId); ?>"><i
                                                                class="fa fa-star"></i></a>
                                                    </li> <?php } ?> <?php if ($canReturnRefund) { ?> <li><a
                                                            href="<?php echo UrlHelper::generateUrl('Buyer', 'orderReturnRequest', array($row['op_id'])); ?>"
                                                            title="<?php echo Labels::getLabel('LBL_Refund', $siteLangId); ?>"><i
                                                                class="fas fa-dollar-sign"></i></a></li> <?php } ?>
                                                </ul>
                                            </td>
                                        </tr> <?php }
                                            } else { ?> <tr>
                ...
                <div class="col-lg-6 col-md-12 mb-4">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="action"> <?php if (count($offers) > 0) { ?> <a
                            ...
                            <div class="js-scrollable table-wrap scroll scroll-x">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <figure class="item__pic"><img
                                                        src="<?php echo UrlHelper::generateFullUrl('Image', 'coupon', array($row['coupon_id'], $siteLangId, 'NORMAL')) ?>"
                                                        alt="<?php echo ($row['coupon_title'] == '') ? $row['coupon_identifier'] : $row['coupon_title']; ?>">
                                                </figure>
                                            </td>
                                            <td>
                                                <div class="item__description">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title "><?php echo Labels::getLabel('LBL_Return_requests', $siteLangId); ?>
                                ...
                                <a href="<?php echo UrlHelper::generateUrl('buyer', 'orderReturnRequests'); ?>"
                                    class="link"><?php echo Labels::getLabel('Lbl_View_All', $siteLangId); ?></a>
                            </div> <?php } ?>
                        </div>
                        <div class="card-body ">
                                ...
                                <table class="table table-justified">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($returnRequests as $row) {
                                                ...
                                                <div class="item__description">
                                                    ...
                                                    <div class="item__title">
                                                        <a title="<?php echo Labels::getLabel('LBL_Invoice_number', $siteLangId); ?>"
                                                            href="<?php echo UrlHelper::generateUrl('Buyer', 'viewOrder', array($row['order_id'], $row['op_id'])); ?>"
                                                            href="<?php echo $orderDetailUrl; ?>"><?php echo $row['op_invoice_number']; ?></a>
                                                    </div>
                                                    <div class="item__title">
                                                        <?php if ($row['op_selprod_title'] != '') { ?> <a
                                                            title="<?php echo $row['op_selprod_title']; ?>"
                                            ...
                                            <td>
                                                <span
                                                    class="label label-inline <?php echo $OrderRetReqStatusClassArr[$row['orrequest_status']]; ?>">
                                                ...
                                                <ul class="actions">
                                                    <li>
                                                        <a title="<?php echo Labels::getLabel('LBL_View_Request', $siteLangId); ?>"
                                                            href="<?php echo UrlHelper::generateUrl('Buyer', 'ViewOrderReturnRequest', array($row['orrequest_id'])); ?>">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </li>
                                                </ul>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <?php if (count($cancellationRequests) > 0) { ?> <div class="action">
                                <a href="<?php echo UrlHelper::generateUrl('buyer', 'orderCancellationRequests'); ?>"
                                    class="link"><?php echo Labels::getLabel('Lbl_View_All', $siteLangId); ?></a>
                            </div> <?php } ?>
                        </div>
                        <div class="card-body ">
