...
<main id="main-area" class="main">
    <div class="content-wrapper content-space">
        <div class="content-header row">
            <div class="col"> <?php $this->includeTemplate('_partial/dashboardTop.php'); ?> <h2
                    class="content-header-title"><?php echo Labels::getLabel('LBL_Affiliate', $siteLangId); ?></h2>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <i class="icn"><svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#credits"
                                            href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#Credits"></use>
                                    </svg>
                                </i>
                            </div>
                            <div class="card-body ">
                    ...
                    <a href="<?php echo UrlHelper::generateUrl('Account', 'credits'); ?>">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <i class="icn">
                                    <svg class="svg">
                                        <use xlink:href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#revenue"
                                            href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#revenue"></use>
                                    </svg>
                                </i>
                            </div>
                            <div class="card-body ">
                                <div class="stats">
                                    <div class="stats-number">
                                        <ul>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Total_Revenue', $siteLangId);?></span>
                                                <span
                                                    class="total-numbers"><?php echo CommonHelper::displayMoneyFormat($userRevenue);?></span>
                                            </li>
                                            <li>
                                                <span
                                                    class="total"><?php echo Labels::getLabel('LBL_Today_Revenue', $siteLangId);?></span>
                                                <span
                                                    class="total-numbers"><?php echo CommonHelper::displayMoneyFormat($todayRevenue);?></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="card-body ">
                            <div class="stats">
                                <a href="javascript:void(0)" class="btn btn-outline-brand btn-sm"
                                    title="<?php echo $affiliateTrackingUrl; ?>"
    ...
    ?> <div class="widget widget-stats">
        ...
        ?> <div class="action">
                                <a href="<?php echo UrlHelper::generateUrl('affiliate', 'referredByMe'); ?>"
                                            ...
                                            <td>
                                                <div class="item__description">
                                                    <div class="item__date"
                                                        title="<?php echo Labels::getLabel('Lbl_Registered_on', $siteLangId)?>">
                                            ...
                                            <td>
                                                <div class="item__description">
                                                    ...
                                                    <div class="item__title"
                                                        title="<?php echo Labels::getLabel('Lbl_Txn._Id', $siteLangId)?>">
