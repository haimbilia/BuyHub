                ...
                <div class="widget-scroll">
                    ...
                    <div class="widget widget-stats">
                        <div class="card card-commerce card-commerce-bg" style="background-image: url(<?php echo CONF_WEBROOT_URL; ?>/images/card-commerce-bg-3.png);">
                            ...
                            <div class="card-body pt-0 ">
                                <div class="stats">
                                    <button type="button" class="btn btn-outline-gray btn-sm mt-4" title="<?php echo Labels::getLabel('MSG_COPY_TO_CLIPBOARD', $siteLangId); ?>" data-url="<?php echo $referralTrackingUrl; ?>" onclick="copyText(this, false)"><?php echo Labels::getLabel('LBL_Click_to_copy', $siteLangId) ?></button>
                                </div>
                            </div>
                        </div>
                    </div> <?php
