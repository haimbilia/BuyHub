            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-head">
                        ...
                        <div class="btn-group">
                            <a class="btn btn-outline-gray btn-sm formActionBtn-js disabled" title="<?php echo Labels::getLabel('LBL_UNLINK', $siteLangId); ?>" onclick="unlinkproducts(<?php echo $adsBatchId; ?>)" href="javascript:void(0)"><?php echo Labels::getLabel('LBL_UNLINK', $siteLangId); ?></a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div id="listing">
