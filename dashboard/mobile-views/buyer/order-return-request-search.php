...
foreach ($requests as $key => $request) {
    ...
    $requests[$key]['product_image_url'] = UrlHelper::generateFullUrl('image', 'product', array($request['selprod_product_id'], "THUMB", $request['op_selprod_id'], 0, $siteLangId), CONF_WEBROOT_FRONTEND);
}
$data = array(
    'requests' => $requests,
    'page' => $page,
