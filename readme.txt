...
====================TV-9.4.0.20220201===================== 
    ...
    => 064321 - Admin:Paid amount's details are showing incorrect on the view-subscription-order at the seller's end, in case the admin enabled the "adjust amount" option for the subscription from the settings section. 
