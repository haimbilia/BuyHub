...
class ShippingServicesBase extends PluginBase
{
    ...
    public function getSystemOrder(int $opId): array
    {
        ...
        $srch->joinTable(Orders::DB_TBL_ORDER_PAYMENTS, 'LEFT JOIN', 'o.order_no = opaym.opayment_order_no', 'opaym');
