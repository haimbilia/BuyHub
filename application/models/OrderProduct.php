...
class OrderProduct extends MyAppModel
{
    ...
    public static function pendingForReviews($userId, $langId = 0)
    {
        ...
        $srch->addMultipleFields(array('op_id', 'op_selprod_id', 'op_order_id', 'selprod_title', 'selprod_product_id', 'order_id', 'order_no', 'order_user_id', 'op_qty', 'op_unit_price', 'op_selprod_options'));
