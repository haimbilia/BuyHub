...
class OrderProduct extends MyAppModel
{
    ...
    public function setupSettings()
    {
        ...
        $data = array(
            ...
            'op_tax_after_discount' => FatApp::getConfig('CONF_TAX_AFTER_DISOCUNT', FatUtility::VAR_INT, 0),
            'op_product_inclusive_tax' => FatApp::getConfig('CONF_PRODUCT_INCLUSIVE_TAX', FatUtility::VAR_INT, 0),
        );
