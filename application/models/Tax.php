...
class Tax extends MyAppModel
{
    ...
    public function createInvoice(array $childOrderInfo): bool
    {
        ...
        $toAddress = Tax::formatAddress($toAddress, 'order');
