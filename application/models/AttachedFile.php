...
class AttachedFile extends MyAppModel
{
    ...
    public static function getMultipleAttachments($fileType, $recordId, $recordSubid = 0, $langId = 0, $displayUniversalImage = true, $screen = 0, $size = 0, $haveSubIdZero = false)
    {
        ...
        $attr = ['afile_id','afile_type','afile_record_id','afile_record_subid','afile_lang_id','afile_screen','afile_physical_path','afile_name','afile_attribute_title','afile_attribute_alt','afile_aspect_ratio','afile_display_order','afile_updated_at','afile_downloaded_times'];
