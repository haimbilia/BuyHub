...
<div class="cookie-alert">
    <h5><?php echo Labels::getLabel('LBL_Your_Cookie_Preferences', $siteLangId); ?></h5>

    <div><?php echo Labels::getLabel('LBL_What_is_a_cookie?', $siteLangId); ?></div>
    <div><?php echo Labels::getLabel('LBL_What_is_a_cookie_Information', $siteLangId); ?></div>
    ...
    <div>
        ...
        <div><?php echo Labels::getLabel('LBL_Functional_Cookies_Information', $siteLangId); ?></div>
    </div>
    ...
    <div>
        ...
        <div><?php echo Labels::getLabel('LBL_Statistical_Analysis_Cookies_Information', $siteLangId); ?></div>
    </div>
    ...
    <div>
        ...
        <div><?php echo Labels::getLabel('LBL_Personalise_Cookies_Information', $siteLangId); ?></div>
    </div>
