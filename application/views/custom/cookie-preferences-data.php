...
<div class="modal-body cookie-alert">
    ...
    <p>
        <?php echo Labels::getLabel('LBL_What_is_a_cookie_Information', $siteLangId); ?></p>
    <div class="cookies-group">
        <div class="cookies-group-head" data-bs-toggle="collapse" data-bs-target="#Functional_Cookies" aria-expanded="false" aria-controls="Functional_Cookies">
            <h6>
    ...
    <div class="cookies-group">
        <div class="cookies-group-head" data-bs-toggle="collapse" data-bs-target="#Statistical_analysis" aria-expanded="false" aria-controls="Statistical_analysis">
    ...
    <div class="cookies-group">
        <div class="cookies-group-head" data-bs-toggle="collapse" data-bs-target="#Cookies_to_personalise" aria-expanded="false" aria-controls="Cookies_to_personalise">
            <h6>
                <?php echo Labels::getLabel('LBL_Cookies_to_personalise_the_experience', $siteLangId); ?></h6>
            <label class="switch switch-sm switch-icon">
