                ...
                <div class="col-xl-9">
                    <div class="order-completed">
                        <div class="thanks-screen text-center">
                            ...
                            <?php } ?>
                            <?php if ($orderInfo['order_type'] != Orders::ORDER_WALLET_RECHARGE && $orderInfo['order_type'] != Orders::GIFT_CARD_TYPE) { ?>
                                <p>
                    ...
                    <?php if (true === $showOrderDetails) {
                        if ($orderInfo['order_type'] != Orders::ORDER_WALLET_RECHARGE && $orderInfo['order_type'] != Orders::GIFT_CARD_TYPE) { ?>
