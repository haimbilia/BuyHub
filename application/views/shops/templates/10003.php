            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="shop-btn-group">
                    ...
                    <?php if($showAddToFavorite) { ?>
                        <a href="javascript:void(0)" onclick="toggleShopFavorite(<?php echo $shop['shop_id']; ?>);" class="btn btn-outline-brand btn-sm <?php echo ($shop['is_favorite']) ? 'is-active' : ''; ?>" id="shop_<?php echo $shop['shop_id']; ?>"><i class="icn"><svg class="svg">
                    ...
                    <?php if($showMoreButtons){ 
                        ...
                        <a href="<?php echo UrlHelper::generateUrl('Shops','ReportSpam', array($shop['shop_id'])); ?>" class="btn btn-outline-brand btn-sm"><i class="icn"><svg class="svg">
							...
							<?php } ?>
                        <a href="<?php echo UrlHelper::generateUrl('shops','sendMessage',array($shop['shop_id'])); ?>" class="btn btn-outline-brand btn-sm"><i class="icn"><svg class="svg">
