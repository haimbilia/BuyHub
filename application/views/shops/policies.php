...
<div class="bg-brand-light py-4">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 align--right"><a href="<?php echo UrlHelper::generateUrl('Shops', 'View', array($shop['shop_id'])); ?>" class="btn btn-outline-white btn-sm"><?php echo Labels::getLabel('LBL_Back_to_Shop', $siteLangId); ?></a>
            </div>
        </div>
    </div>
</div>
