        ...
        <div class="testimonials-item">
            <div class="user">
                ...
                <img alt="<?php echo $listItem['testimonial_user_name'];?>"
                    src="<?php echo UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Image', 'testimonial', array($listItem['testimonial_id'],0,'THUMB'), CONF_WEBROOT_FRONT_URL) . $uploadedTime, CONF_IMG_CACHE_TIME, '.jpg'); ?>">
            </div>
