...
<div class="" id="filters_body--js">
    <div class="sidebar-widget resetFilterSectionJs" style="display: none;">
        <div class="selected-filters-head">
            ...
            <button type="button" class="link-underline link-underline-black" id="resetAllJs"
                    ...
                    <ul class="list-vertical">
                        ...
                        <li>
                            <label class="checkbox brand" id="prodcat_<?php echo $cat['prodcat_id']; ?>">
                                <input name="category" value="<?php echo $cat['prodcat_id']; ?>" type="checkbox"
                ...
                <div class="scrollbar-filters scroll scroll-y" id="scrollbar-filters">
                    <ul class="list-vertical brandFilter-js">
                        ...
                        <li><label class="checkbox brand" id="brand_<?php echo $brand['brand_id']; ?>"><input
                                    ...
                                    <?php if (in_array($brand['brand_id'], $brandsCheckedArr)) {
                                                                                                                                                                                                                                                                                                    echo "checked='true'";
                                                                                                                                                                                                                                                                                                } ?>><span
                                    class="lb-txt"><?php echo $brand['brand_name']; ?></span> </label>
                        </li>
                        <?php
                        } ?>
                    </ul>
