                                ...
                                <ul class="slides--combo">
                                    ...
                                    <li>
                                        <div class="items-group">
                                            <div
                                                class="item item--small item--hovered <?php echo(!$product['in_stock'])?'item--sold':'';?>">
                                                <?php if(!$product['in_stock']){
														$batchInStock = false;
														?>
                                                <span
                                                    class="tag--soldout"><?php echo Labels::getLabel('LBL_Sold_Out',$siteLangId); ?></span>
                                                <?php }?>
