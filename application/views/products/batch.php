            ...
            <div class="section__body">
                <div class="box box--white box--rounded">
                    <div class="box__head">
                        ...
                        <span class="text--normal"><?php echo Labels::getLabel('LBL_Sold_By', $siteLangId); ?>: <a href="<?php echo UrlHelper::generateUrl('Shops', 'view', array($batch['shop_id'])); ?>"><?php echo $batch['shop_name']; ?></a></span>
                    </div>
                    <div class="box__body">
                                        ...
                                        ?>
                                            <li>
                                                <div class="items-group">
                                                    <div class="item item--small item--hovered <?php echo (!$product['in_stock']) ? 'out-of-stock' : ''; ?>">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12">
                                    <div class="items-group">
                                        <div class="item__total">
                                            ...
                                            <span class="item__price"><?php echo CommonHelper::displayMoneyFormat($batch['prodgroup_price']); ?></span>
                                            <span class="item__price--old"><?php echo CommonHelper::displayMoneyFormat($productsTotalPrice); ?></span>
                                            <?php if ($batchInStock) { ?>
