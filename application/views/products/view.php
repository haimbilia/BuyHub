                        ...
                        <div class="col-lg-7 relative">
                            <div id="img-static" class="product-detail-gallery">
                                ...
                                <div class="slider-for" dir="<?php echo CommonHelper::getLayoutDirection(); ?>"
                                    ...
                                    <img alt="" class="xzoom active" id="xzoom-default" src="<?php echo $mainImgUrl; ?>"
                                        data-xoriginal="<?php echo $originalImgUrl; ?>">
                                    <?php break;
                                        } ?>
                                    <?php } else {
                                    ...
                                    <img alt="" class="xzoom" src="<?php echo $mainImgUrl; ?>"
                                        data-xoriginal="<?php echo $originalImgUrl; ?>">
                                    <?php } ?>
                                </div>
                                <?php if ($productImagesArr) { ?>
                                <div class="slider-nav xzoom-thumbs"
                                    ...
                                    <?php foreach ($productImagesArr as $afile_id => $image) {
                                            ...
                                            $mainImgUrl = UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Image', 'product', array($product['product_id'], 'MEDIUM', 0, $image['afile_id'])), CONF_IMG_CACHE_TIME, '.jpg');
                                            /* $thumbImgUrl = UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Image', 'product', array($product['product_id'], 'THUMB', 0, $image['afile_id']) ), CONF_IMG_CACHE_TIME, '.jpg'); */ ?>
                                    <div class="thumb"><a href="<?php echo $originalImgUrl; ?>"><img alt=""
                            ...
                            <div class="product-description">
                                <div class="product-description-inner">
                                    ...
                                    <div class="products__title">
                                        <h1>
                                            <img class="products__title_badge"
                                                src="<?php echo CONF_WEBROOT_URL; ?>images/retina/badges/badges.svg"
                                        ...
                                        <div class="products-reviews">
                                            ...
                                            <a href="#itemRatings"
                                                class="totals-review nav-scroll-js"><?php echo $label; ?></a>
                                        </div>
                                        <?php /*}*/ ?>
                                        <?php /* if (round($product['prod_rating']) == 0) {  ?>
                                    ...
                                    <div class="share-via">
                                        <h6 class="h6"><?php echo Labels::getLabel("LBL_Share_This", $siteLangId); ?></h6>
                                        <ul class="share-via-list">
                                            <li class="social-facebook">
                                                <a href="javascript:void(0)" class="st-custom-button"
...
<div class="nav-detail nav-detail-js">
    <ul>
        ...
        <li><a class="nav-scroll-js is-active"
                href="#specifications"><?php echo Labels::getLabel('LBL_Previews', $siteLangId); ?></a>
        </li>
        <?php } ?>
