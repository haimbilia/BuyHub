            ...
            <div class="product-profile">
                <div class="item__pic item__pic-seller">
                    <a href="<?php echo UrlHelper::generateUrl('shops', 'view', array($sellerDetail['shop_id'])); ?>" title="<?php echo $sellerDetail['shop_name']; ?>">
                        <img src="<?php echo UrlHelper::generateFileUrl('image', 'shopLogo', array($sellerDetail['shop_id'], $siteLangId, ImageDimension::VIEW_THUMB)); ?>" alt="<?php echo $sellerDetail['shop_name']; ?>" title="<?php echo $sellerDetail['shop_name']; ?>">
                    </a>
                </div>
