...
?>
 ...
 <div class="selected-filters" id="filters"><a href="javascript:void(0)" class="resetAll link" id="resetAll"
 ...
 <div class="filter-horizontal" id="filters_body--js">
     <ul>
         ...
         <li class="dropdown">
             <button type="button" class="btn btn-brand filter-trigger dropdown-toggle" data-toggle="dropdown"
                 aria-haspopup="true" aria-expanded="false">
                 <?php echo Labels::getLabel('LBL_Categories', $siteLangId); ?>
             </button>
             <div class="filter-target dropdown-menu dropdown-menu-anim dropdown-menu-fit" aria-labelledby="category">
                 <?php if (!$shopCatFilters) { ?>
                 <div id="accordian" class="cat-accordion scrollbar-filters">
                     <ul>
                ...
                $catUrl = UrlHelper::generateUrl('category', 'view', array($cat['prodcat_id'])); ?>
                         <li>
                             ...
                             <span class="acc-trigger" ripple="ripple" ripple-color="#000"></span>
                             <?php  } ?>
                            ...
                            foreach ($children['children'] as $subChildren) {
                                ?>
                                         <li>
                                             ...
                                             <span class="acc-trigger" ripple="ripple" ripple-color="#000"></span>
                                             <?php  } ?>
                                             <a class="filter_categories"
                                                 data-id="<?php echo $subChildren['prodcat_id']; ?>"
                                    ...
                                    foreach ($subChildren['children'] as $subSubChildren) {
                                        ?>
                                                 ...
                                                 <li>
                                                     ...
                                                     <?php } ?>
                                                     <a class="filter_categories"
                                                         data-id="<?php echo $subSubChildren['prodcat_id']; ?>"
                        ...
                        if (isset($categoriesArr[$code]['prodcat_name'])) {
                         ...
                         <li>
                             <label class="checkbox brand" id="prodcat_<?php echo $cat['prodcat_id']; ?>"><input
                                     ...
                                     data-title="<?php echo $catName; ?>"
                                     <?php if (in_array($cat['prodcat_id'], $prodcatArr)) { ?> checked
                                     <?php } ?>><?php echo $productCatName; ?></label></a>
                         </li>
      ...
      $brandsCheckedArr = (isset($brandsCheckedArr) && !empty($brandsCheckedArr)) ? $brandsCheckedArr : array(); ?>
         ...
         <li class="dropdown">
             <button type="button" class="btn btn-brand filter-trigger dropdown-toggle" data-toggle="dropdown"
                 aria-haspopup="true" aria-expanded="false">
                 <?php echo Labels::getLabel('LBL_Brand', $siteLangId); ?></button>
             <div class="filter-target dropdown-menu dropdown-menu-anim dropdown-menu-fit" id="brand">
                 <div class="scrollbar-filters scroll scroll-y" id="scrollbar-filters">
          ...
          if ($brand['brand_id'] == null) {
              continue;
                         ...
                         <li><label class="checkbox brand" id="brand_<?php echo $brand['brand_id']; ?>"><input
                                     name="brands" data-id="brand_<?php echo $brand['brand_id']; ?>"
                                     value="<?php echo $brand['brand_id']; ?>"
                                     data-title="<?php echo $brand['brand_name']; ?>" type="checkbox"
                                     <?php if (in_array($brand['brand_id'], $brandsCheckedArr)) { ?> checked='true'
                                     <?php } ?>><span class="lb-txt"><?php echo $brand['brand_name']; ?></span>
                             </label>
                         </li>
                         <?php
      } ?>
 ...
 <li class="dropdown">
     ...
     <div class="filter-target dropdown-menu dropdown-menu-anim dropdown-menu-fit"
         id="option<?php echo $optionRow['option_id'];?>">
         <ul class="list-vertical">
             <?php
                }
             ...
             <li>
                 <label class="checkbox optionvalue" id="optionvalue_<?php echo $optionRow['optionvalue_id']; ?>"><input
                         name="optionvalues" value="<?php echo $optionValueId; ?>" type="checkbox"
                         <?php if (in_array($optionRow['optionvalue_id'], $optionValueCheckedArr)) { ?> checked='true'
                         <?php  } ?>><?php echo ($optionRow['optionvalue_name']) ? $optionRow['optionvalue_name'] : $optionRow['optionvalue_identifier']; ?>
                 </label>
             </li>
 ...
 <li class="dropdown">
     <button type="button" class="btn btn-brand filter-trigger dropdown-toggle" data-toggle="dropdown"
         aria-haspopup="true" aria-expanded="false">
         <?php echo Labels::getLabel('LBL_Condition', $siteLangId); ?></button>
     <div class="filter-target dropdown-menu dropdown-menu-anim dropdown-menu-fit" id="condition">
         <ul class="list-vertical">
             <?php foreach ($conditionsArr as $condition) {
                            if (empty($condition) || $condition['selprod_condition'] == 0) {
                                continue;
                            } ?>
             <li><label class="checkbox condition" id="condition_<?php echo $condition['selprod_condition']; ?>"><input
                         value="<?php echo $condition['selprod_condition']; ?>" name="conditions" type="checkbox"
                         <?php if (in_array($condition['selprod_condition'], $conditionsCheckedArr)) { ?> checked='true'
                         <?php  } ?>><?php echo Product::getConditionArr($siteLangId)[$condition['selprod_condition']]; ?>
                 </label></li>
             <?php
                        } ?>
         </ul>
 ...
 <li class="dropdown">
     ...
     <div class="filter-target dropdown-menu dropdown-menu-anim dropdown-menu-fit" id="availability">

         <ul class="listing--vertical listing--vertical-chcek">
             <li><label class="checkbox availability" id="availability_1"><input name="out_of_stock" value="1"
                         type="checkbox" <?php if ($availability == 1) { ?> checked='true'
                         <?php } ?>><?php echo Labels::getLabel('LBL_Exclude_out_of_stock', $siteLangId); ?>
                 </label></li>
         </ul>
...
$("document").ready(function() {
    ...
    $(window).resize(function() {
        ...
        if (windowSize > 992) {
            ...
            $('#filters_body--js .filter-trigger  dropdown-toggle').attr(
                'aria-expanded',
                false);
