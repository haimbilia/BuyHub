...
?>
 ...
 <div class="" id="filters_body--js">
     ...
     <div class="sidebar-widget">
         <div class="sidebar-widget_head" data-toggle="collapse" data-target="#category" aria-expanded="true"
             ...
             <div id="accordian" class="cat-accordion toggle-target scrollbar-filters">
                ...
                $catUrl = UrlHelper::generateUrl('category', 'view', array($cat['prodcat_id'])); ?>
                    ...
                    echo '<span class="acc-trigger" ripple="ripple" ripple-color="#000"></span>';
                         ...
                         <a class="" data-id="<?php echo $cat['prodcat_id']; ?>"
                    ...
                    foreach ($cat['children'] as $children) {
                     ...
                     <li>
                         ...
                         <a class="" data-id="<?php echo $children['prodcat_id']; ?>"
                     ...
                     <li>
                         ...
                         <a class="" data-id="<?php echo $subChildren['prodcat_id']; ?>"
                     ...
                     <li>
                         ...
                         <a class="" data-id="<?php echo $subSubChildren['prodcat_id']; ?>"
     ...
     <div class="sidebar-widget">
         <div class="sidebar-widget_head" data-toggle="collapse" data-target="#price" aria-expanded="true"
             aria-controls="price">
     ...
     <div class="sidebar-widget">
         <div class="sidebar-widget_head" data-toggle="collapse" data-target="#brand" aria-expanded="true">
     ...
     <div class="sidebar-widget">
         <div class="sidebar-widget_head" data-toggle="collapse"
         ...
         <div class="sidebar-widget_body collapse show" id="option<?php echo $optionRow['option_id'];?>">
            ...
            $conditionsCheckedArr = (isset($conditionsCheckedArr) && !empty($conditionsCheckedArr)) ? $conditionsCheckedArr : array(); ?>
                 ...
                 <div class="sidebar-widget">
                     <div class="sidebar-widget_head" data-toggle="collapse" data-target="#condition"
                         aria-expanded="true">
        ...
        if (isset($availabilityArr) && count($availabilityArr) > 1) {
         ...
         $("document").ready(function() {
             ...
             $(window).resize(function() {
                 ...
                 if (windowSize > 992) {
                     $('#filters_body--js .sidebar-widget_body').removeClass('show');
                     $('#filters_body--js .sidebar-widget__head').attr('aria-expanded',
                         false);
                     $('#filters_body--js .sidebar-widget_body').attr('data-parent',
                         '#collection-sidebar');
                 } else {
                     $('#filters_body--js .sidebar-widget_body').addClass('show');
                     $('#filters_body--js .sidebar-widget__head').attr('aria-expanded',
                         true);
                     $('#filters_body--js .sidebar-widget_body').removeAttr(
                         'data-parent');
                 }
             });
