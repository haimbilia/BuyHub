...
<div class="product-description">
    <div class="product-description-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="dropdown dropdown-options">
                        <button class="btn btn-outline-gray dropdown-toggle" type="button" data-toggle="dropdown"
        ...
        <div class="block-detail">
            ...
            <ul class="<?php echo (count($volumeDiscountRows) > 1) ? '' : ''; ?> discount-slider">
            ...
            <div class="addons-scrollbar scroll scroll-x">
                <ul class="list-addons list-addons--js">
                    ...
                    <li class="addon--js <?php echo $cancelClass; ?>">
                        <div class="item">
                            <figure class="item__pic"><a title="<?php echo $usproduct['selprod_title']; ?>"
                        ...
                        <div class="qty-wrapper">
                            <div class="quantity quantity-2" data-stock="<?php echo $usproduct['selprod_stock']; ?>">
                                ...
                                <div class="qty-input-wrapper" data-stock="<?php echo $usproduct['selprod_stock']; ?>">
                                    <input type="text" value="1" data-page="product-view" placeholder="Qty"
