 ...
 <div class="filter-horizontal" id="filters_body--js">
     <ul>
         <?php if (isset($categoriesArr) && $categoriesArr) { ?>
             <li class="dropdown">
                 <button type="button" class="btn btn-brand filter-trigger dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             ...
                             <ul class="list-vertical">
                                 <?php
                                    ...
                                    foreach ($categoriesArr as $cat) {
                                     ...
                                     <li>
                                         <label class="checkbox brand" id="prodcat_<?php echo $cat['prodcat_id']; ?>"><input name="category" value="<?php echo $cat['prodcat_id']; ?>" type="checkbox" data-title="<?php echo $catName; ?>" <?php if (in_array($cat['prodcat_id'], $prodcatArr)) { ?> checked <?php } ?>><?php echo $productCatName; ?></label></a>
                                     </li>
                     ...
                     <div class="scrollbar-filters scroll scroll-y" id="scrollbar-filters">
                         <ul class="list-vertical brandFilter-js">
                             <?php foreach ($brandsArr as $brand) {
                                 ...
                                 <li><label class="checkbox brand" id="brand_<?php echo $brand['brand_id']; ?>"><input name="brands" data-id="brand_<?php echo $brand['brand_id']; ?>" value="<?php echo $brand['brand_id']; ?>" data-title="<?php echo $brand['brand_name']; ?>" type="checkbox" <?php if (in_array($brand['brand_id'], $brandsCheckedArr)) { ?> checked='true' <?php } ?>><span class="lb-txt"><?php echo $brand['brand_name']; ?></span>
                                     </label>
                                 </li>
                             <?php
                                } ?>
 ...
 <li class="dropdown">
     ...
     <div class="filter-target dropdown-menu dropdown-menu-anim dropdown-menu-fit" id="option<?php echo $optionRow['option_id']; ?>">
         <ul class="list-vertical">
         <?php
                    }
         ...
         <div class="filter-target dropdown-menu dropdown-menu-anim dropdown-menu-fit" id="condition">
             <ul class="list-vertical">
                 <?php foreach ($conditionsArr as $condition) {
                     ...
                     <li><label class="checkbox condition" id="condition_<?php echo $condition['selprod_condition']; ?>"><input value="<?php echo $condition['selprod_condition']; ?>" name="conditions" type="checkbox" <?php if (in_array($condition['selprod_condition'], $conditionsCheckedArr)) { ?> checked='true' <?php  } ?>><?php echo Product::getConditionArr($siteLangId)[$condition['selprod_condition']]; ?>
                         </label></li>
                 <?php
                    } ?>
             </ul>
     ...
     <li class="dropdown">
         ...
         <div class="filter-target dropdown-menu dropdown-menu-anim dropdown-menu-fit" id="availability">
             ...
             <ul class="listing--vertical listing--vertical-chcek">
                 <li><label class="checkbox availability" id="availability_1"><input name="out_of_stock" value="1" type="checkbox" <?php if ($availability == 1) { ?> checked='true' <?php } ?>><?php echo Labels::getLabel('LBL_Exclude_out_of_stock', $siteLangId); ?>
                     </label></li>
             </ul>
