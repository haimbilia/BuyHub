            ...
            <div class="product-detail product-description product-detail-quickview">
                <div>
                    <div class="product-description-inner">
                        ...
                        <p class="tax-inclusive"><?php echo Labels::getLabel('LBL_Inclusive_All_Taxes', $siteLangId); ?>
                        </p>
                            ...
                            <div class="dropdown dropdown-options">
                                ...
                                <div class="dropdown-menu dropdown-menu-anim scroll scroll-y">
                                    <ul class="nav nav-block">
                                        ...
                                        <li
                                            class="nav__item <?php echo (in_array($opVal['optionvalue_id'], $product['selectedOptionValues'])) ? ' selected' : ' ';
                                            ...
                                            <a optionValueId="<?php echo $opVal['optionvalue_id']; ?>"
                                                ...
                                                onclick="quickDetail(<?php echo $selprodId; ?>)"> <span class="colors"
                                            ...
                                            <a optionValueId="<?php echo $opVal['optionvalue_id']; ?>"
                                                ...
                                                class="dropdown-item nav__link <?php echo (in_array($opVal['optionvalue_id'], $product['selectedOptionValues'])) ? '' : ' ';
                                                                                                                                                                                                                                                                                                                                                                        echo (!$optionUrl) ? ' is-disabled' : '' ?>"
                                                href="javascript:void(0)"
                                                onclick="quickDetail(<?php echo $selprodId; ?>)">
