            ...
            <div class="products">
                ...
                <div class="products__body">
                    ...
                    <div class="products__img">
                        ...
                        <a title="<?php echo $product['selprod_title']; ?>"
                            ...
                            <picture>
                            <source srcset="<?php echo UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('image', 'product', array($product['product_id'], "WEBPCLAYOUT3", $product['selprod_id'], 0, $siteLangId)) . $uploadedTime, CONF_IMG_CACHE_TIME, '.webp'); ?>" type="image/webp">
                            <source srcset="<?php echo UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('image', 'product', array($product['product_id'], "CLAYOUT3", $product['selprod_id'], 0, $siteLangId)) . $uploadedTime, CONF_IMG_CACHE_TIME, '.jpg'); ?>" type="image/jpeg" > 
                ...
                <div class="products__footer">
                    <div class="products__category">
                        <a
                            href="<?php echo UrlHelper::generateUrl('Category', 'View', array($product['prodcat_id'])); ?>"><?php echo html_entity_decode($product['prodcat_name'], ENT_QUOTES, 'UTF-8'); ?>
                        </a>
                    </div>
