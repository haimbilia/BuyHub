            ...
            <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
              <div class="info--order">
                ...
                <p>
                  ...
                  <?php echo (strlen($vendorReturnAddress['ura_phone']) > 0) ? Labels::getLabel('LBL_Phone:', $siteLangId) . $vendorReturnAddress['ura_phone_dcode'] . $vendorReturnAddress['ura_phone'] . '<br>' : ''; ?>
                </p>
              </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
