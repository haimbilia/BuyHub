    ...
    <div class="request-quote">
            ...
            <div class="quote">
                ...
                <div class="quote-for">
                    ...
                    <div class="quote-for-qty">
                        <div class="qty-wrap">
                            <label class="label">
                                <?php echo Labels::getLabel('LBL_REQUIRED_QUANTITY'); ?></label>
                            <div class="input-group">
                                <?php echo $frm->getFieldHtml('rfq_quantity'); ?><?php echo $frm->getFieldHtml('rfq_quantity_unit'); ?>
                            </div>
        ...
        <div class="request-quote__body">
            ...
            <div class="accordion-group">
                <div class="accordion-group__head" data-bs-toggle="collapse" data-bs-target="#variants"
            ...
            <?php } ?>
            <div class="accordion-group">
                <div class="accordion-group__head descHeadJs" data-bs-toggle="collapse" data-bs-target="#detailed"
