...
<div id="body" class="body">
	...
	<div class="page-banner" style="background-image:url(<?php echo UrlHelper::generateUrl('image','cpageBackgroundImage', array($cPage['cpage_id'], $siteLangId, '', 0, false),CONF_WEBROOT_URL); ?>);">
		<div class="container">
