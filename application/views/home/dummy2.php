<div class="body detail-page" id="body">
    <section class="">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-11">
                    <div class="breadcrumb">
                        <ul>
                            <li class="breadcrumb-item"><a href="/yokart">Home </a></li>
                            <li class="breadcrumb-item" title="Electronics"><a href="/yokart/electronics">Electronics</a></li>
                            <li class="breadcrumb-item" title="Mobiles"><a href="/yokart/mobiles">Mobiles</a></li>
                            <li class="breadcrumb-item" title="Phones"><a href="/yokart/mobiles-phones">Phones</a></li>
                            <li class="breadcrumb-item" title="Apple iPhone 12">Apple iPhone 12</li>
                        </ul>
                    </div>
                    <div class="detail-first-fold">
                        ...
                        <div class="product-description">
                            ...
                            <div class="products-title">
                                <h1 class="h1">Men Black Raglan Sleeved Active T-shirt</h1>
                            </div>
                            <div class="products-price">
                                <span class="products-price-new">$80.99</span>
                            ...
                            <div class="product-ratings">
                                ...
                                <button href="#itemRatings" class="totals-review nav-scroll-js">25 Reviews </button>
                            </div>
                            <div class="options-block">
                                <div class="options-block-head">
                                    <h6 class="h6">Size</h6>
                                    <button class="view-chart" type="button">View Chart</button>
                                </div>
                                <ul class="select-options select-options-size">
                                    <li class="select-options-item selected">
                                        <button class="btn-option" type="">S</button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="">M</button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="">L</button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="">XL</button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="">XXL</button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="">3XXL</button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="">4XXL</button>
                                    </li>
                            ...
                            <div class="options-block">
                                <div class="options-block-head">
                                    <h6 class="h6">Color</h6>
                                </div>
                                <ul class="select-options select-options-color">
                                    <li class="select-options-item selected">
                                        <button class="btn-option" type="" style="background-color:#151413;">

                                        </button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="" style="background-color:#7C1A00;">
                                        </button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="" style="background-color:#1252BC;"></button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="" style="background-color:#E67F05;"></button>
                                    </li>
                                    <li class="select-options-item">
                                        <button class="btn-option" type="" style="background-color:#BEBDBD;"></button>
                                    </li>
                                </ul>
                            </div>
                            <form id="frmBuyProduct" name="frmBuyProduct" method="post">
                                <div class="options-block">
                                    <div class="options-block-head">
                                        ...
                                        <div class="quantity" data-stock="50">
                                            ...
                                            <div class="qty-input-wrapper" data-stock="50">
                                                <input maxlength="3" class="qty-input cartQtyTextBox productQty-js" data-page="product-view" data-min-qty="1" data-field-caption="Quantity" data-fatreq="{&quot;required&quot;:false,&quot;integer&quot;:true,&quot;range&quot;:{&quot;minval&quot;:0,&quot;maxval&quot;:9999999999,&quot;numeric&quot;:true}}" type="text" name="quantity" value="1">
                                            </div>
                                ...
                                <div class="buy-group">
                                    <button name="btnAddToCart" type="submit" id="btnAddToCart" class="btn btn-brand btn-block add-to-cart add-to-cart--js"> Add to bag</button><input data-field-caption="" data-fatreq="{&quot;required&quot;:false}" type="hidden" name="selprod_id" value="187">
                                </div>
                            </form>
                            <div class="product-sharing">
                                <button class="btn btn-outline-light btn-favorite" type="button">
                                ...
                                <ul class="via-social-sharing">
                                    <li class="via-social-sharing-item">
                                        <a class="via-social-sharing-link" href="#">
                                            <svg class="svg" width="20" height="20">
                                    ...
                                    <li class="via-social-sharing-item">
                                        <a class="via-social-sharing-link" href="#">
                                            <svg class="svg" width="20" height="20">
                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#instagram">
                                                </use>
                                            </svg>
                                        </a>
                                    </li>
                                    <li class="via-social-sharing-item">
                                        <a class="via-social-sharing-link" href="#">
                                            <svg class="svg" width="20" height="20">
                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#linkedin">
                                                </use>
                                            </svg>
                                        </a>
                                    </li>
                            ...
                            <ul class="more-sellers">
                                ...
                                <li class="more-sellers-head">Other Sellers on YoKart</li>
                                <li class="more-sellers-item">
                                    <div class="sold-price">$566.00</div>
                                    <div class="sold-by">
                                        <span class="sold-by-txt">Sold by</span>
                                        <a class="sold-by-name" href="#">Kanwar Shop</a>
                                    </div>
                                ...
                                <li class="more-sellers-item more-link"> <button class="link-underline" type="button">
                                        View All
                                    </button></li>
                            </ul>
                            ...
                            <div class="side-blocks wholesale-options">
                                <h5 class="h5">Wholesale Price (Piece)</h5>
                            ...
                            <div class="side-blocks product-add-ons">
                                <h5 class="h5">Product Add-Ons</h5>
                                <ul class="list-addons list-addons--js">
                                    <li class="list-addons-item addon--js">
                                        <div class="product-profile">
                                            <figure class="product-profile__pic">
                                                <a title="Apple iPhone 6s Plus (Space Grey, 16 GB)" href="/yokart/iphone-6s-plus-41"><img src="/yokart/image/product/3/MINI/41" alt="iPhone 6s plus">
                                                </a>
                                            </figure>
                                            <div class="product-profile-data">
                                                <a class="title" href="/yokart/iphone-6s-plus-41">Apple iPhone 6s Plus (Space Grey, 16 GB)</a>
                                                <div class="products-price">
                                                    $665.00 </div>
                                                <div class="quantity quantity-2" data-stock="4545">
                                                    ...
                                                    <div class="qty-input-wrapper" data-stock="4545">
                                                        <input type="text" value="1" data-page="product-view" placeholder="Qty" class="qty-input cartQtyTextBox productQty-js" data-lang="addons[41]" name="addons[41]">
                                                    </div>
                                                    <span class="increase increase-js"><i class="icn">
                                                            <svg class="svg" width="16" height="16">
                                                                <use xlink:href="/yokart/images/retina/sprite.svg#plus">
                ...
                <div class="col-lg-7">
                    <div class="descriptions" id="descriptions">
                        <div class="descriptions-item">
                            ...
                            <div id="specification" class="collapse show" data-bs-parent="#descriptions">
                                <div class="descriptions-data">
                                    <ul class="list-specification">
                                        <li class="list-specification-item">
                                            <span class="label">Camera and Video:</span>
                                            <span class="value">Dual 12MP cameras with Portrait mode, Depth Control, Portrait Lighting, Smart HDR, and 4K Dolby Vision HDR video up to 60 fps </span>
                                        </li>

                                        <li class="list-specification-item">
                                            <span class="label">Capacity:</span>
                                            <span class="value">64GB, 128GB, 256GB </span>
                                        </li>

                                        <li class="list-specification-item">
                                            <span class="label">Display:</span>
                                            <span class="value">6.1inch Super Retina XDR display with True Tone </span>
                                        </li>

                                        <li class="list-specification-item">
                                            <span class="label">Front Camera:</span>
                                            <span class="value">12MP TrueDepth front camera with Portrait mode, Depth Control, Portrait Lighting, and Smart HDR 3 </span>
                                        </li>

                                        <li class="list-specification-item">
                                            <span class="label">In the Box:</span>
                                            <span class="value">iPhone with iOS 14, USB-C to Lightning Cable, Documentation </span>
                                        </li>

                                        <li class="list-specification-item">
                                            <span class="label">Power and Battery:</span>
                                            <span class="value">Video playback:Up to 17 hours, Video playback (streamed):Up to 11 hours, Audio playback:Up to 65 hours, 20W adapter or higher (sold separately), Fast-charge capable: Up to 50% charge in around 30 minutes with 20W adapter or higher </span>
                                        </li>

                                        <li class="list-specification-item">
                                            <span class="label">Splash, Water, and Dust Resistant:</span>
                                            <span class="value">All-glass and surgical-grade stainless steel design, water and dust resistant (rated IP68) </span>
                                        </li>

                                        <li class="list-specification-item">
                                            <span class="label">Warranty:</span>
                                            <span class="value">1 year manufacturer warranty for device and 6 months manufacturer warranty for in-box accessories including batteries from the date of purchase </span>
                                        </li>
                                ...
                                <div class="descriptions-data">
                                    <div class="cms">
                                        <ul class="a-unordered-list a-vertical a-spacing-mini" style="box-sizing: border-box; margin: 0px 0px 0px 18px; color: rgb(17, 17, 17); padding: 0px; font-family: " amazon="" ember",="" arial,="" sans-serif;="" font-size:="" 14px;="" background-color:="" rgb(255,="" 255,="" 255);"="">
                                            ...
                                            <li style="box-sizing: border-box; list-style: disc; overflow-wrap: break-word; margin: 0px;"><span class="a-list-item" style="box-sizing: border-box;">Advanced dual-camera system with 12MP Ultra Wide and Wide cameras; Night mode, Deep Fusion, Smart HDR 3, 4K Dolby Vision HDR recording</span></li>
                                            <li style="box-sizing: border-box; list-style: disc; overflow-wrap: break-word; margin: 0px;"><span class="a-list-item" style="box-sizing: border-box;">12MP TrueDepth front camera with Night mode, 4K Dolby Vision HDR recording</span></li>
                                            <li style="box-sizing: border-box; list-style: disc; overflow-wrap: break-word; margin: 0px;"><span class="a-list-item" style="box-sizing: border-box;">Industry-leading IP68 water resistance</span></li>
                                            <li style="box-sizing: border-box; list-style: disc; overflow-wrap: break-word; margin: 0px;"><span class="a-list-item" style="box-sizing: border-box;">Supports MagSafe accessories for easy attach and faster wireless charging</span></li>
                                            <li style="box-sizing: border-box; list-style: disc; overflow-wrap: break-word; margin: 0px;"><span class="a-list-item" style="box-sizing: border-box;">iOS with redesigned widgets on the Home screen, all-new App Library, App Clips and more</span></li>
                                        </ul>
                                        <p></p>
                                    </div>
                                </div>
                        ...
                        <div class="descriptions-item">
                            ...
                            <div id="video" class="collapse" data-bs-parent="#descriptions">
                                <div class="descriptions-data">
                                    <div class="mb-4 video-wrapper">
                                        <iframe width="100%" height="315" src="//www.youtube.com/embed/CcdFEiVHVZo" allowfullscreen=""></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="descriptions-item">
                            ...
                            <div id="policies" class="collapse" data-bs-parent="#descriptions">
                                <div class="descriptions-data">
                                    <div class="cms">
                ...
                <div class="col-lg-10">
                    <div class="customer-reviews">
                        <div class="customer-reviews-head">
                            ...
                            <div class="sort-by">
                                <div class="dropdown">
                                    <button class="dropdown-toggle-custom btn btn-outline-gray sort-by-btn" type="button" data-bs-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="true">
                                        <span>Sort by</span>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-anim">
                                        <ul class="drop nav nav-block">
                                            <li class="nav__item selected">
                                                <a class="dropdown-item nav__link" href="javascript:void(0);">Most Recent</a>
                                            </li>
                                            <li class="nav__item selected"><a class="dropdown-item nav__link" href="javascript:void(0);">Most Helpful</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="sticky-lg-top">
                                        <div class="rating-block">
                                            <div class="average-rating">
                                                ...
                                                <span class="totals">150 Reviews</span>
                                        ...
                                        <div class="rating-block">
                                            ...
                                            <ul class="rating-by-category">
                                                <li class="rating-by-category-item">
                                                    ...
                                                    <span class="value"> <svg class="svg" width="11" height="11">
                                                            <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#star-yellow">
                                                            </use>
                                                        </svg>
                                                        <span class="out-of">
                                    ...
                                    <div class="user-reviews">
                                        ...
                                        <div class="user-reviews-item">
                                            ...
                                            <div class="user-reviews-foot">
                                                ...
                                                <ul class="yes-no">
                                                    <li class="yes-no-item">Was this review helpful?</li>
                                                    <li class="yes-no-item">
                                                        <button class="btn btn-thumb" type="button">
                                                            Yes <span class="counts">(10)</span>
                                                        </button>
                                                    </li>
                                                    <li class="yes-no-item">
                                                        <button class="btn btn-thumb" type="button">
                                                    ...
                                                    <li class="yes-no-item">
                                                        <a class="btn btn-light" href="#">Permalink</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <button class="btn link-underline" type="button">
                                            All 567 Reviews
                                        </button>
                                    </div>
