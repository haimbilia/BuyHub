    ...
    $.extend($.facebox, {
        ...
        reveal: function (data, bodyClass) {
            ...
            if (1 > $(contentBody).find(".modal-header").length) {
                ...
                0 < $(contentBody).find(".modal-header").length &&
                1 >
                $(
                    "body ." + $.facebox.element + " .contentBody--js .modal-header"
                ).find(".close").length
            ) {
                $(
                    "body ." + $.facebox.element + " .contentBody--js .modal-header"
            ...
            if (
                "undefined" != typeof bodyClass &&
                0 == $(data).find(bodyClass).length
            ) {
    ...
    function init(klass) {
        ...
        if (1 > $("body").find("." + $.facebox.element).length) {
            var content =
                ...
                klass +
                ' " role="document"><div class="modal-content contentBody--js"></div></div>';
            var htm =
