        ...
        <section class="section">
            <div class="container">
                <div class="section-head">
                    ...
                    <div class="section_action"> <a href="<?php echo UrlHelper::generateUrl('Collections', 'View', array($row['collection_id']));?>" class="link"><?php echo Labels::getLabel('LBL_View_More', $siteLangId); ?></a> </div>
                    <?php }  ?>
                </div>
