...
<div class="shop-layout-2">
    <div class="shop">
        <div class="shop-body">
            <a title="" href="">
                <picture class="shop-logo" data-ratio="1:1">
                    <source type="image/webp" srcset="" title="">
                    <img loading="lazy" data-aspect-ratio="1:1" src="http://localhost/yokart/images/products/product-16.jpg" alt="" title="">
                </picture>
            </a>
        </div>
        <div class="shop-foot">

            <div class="shop-title"> Vike Fashion Store</div>
            <div class="shop-location">California, United States</div>
            <div class="shop-action">
                <button class="btn btn-outline-black btn-sm" type="button">Shop Now</button>
            </div>
