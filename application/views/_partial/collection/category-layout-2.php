        ...
        <div class="container">
            ...
            <div class="category-layout-1">
                <div class="category">
                    ...
                    <div class="category-body">
                        <ul class="category-list">
                            <li class="category-list-item category-list-head"> <a href="#"> Mobiles</a> </li>
                            <li class="category-list-item"> <a href="/yokart/televisions">Televisions</a> </li>
                            <li class="category-list-item"> <a href="/yokart/washing-machines">Washing Machines</a> </li>
                            <li class="category-list-item"> <a href="/yokart/mobiles">Mobiles</a> </li>
                            <li class="category-list-item"> <a href="/yokart/gaming-consoles">Gaming Consoles</a> </li>
                            <li class="category-list-item"> <a href="/yokart/washing-machines">Washing Machines</a> </li>
                            <li class="category-list-item"> <a href="/yokart/laptops">Laptops</a> </li>
                        </ul>
                    </div>
                </div>
                <div class="category">
                    ...
                    <div class="category-body">
                        <ul class="category-list">
                            <li class="category-list-item category-list-head"> <a href="#"> Phones </a></li>
                            <li class="category-list-item"> <a href="/yokart/mobiles-mobile-cases">Mobile Cases</a> </li>
                            <li class="category-list-item"> <a href="/yokart/mobiles-headphones">Headphones</a> </li>
                            <li class="category-list-item"> <a href="/yokart/mobiles-screengaurds">Screengaurds</a> </li>
                        </ul>
                    </div>
                ...
                <div class="category">
                    ...
                    <div class="category-body">
                        <ul class="category-list">
                            <li class="category-list-item category-list-head"> <a href="#"> Laptops </a></li>
                            <li class="category-list-item"> <a href="/yokart/laptops-antivirus">Antivirus</a>
                            </li>
                            <li class="category-list-item"> <a href="/yokart/laptops-laptop-bags">Laptop Bags</a>
                            </li>
                            <li class="category-list-item"> <a href="/yokart/laptops-business-laptops">Business Laptops</a>
                            </li>
                            <li class="category-list-item"> <a href="/yokart/laptops-antivirus">Antivirus</a>
                            </li>
                            <li class="category-list-item"> <a href="/yokart/laptops-laptop-bags">Laptop Bags</a>
                ...
                <div class="category">
                    ...
                    <div class="category-body">
                        <ul class="category-list">
                            <li class="category-list-item category-list-head"> <a href="#">Electronics </a></li>
                            <li class="category-list-item"> <a href="/yokart/televisions">Televisions</a> </li>
                            <li class="category-list-item"> <a href="/yokart/washing-machines">Washing Machines</a> </li>
                            <li class="category-list-item"> <a href="/yokart/mobiles">Mobiles</a> </li>
                            <li class="category-list-item"> <a href="/yokart/gaming-consoles">Gaming Consoles</a> </li>
