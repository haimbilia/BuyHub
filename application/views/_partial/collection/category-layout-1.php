                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        foreach ($collection['categories'] as $key => $category) {
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?php echo 1 == $x ? 'active' : ''; ?>" data-bs-toggle="tab" data-bs-target="#tb-<?php echo $key . "-" . $collection['collection_id']; ?>" type="button" aria-controls="panel-1">
