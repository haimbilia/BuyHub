<div id="tabUl" class="tabs tabs--flat-js justify-content-md-center tabs--mobileview">
    <ul>
        ...
        <li class=""><a
                href="#tb-<?php echo $key."-".$collection['collection_id'];; ?>"><?php echo $category['catData']['prodcat_name']; ?></a>
        </li>
        <?php } ?>
    </ul>
</div>
...
<div id="tb-<?php echo $key."-".$collection['collection_id'];; ?>" class="tabs-content tabs-content-js"
    style="display: block;">
