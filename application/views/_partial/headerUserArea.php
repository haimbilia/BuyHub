        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim"
            ...
            <ul class="nav nav-block">
                ...
                <li class="nav__item logout"><a class="dropdown-item nav__link"
                        data-org-url="<?php echo UrlHelper::generateUrl('GuestUser', 'logout', [], CONF_WEBROOT_FRONTEND, null, false, $getOrgUrl); ?>"
                ...
                ?> <li>
    <div class="dropdown dropdown--user"><a href="javascript:void(0)" class="sign-in sign-in-popup-js"><i
                class="icn icn--login"><svg class="svg">
                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#login"
                        href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#login"></use>
                </svg></i> <span>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim"
            ...
            <ul class="nav nav-block">
                ...
                <li class="nav__item "><a class="dropdown-item nav__link" data-org-url="<?php echo $dashboardOrgUrl; ?>"
