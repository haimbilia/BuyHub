...
if ($orderProducts['op_product_type'] == Product::PRODUCT_TYPE_DIGITAL) {
    ...
    if (!empty($orderProducts['pickupAddress'])) {
        ...
        if ($orderProducts['pickupAddress']['oua_phone'] != '') {
            $pickUpAddressInfo .= '<br><span class="default-ltr">' . ValidateElement::formatDialCode($orderProducts['pickupAddress']['oua_phone_dcode']) . $orderProducts['pickupAddress']['oua_phone'] . '</span>';
        }
