                        ...
                        <ul class="quick-nav">
                            ...
                            if (CommonHelper::demoUrl()) { ?>
                                ...
                                <li class="quick-nav-item item-desktop quick-nav-pipe">
                                    <a class="quick-nav-link btn-cta" href="https://www.yo-kart.com/request-demo.html?q=demo-nav" rel="noopener" title="Get a Free demo of Yo!Kart system by an expert"> Request a Demo </a>
                                </li>
                            <?php } ?>
