            ...
            <ul class="list-cart">
                ...
                <li
                    ...
                    <div class="cell cell_product">
                        <div class="item">
                            <div class="item__pic"><a href="<?php echo $productUrl; ?>"><img
                                        src="<?php echo $imageUrl; ?>" alt="<?php echo $product['product_name']; ?>"
                                        title="<?php echo $product['product_name']; ?>"></a></div>
                            <div class="item__description">
                                <div class="item__category"><a
                                        href="<?php echo $shopUrl; ?>"><?php echo $product['shop_name']; ?> </a></div>
                                <div class="item__title"><a title="<?php echo $product['product_name']; ?>"
                    ...
                    <div class="cell cell_price">
                        <div class="product-price">
                            ...
                            <span
                                class="off_price text-success"><?php echo CommonHelper::showProductDiscountedText($product, $siteLangId); ?></span>
                            <?php } ?>
                        </div>
                    </div>
    ...
    <div class="side-cart_foot">
        ...
        <div class="buttons-group">
            ...
            <a class="btn btn-brand"
                href="<?php echo UrlHelper::generateUrl('cart'); ?>"><?php echo Labels::getLabel('LBL_Proceed_To_Pay', $siteLangId); ?></a>
        </div>

    </div>
    <?php } else { ?>
    <div class="block--empty m-auto text-center"> <img class="block__img"
            src="<?php echo CONF_WEBROOT_URL; ?>images/retina/empty_cart.svg"
            alt="<?php echo Labels::getLabel('LBL_No_Record_Found', $siteLangId); ?>" width="80">
