...
<div class="favourite-wrapper <?php /* echo $staticCollectionClass; */ ?>">
    ...
    <div class="favourite heart-wrapper wishListLink-Js <?php echo ($product['is_in_any_wishlist']) ? 'is-active' : ''; ?>"
        <?php /* id="listDisplayDiv_<?php echo $product['selprod_id']; ?>" */ ?>
        data-id="<?php echo $product['selprod_id']; ?>">
    ...
    <div class="dropdown">
        <a class="dropdown-toggle no-after share-icon" href="javascript:void(0)" data-toggle="dropdown">
            <i class="icn">
                <svg class="svg">
                    <use xlink:href="/yokartv8/images/retina/sprite.svg#share"
                        href="/yokartv8/images/retina/sprite.svg#share"></use>
                </svg>
            </i>
        </a>
            ...
            <ul class="social-sharing">
                <li class="social-twitter">
                    <a href="https://www.twitter.com"><i class="icn">
                            <svg class="svg">
                                <use xlink:href="/yokartv8/images/retina/sprite.svg#tw"
                                    href="/yokartv8/images/retina/sprite.svg#tw"></use>
                            </svg>
                        </i></a>
                </li>
                <li class="social-facebook">
                    <a href="https://www.facebook.com"><i class="icn">
                            <svg class="svg">
                                <use xlink:href="/yokartv8/images/retina/sprite.svg#fb"
                                    href="/yokartv8/images/retina/sprite.svg#fb"></use>
                            </svg>
                        </i></a>
                </li>
                <li class="social-gplus">
                    <a href="http://www.gplus.com"><i class="icn">
                            <svg class="svg">
                                <use xlink:href="/yokartv8/images/retina/sprite.svg#gp"
                                    href="/yokartv8/images/retina/sprite.svg#gp"></use>
                            </svg>
                        </i></a>
                </li>
                <li class="social-pintrest">
                    <a href="http://www.gplus.com"><i class="icn">
                            <svg class="svg">
                                <use xlink:href="/yokartv8/images/retina/sprite.svg#pt"
                                    href="/yokartv8/images/retina/sprite.svg#pt"></use>
                            </svg>
                        </i></a>
                </li>
                ...
                <li class="social-email">
                    <a href="http://www.gplus.com"><i class="icn">
                            <svg class="svg">
                                <use xlink:href="/yokartv8/images/retina/sprite.svg#envelope"
                                    href="/yokartv8/images/retina/sprite.svg#envelope"></use>
                            </svg>
                        </i></a>
                </li>
            </ul>
