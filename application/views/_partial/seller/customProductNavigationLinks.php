<div class="cards-header">
    ...
    <?php }?>
    <div class="action">
        <a href="<?php echo UrlHelper::generateUrl('seller', 'catalog');?>" class="btn btn--primary btn--sm"><strong><?php echo Labels::getLabel('LBL_Back_To_Products_list', $siteLangId)?></strong> </a>
    </div>
</div>
