    ...
    <ul class="footer-social">
        <?php foreach ($rows as $row) {
            ...
            <li class="footer-social-item">
                <a class="footer-social-link" aria-label="<?php echo $title . 'Open in new tab'; ?>" <?php if ($row['splatform_url'] != '') { ?>target="_blank" rel="noopener" <?php } ?> href="<?php echo ($row['splatform_url'] != '') ? $row['splatform_url'] : 'javascript:void(0)'; ?>">
                    <?php
