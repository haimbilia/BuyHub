...
<div class="box" style="text-align: center;">
	...
	<?php echo Labels::getLabel('LBL_PHONE', $siteLangId) . ': <span class="default-ltr">' . ValidateElement::formatDialCode($data['user_phone_dcode']) . $data['user_phone'] . '</span>'; ?><br>
	<p><?php echo !empty($data['user_profile_info']) ? nl2br($data['user_profile_info']) : ''; ?>
	</p>
