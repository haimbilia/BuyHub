	...
	<div class="row">
		<div class="col-md-12">
			<form onsubmit="setupZone(this); return(false);" method="post" class="form" id="shippingZoneFrm">
												...
												<label>
													<span class="checkbox" data-zoneid="-1"><input type="checkbox" name="rest_of_the_world"
														...
														<?php echo (in_array(-1, $exZoneIds)) ?'disabled':'';?>><i
															class="input-helper"></i><?php echo Labels::getLabel("LBL_REST_OF_THE_WORLD", $siteLangId); ?></span>
												</label>
											</div>
										</div>
								</div>
											...
											<div class="field_cover">
												<label>
													<span class="checkbox zone--js"
														...
														><i class="input-helper"></i><?php echo $zone['zone_name']; ?></span>
												</label>
											</div>
										</div>
									</div>
									...
									<li class="collapse"
										...
										<div class="row no-gutters">
														...
														<label>
															<span class="checkbox country--js "
																...
																data-statecount="<?php echo $statesCount; ?>"><input
																	...
																	<?php echo $checked; ?>
																<?php echo $disabled; ?>><i
																	class="input-helper"></i><?php echo $country['country_identifier']; ?></span>
														</label>
													</div>
												</div>
											</div>
											...
											<div class="col-auto">
												...
												<a class="btn  btn-sm link_<?php echo $countryId;?>"
				...
				<div class="row my-3">
					<div class="col-lg-5">
						<input class="btn btn-primary btn-block" type="submit" name="btn_submit"
							value="<?php echo Labels::getLabel("LBL_Add_Zone", $siteLangId); ?>">						 
					</div>
					
					<div class="col-lg-5">					 
						<input class="btn btn-outline-primary btn-block" type="button" name="cancel"
