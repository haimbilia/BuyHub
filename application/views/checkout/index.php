...
<section class="section" data-section="section" data-content="">
    <div class="container">
        <div class="checkout-page checkoutPageJs">
                    ...
                    <ul class="review-block">
                        <li class="review-block-item">
                            <button class="btn btn-add-address" type="button" onclick="showAddressFormDiv()">
                                <svg xmlns="http://www.w3.org/2000/svg" class="svg mb-2" width="38" height="38"
            ...
            <aside class="checkout-page_aside">
                <div class="sticky-summary">
                    ...
                    <div class="secure">
                        <img class="svg" width="32" height="32"
                            src="<?php echo CONF_WEBROOT_URL; ?>images/retina/shield-fill-check.svg" alt="">
                        <p>
