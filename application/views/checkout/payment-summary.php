...
<div class="step active" role="step:4">
    <ul class="review-block">
            ...
            <div class="review-block__label">
                ...
                <div class="review-block__link">
                    ...
                    <a class="link" href="javascript:void(0);"
                        onClick="<?php echo $onclick; ?>"><span><?php echo Labels::getLabel('LBL_Edit', $siteLangId); ?></span></a>
                </div>
            </div>
        ...
        <li>
            <div class="review-block__label">
                ...
                <div class="review-block__link">
                    <a class="link" href="javascript:void(0);"
                        onClick="loadShippingSummaryDiv();"><span><?php echo Labels::getLabel('LBL_Edit', $siteLangId); ?></span></a>
                </div>
            </div>
            <div class="review-block__content">
                <div class="delivery-address">
                    ...
                    <p class="phone-txt"><i
                            class="fas fa-mobile-alt"></i><?php echo ValidateElement::formatDialCode($address['oua_phone_dcode']) . $address['oua_phone']; ?>
                    </p>
                    <?php } ?>
                    ...
                    <ul class="media-more media-more-sm show">
                        ...
                        <li>
                            <span class="circle" data-toggle="tooltip" data-placement="top"
                                ...
                                <img src="<?php echo UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('image', 'product', array($data['selprod_product_id'], "THUMB", $data['op_selprod_id'], 0, $siteLangId)), CONF_IMG_CACHE_TIME, '.jpg'); ?>"
        ...
        <li>
            <div class="review-block__label">
                <?php echo Labels::getLabel('LBL_Billing_to:', $siteLangId); ?> <div class="review-block__link">
                    <a class="link" href="javascript:void(0);"
                        onClick="loadAddressDiv(<?php echo Address::ADDRESS_TYPE_BILLING; ?>)"><span><?php echo Labels::getLabel('LBL_Edit', $siteLangId); ?></span></a>
                </div>
            </div>
            <div class="review-block__content">
    ...
    <div class="step_section">
        ...
        <label class="checkbox mb-4"><input onClick="billingAddress(this);" type="checkbox" checked='checked'
                name="isShippingSameAsBilling"
                value="1"><?php echo Labels::getLabel('LBL_MY_BILLING_IS_SAME_AS_SHIPPING_ADDRESS', $siteLangId); ?>
        </label>
        <?php } ?>
