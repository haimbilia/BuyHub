    ...
    <?php foreach ($blogPostComments as $comment) { ?>
        <div class="comments-wrap">
            <div class="comment-meta comment-author">
                <img alt="" src="<?php echo UrlHelper::generateFileUrl('image', 'user', array($comment['bpcomment_user_id'], "THUMB",1), CONF_WEBROOT_FRONT_URL); ?>" class="avatar avatar-60 photo" width="60" height="60">
