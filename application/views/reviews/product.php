    ...
    <div class="bg-second pt-3 pb-3">
        <div class="container ">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-auto col-sm-auto mt-3 mt-md-0"><a href="<?php echo UrlHelper::generateUrl('Products', 'view', array($product['selprod_id'])); ?>" class="btn btn-outline-white btn-sm"><?php echo Labels::getLabel('Lbl_Back_to_Product', $siteLangId); ?></a></div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-7">
                    <div id="itemRatings">
                        ...
                        <div class="section__body">
                            <?php $this->includeTemplate('_partial/product-reviews-list.php', array('reviews' => $reviews, 'ratingAspects' => $ratingAspects, 'siteLangId' => $siteLangId, 'product_id' => $product['product_id'], 'canSubmitFeedback' => $canSubmitFeedback), false); ?>
                        </div>
                    </div>
                </div>
            </div>
