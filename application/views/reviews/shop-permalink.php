                                ...
                                <li>
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-auto">
                                            <div class="yes-no">
                                                <ul>
                                                    <li><a href="javascript:undefined;" onclick='markReviewHelpful(<?php echo FatUtility::int($reviewData['spreview_id']); ?>,1);return false;' class="yes <?php echo 'rev_' . FatUtility::int($reviewData['spreview_id']) . '_1'; ?>"><img src="<?php echo CONF_WEBROOT_URL; ?>images/thumb-up.png" alt="<?php echo Labels::getLabel('LBL_Helpful', $siteLangId); ?>"> <span>(<?php echo $reviewHelpfulData['helpful']; ?>)</span></a>
                                                    </li>
                                                    <li><a href="javascript:undefined;" onclick='markReviewHelpful("<?php echo $reviewData['spreview_id']; ?>",0);return false;' class="no <?php echo 'rev_' . FatUtility::int($reviewData['spreview_id']) . '_0'; ?>"><img src="<?php echo CONF_WEBROOT_URL; ?>images/thumb-down.png" alt="<?php echo Labels::getLabel('LBL_Not_Helpful', $siteLangId); ?>">
