                ...
                <div class="col-auto">
                    <div class="profile-avatar">
                        ...
                        <div class="profile__bio">
                            <div class="title">
                                <?php echo Labels::getLabel('Lbl_By', $siteLangId) ; ?> <?php echo CommonHelper::displayName($review['user_name']); ?>
            ...
            <div class="reviews-desc">
                ...
                <div class="review-container">
                    <div class="cms">
                        ...
                        <a class="btn btn-brand mt-3" href="<?php echo UrlHelper::generateUrl('Reviews', 'shopPermalink', array($review['spreview_seller_user_id'] , $review['spreview_id'])) ?>"><?php echo Labels::getLabel('Lbl_Permalink', $siteLangId); ?> </a>
                    </div>
                </div>
