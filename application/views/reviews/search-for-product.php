...
<?php if ($reviewsList) { ?>
                ...
                <div class="row justify-content-between">
                    <div class="col-auto">
                        <div class="profile-avatar">
                            <div class="profile-dp">
                                <img src="<?php echo UrlHelper::generateFileUrl('Image', 'user', array($review['spreview_postedby_user_id'], ImageDimension::VIEW_THUMB, true)); ?>" alt="<?php echo $review['user_name']; ?>">
                            </div>
                            <div class="profile-bio">
                                <div class="title"><?php echo Labels::getLabel('Lbl_By', $siteLangId); ?>
                    ...
                    <div class="col-auto">
                        <div class="yes-no">
                            <ul>
                                <li>
                                    <a href="javascript:undefined;" onclick='markReviewHelpful(<?php echo FatUtility::int($review['spreview_id']); ?>,1);return false;' class="yes"><img src="<?php echo CONF_WEBROOT_URL; ?>images/thumb-up.png" alt="<?php echo Labels::getLabel('LBL_Helpful', $siteLangId); ?>">
                                        (<?php echo $review['helpful']; ?>)
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:undefined;" onclick='markReviewHelpful("<?php echo $review['spreview_id']; ?>",0);return false;' class="no">
                                        <img src="<?php echo CONF_WEBROOT_URL; ?>images/thumb-down.png" alt="<?php echo Labels::getLabel('LBL_Not_Helpful', $siteLangId); ?>">
                                        (<?php echo $review['notHelpful']; ?>)
                                    </a>
                                </li>
                                <li>
                                    <a class="btn btn-outline-gray btn-sm" href="<?php echo UrlHelper::generateUrl('Reviews', 'productPermalink', array($review['spreview_selprod_id'], $review['spreview_id'])) ?>"><?php echo Labels::getLabel('Lbl_Permalink', $siteLangId); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="align-center mt-4"><a href="<?php echo UrlHelper::generateUrl('Reviews', 'Product', array($selprod_id)); ?>" class="btn btn-outline-gray btn-sm"><?php echo Labels::getLabel('Lbl_Showing_All', $siteLangId) . ' ' . count($reviewsList) . ' ' . Labels::getLabel('Lbl_Reviews', $siteLangId); ?>
        </a></div>
