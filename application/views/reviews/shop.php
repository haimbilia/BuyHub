                ...
                <div class="col-lg-7">
                    <div id="itemRatings">
                        ...
                        <div class="section__body">
                            <?php $this->includeTemplate('_partial/shop-reviews.php', array('reviews' => $reviews, 'shop_rating' => $shop_rating, 'ratingAspects' => $ratingAspects, 'siteLangId' => $siteLangId, 'shop_id' => $shop['shop_id']), false); ?>
                        </div>
                    </div>
                </div>
            </div>
