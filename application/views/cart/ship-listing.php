...
<div class="cart-blocks">
    ...
    ?>
    <ul
        class="list-cart <?php echo (count($fulfillmentProdArr[Shipping::FULFILMENT_SHIP]) != $productsCount) ? '' : 'list-cart-page'; ?>">
        <?php
            ...
            <div class="info">
                <span> <svg class="svg">
                    ...
                    <a href="javascript:void(0);"
                        ...
                        class="link"><?php echo Labels::getLabel('LBL_Pickup_Entire_Order', $siteLangId); ?></a>
                    <?php } ?>
                </span>
                ...
                <div class="product-profile">
                    <div class="product-profile__thumbnail">
                        <a href="<?php echo $productUrl; ?>">
                            <img class="img-fluid" data-ratio="1:1" src="<?php echo $imageUrl; ?>"
            ...
            <div class="cell cell_qty">
                <div class="product-quantity">
                    <div class="quantity quantity-2" data-stock="<?php echo $product['selprod_stock']; ?>">
                        <span
                            class="decrease decrease-js <?php echo ($product['quantity'] <= $product['selprod_min_order_qty']) ? 'not-allowed' : ''; ?>">
                            <i class="icn">
    ...
    <ul class="list-cart list-cart-page">
        <?php foreach ($saveForLaterProducts as $product) {
            ...
            ?>
        <li
            class=" <?php echo isset($product['key']) ? md5($product['key']) : ''; ?> <?php echo (!$product['in_stock']) ? 'disabled' : ''; ?>">
            <div class="cell cell_product">
                <div class="product-profile">
                    <div class="product-profile__thumbnail">
                        <a href="<?php echo $productUrl; ?>">
