                            ...
                            <div class="sticky-summary">
                                <div class="cart-total">
                                    ...
                                    <div class="cart-action">
                                        <button class="btn btn-brand btn-block" type="button" onclick="goToCheckout()"><?php echo Labels::getLabel('LBL_Checkout', $siteLangId); ?></button>

                                        <a class="link-arrow" href="<?php echo UrlHelper::generateUrl(); ?>"><?php echo Labels::getLabel('LBL_Continue_Shopping', $siteLangId); ?></a>
                                    </div>
                                    <!-- <div class="secure">
                                        <p>
