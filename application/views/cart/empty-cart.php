...
<div class="block-empty m-auto text-center">
    <img class="block__img" width="200" height="200" src="<?php echo CONF_WEBROOT_URL; ?>images/retina/empty-cart.svg"
        alt="">
    <h3>
    ...
    <?php if ($EmptyCartItems) { ?>
        <ul class="browse-more mt-4">
            ...
            foreach ($EmptyCartItems as $item) {
                ...
                ?>
                <li class="browse-more-item">
                    <a class="browse-more-link" target="<?php echo $item['emptycartitem_url_is_newtab'] ? "_blank" : "_self" ?>"
                        href="<?php echo $itemUrl; ?>"><?php echo $item['emptycartitem_title']; ?></a>
                    <?php echo ($counter < count($EmptyCartItems)) ? '' : ''; ?>
                </li>
                <?php
                $counter++;
            } ?>
