                ...
                <li class="">
                    <div class="info">
                        ...
                        <div class="cell cell_action">
                            <a href="javascript:void(0);" onClick="removeShippedOnlyProducts();"><svg class="svg" width="20px" height="20px">
                        ...
                        <div class="cell cell_product">
                            <div class="product-profile">
                                ...
                                <div class="product-profile__data">
                                    ...
                                    <p class="text-danger pt-2"><?php echo Labels::getLabel('LBL_NOT_AVAILABLE_FOR_PICKUP', $siteLangId); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="cell cell_action">
