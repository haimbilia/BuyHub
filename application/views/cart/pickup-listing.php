                ...
                <li class="minus-space">
                    <div class="info">
                        ...
                        <div class="cell cell_action">
                            <ul class="actions">
                                <li> <a href="javascript:void(0);" onClick="removeShippedOnlyProducts();"><svg class="svg" width="20px" height="20px">
            ...
            <li class=" <?php echo md5($product['key']); ?> <?php echo (!$product['in_stock']) ? 'disabled' : ''; ?>">
                ...
                <div class="cell cell_action">
                    <ul class="actions">
                        ...
                        <?php } ?>
                        <li>
                            <a href="javascript:void(0)" onClick="moveToSaveForLater( '<?php echo md5($product['key']); ?>',<?php echo $product['selprod_id']; ?>, <?php echo Shipping::FULFILMENT_PICKUP; ?> );" title="<?php echo Labels::getLabel('LBL_Move_to_wishlist', $siteLangId); ?>">
                                <svg class="svg" width="20px" height="20px" title="<?php echo Labels::getLabel('LBL_Remove', $siteLangId); ?>">
                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#saveforlater">
                                    </use>
                                </svg>
