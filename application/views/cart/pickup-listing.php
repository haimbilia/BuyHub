            ...
            ?>
                <li class="minus-space">
                    <div class="delivery-info">
                        ...
                        <a class="btn-close" href="javascript:void(0);" onClick="removeShippedOnlyProducts();">
                    ...
                    <div class="block-detail-top">
                        ...
                        <div class="cell cell_action">
                            <ul class="actions">
                                    ...
                                    <li>
                                        <?php if (FatApp::getConfig('CONF_ADD_FAVORITES_TO_WISHLIST', FatUtility::VAR_INT, 1) == applicationConstants::NO) {
                                            if (empty($product['ufp_id'])) {  ?>
                                                <a href="javascript:void(0)" class="" onClick="addToFavourite( '<?php echo md5($product['key']); ?>',<?php echo $product['selprod_id']; ?> );" title="<?php echo Labels::getLabel('LBL_Move_to_wishlist', $siteLangId); ?>"><svg class="svg" width="20" height="20">
                                ...
                                <?php } ?>
                                <li>
                                    <a href="javascript:void(0)" onClick="moveToSaveForLater( '<?php echo md5($product['key']); ?>',<?php echo $product['selprod_id']; ?>, <?php echo Shipping::FULFILMENT_PICKUP; ?> );" title="<?php echo Labels::getLabel('LBL_SAVE_FOR_LATER', $siteLangId); ?>">
                                        <svg class="svg" width="20" height="20">
                                            <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#saveforlater">
                                            </use>
                                        </svg>
                ...
                <li class="list-cart-item <?php echo md5($product['key']); ?> <?php echo (!$product['in_stock']) ? 'disabled' : ''; ?>">
                    ...
                    <div class="block-detail">
                        <div class="block-detail-top">
                            <div class="item">
                                <div class="item__description">
                                    <h6 class="item__title"><a class="" href="<?php echo $productUrl; ?>"><?php echo $productTitle; ?></a></h6>
                                    <div class="item__specification">
                                        <?php
                                        if (isset($product['options']) && count($product['options'])) {
                                            foreach ($product['options'] as $key => $option) {
                            ...
                            <div class="cart-action">
                                <ul class="actions">
                                    <li>
                                        <a href="javascript:void(0)" onclick="moveToCart(<?php echo $product['selprod_id']; ?>, <?php echo $product['uwlp_uwlist_id']; ?>, event, <?php echo Shipping::FULFILMENT_PICKUP; ?>)">
                                            <svg class="svg" width="20" height="20">
