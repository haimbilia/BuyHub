                ...
                <div class="card-body "> 
                    <form name="frmOrderFeedback" method="post" id="frm_fat_id_frmOrderFeedback" class="form form--horizontal" action="/Yokart-V8/buyer/setup-order-feedback">
                             <div class="row justify-content-between">
                                 <div class="col-md-6">
                                    <h5 class="blocktitle">Product feedback</h5>
                                 ...
                                 <div class="col-md-5">
                                     <h5 class="blocktitle">Seller feedback</h5>
                                    <div class="shop-rating-wrap mb-4">
                                        <div class="shop-card pb-3">
                                            <div class="shop-card__img">
                                                <img src="http://yokart-v8.local.4livedemo.com/image/shop-logo/4/1/SMALL"/>                        
                                            </div> 
                                            <div class="shop-card__detail">
                                                <h6><?php echo $opDetail['op_shop_name']; ?> </h6>
                                                <span class="shop-opened">Shop Opened On Jul 19, 2017 </span>
                                            </div> 
                                        </div>
                                        <div class="rating-listing">                        
                                            <div class="rating">                            
