    ...
    public function search()
    {
        ...
        $productSrchObj->addMultipleFields(
            array(
                ...
                'theprice', 'selprod_price', 'selprod_stock', 'IF(selprod_stock > 0, 1, 0) AS in_stock', 'selprod_condition', 'prodcat_id', 'IFNULL(prodcat_name, prodcat_identifier) as prodcat_name', 'selprod_sold_count', 'product_updated_on', 'shop_id', 'selprod_min_order_qty', 'selprod_cart_type'
            )
        );
