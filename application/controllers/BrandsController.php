        ...
        if (true === MOBILE_APP_API_CALL) {
            ...
            $productCustomSrchObj->addMultipleFields(
                array(
                    ...
                    'theprice', 'selprod_price', 'selprod_stock', 'selprod_condition', 'prodcat_id', 'IFNULL(prodcat_name, prodcat_identifier) as prodcat_name', 'product_rating as prod_rating ', 'product_total_reviews as totReviews', 'selprod_sold_count', 'selprod_min_order_qty', 'selprod_cart_type', 'product_img_updated_on'
                )
            );
            if (UserAuthentication::isUserLogged()) {
