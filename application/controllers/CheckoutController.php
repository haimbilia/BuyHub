...
class CheckoutController extends MyAppController
{
    ...
    private function getCartProductInfo($selprod_id)
    {
        ...
        $fields = array(
            ...
            'seller_user.user_phone_dcode as shop_owner_phone_dcode', 'seller_user.user_phone as shop_owner_phone', 'seller_user_cred.credential_email as shop_owner_email', 'selprod_download_validity_in_days', 'selprod_max_download_times', 'ps.product_warranty', 'COALESCE(sps.selprod_return_age, ss.shop_return_age) as return_age', 'COALESCE(sps.selprod_cancellation_age, ss.shop_cancellation_age) as cancellation_age', 'product_download_attachements_with_inventory', 'selprod_product_id'
        );
        ...
        if ($cartProducts) {
            foreach ($cartProducts as $cartProduct) {
                ...
                $orderData['products'][CART::CART_KEY_PREFIX_PRODUCT . $productInfo['selprod_id']] = array(
                    ...
                    'product_download_attachements_with_inventory' => $productInfo['product_download_attachements_with_inventory'],
                );
