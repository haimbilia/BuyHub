...
class Common
{
    ...
    public static function headerUserArea($template)
    {
        ...
        if ($isUserLogged) {
            ...
            $profileImage = UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Account', 'userProfileImage', array($userId, ImageDimension::VIEW_THUMB, true)) . $uploadedTime, CONF_IMG_CACHE_TIME, '.jpg');
