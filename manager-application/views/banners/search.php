    ...
    foreach ($fields as $key => $val) {
        ...
        switch ($key) {
            ...
            case 'banner_img':
                ...
                $img = '<img width="40" height="40"  src="' . UrlHelper::generateFullUrl('Banner', 'BannerImage', array($row['banner_id'], $siteLangId, 0, 'MINITHUMB'), CONF_WEBROOT_FRONT_URL) . $uploadedTime . '" />';
