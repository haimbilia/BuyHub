...
<main class="main mainJs">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php require_once(CONF_THEME_PATH . 'volume-discount/search-form.php'); ?>
                <div class="card">
                    <?php $data = [
                        'canEdit' => $canEdit,
                        'siteLangId' => $siteLangId,
                        'cardHeadTitle' => Labels::getLabel('LBL_VOLUME_DISCOUNT_LIST', $siteLangId),
                        'newRecordBtn' => true,
                        'deleteButton' => true,
                    ];
                    ...
                    <div class="card-body">
                        <div class="table-responsive listingTableJs">
                            <?php
                            $tableId = 'volDiscountListJs';
                            require_once(CONF_THEME_PATH . '_partial/listing/listing-column-head.php');
                            require_once(CONF_THEME_PATH . 'volume-discount/search.php');
