...
$keywordPlaceholder = Labels::getLabel('FRM_SEARCH_BY_PURCHASE_AMOUNT', $siteLangId); ?>

<main class="main mainJs">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php require_once(CONF_THEME_PATH . 'rewards-on-purchase/search-form.php'); ?>
                <div class="card">
                    <?php $data = [
                        'canEdit' => $canEdit,
                    ...
                    <div class="card-body">
                        <div class="table-responsive listingTableJs">
                            ...
                            require_once(CONF_THEME_PATH . 'rewards-on-purchase/search.php');
