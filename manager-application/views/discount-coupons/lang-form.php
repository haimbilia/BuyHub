...
<div class="col-sm-12">
	...
	<div class="tabs_nav_container responsive flat">
		<ul class="tabs_nav">
			...
			<li class="<?php echo $inactive;?>"><a href="javascript:void(0);" <?php if($coupon_id>0){?> onclick="couponMediaForm(<?php echo $coupon_id ?>);" <?php }?>><?php echo Labels::getLabel('LBL_Media',$siteLangId);?></a></li>
		</ul>
