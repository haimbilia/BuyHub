...
if (isset($img) && !empty($img)) {
    $htmlAfterField .= '<ul class="grids--onethird"> <li><div class="uploaded--image"><img src="'.UrlHelper::generateFullUrl('Image', 'SocialPlatform', array($splatform_id,'THUMB'), CONF_WEBROOT_FRONT_URL).'?t='.time().'"<a href="javascript:void(0);" onClick="removeImg('.$splatform_id.')" class="remove--img"><i class="ion-close-round"></i></a></div></li></ul>';
}
