...
$keywordPlaceholder = Labels::getLabel('LBL_SEARCH_ZONES', $siteLangId);
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <?php $data = [
                        ...
                        'recordsTitle' => CommonHelper::replaceStringData(Labels::getLabel('LBL_OVER_{COUNT}_ZONES', $siteLangId), ['{COUNT}' => $recordCount]),
                        'newRecordBtn' => true,
                        'statusButtons' => true
                    ];
