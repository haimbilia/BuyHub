...
if (!empty($translatorSubscriptionKey) && $nav_lang_id != $siteDefaultLangId) {
    ...
    $langFld->htmlAfterField = '<a href="javascript:void(0);" onclick="addLangForm(' . $nav_id . ', ' . $nav_lang_id . ', 1)" class="btn" title="' .  Labels::getLabel('BTN_AUTOFILL_LANGUAGE_DATA', $siteLangId) . '">
