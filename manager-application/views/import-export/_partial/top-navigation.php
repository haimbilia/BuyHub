...
<ul class="importExportUlJs">
    <li class="settings-inner-item <?php echo !empty($action) && $action == 'generalInstructions' ? 'is-active' : ''; ?>">
        <a class="settings-inner-link" href="javascript:void(0)" onClick="loadForm('general_instructions', this)">
            ...
            <div class="">
                <h6 class="settings-inner-title"><?php echo Labels::getLabel('LBL_INSTRUCTIONS', $adminLangId); ?></h6>
