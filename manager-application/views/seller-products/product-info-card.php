...
<div class="product-profile">
    ...
    <div class="product-profile__data">
        ...
        <?php
        if (isset($canViewProducts)  && $canViewProducts == true) { ?>
            <a href="javascript:void(0)" class="sub-title" onclick="redirectfunc('<?php echo UrlHelper::generateUrl('Products');?>',{product_id : <?php echo $product['selprod_product_id'];?>});" class="product-profile">
