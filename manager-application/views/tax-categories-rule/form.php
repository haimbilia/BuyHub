...
$fromCountryFld->setFieldTagAttribute('onChange', 'getCountryStates(this.value,0,\'#taxruleloc_from_state_id\')');
...
$toCountryFld->setFieldTagAttribute('onChange', 'getCountryStatesTaxInTaxForm(this, this.value,0)');
