            ...
            <div class="row">
                ...
                <div class="col-md-12 js-slot-individual">
                    <table class="table table-slots">
                        <thead>
                            <tr>
                                <th><?php echo Labels::getLabel('LBL_DAYS', $siteLangId); ?></th>
                                <th><?php echo Labels::getLabel('LBL_FROM', $siteLangId); ?></th>
                                <th><?php echo Labels::getLabel('LBL_TO', $siteLangId); ?></th>
                                        ...
                                        <tr data-count="<?php echo $row; ?>" class="rows timeSlotJs jsDay-<?php echo $i; ?> row-<?php echo $row . $class; ?>">
                                            <td class="align-middle jsWeekDay">
                                                <?php if ($key == 0) { ?>
                                                    ...
                                                    <div class="allDaysJs d-none"><?php echo Labels::getLabel('LBL_ALL', $siteLangId); ?></div>
                                                <?php }
                                                ?>
                                            </td>
                                            <td>
