...
<main class="main mainJs">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php require_once(CONF_THEME_PATH . 'brand-requests/search-form.php'); ?>
                <div class="card">
                    <?php $data = [
                        'canEdit' => $canEdit,
                        'siteLangId' => $siteLangId,
                        'cardHeadTitle' => Labels::getLabel('LBL_Manage_Product_Brand_Requests', $siteLangId),
                        'newRecordBtn' => false,
                        'statusButtons' => false,
                        'deleteButton' => false
                    ];
                    ...
                    <div class="card-body">
                        <div class="table-responsive listingTableJs">
                            ...
                            require_once(CONF_THEME_PATH . 'brand-requests/search.php');
