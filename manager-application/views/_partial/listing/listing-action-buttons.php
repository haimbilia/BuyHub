...
if (isset($dropdownButtons) && is_array($dropdownButtons)) {
    $li = $ul->appendElement('li', ['class' => 'dropdown', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => Labels::getLabel('LBL_ACTION_BUTTONS', $siteLangId)]);
    $li->appendElement('a', array('href' => 'javascript:void(0)', 'data-toggle' => 'dropdown', 'aria-haspopup' => 'true',  'aria-expanded' => 'false'), '<svg class="svg" width="18" height="18">
    ...
    if (isset($dropdownButtons['otherButtons'])) {
        ...
        foreach ($ddOtherButtons as $btn) {
            ...
            $attr = array_merge($attr, ['data-toggle' => 'tooltip', 'data-placement' => 'top']);
