...
<?php
$_COOKIE['adminSidebar'] = isset($_COOKIE['adminSidebar']) && !empty($_COOKIE['adminSidebar']) ? $_COOKIE['adminSidebar'] : 'off';
?>

<body class="<?php echo $bodyClass; ?>" data-sidebar-minimize="<?php echo $_COOKIE['adminSidebar']; ?>">
