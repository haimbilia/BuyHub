        ...
        <header class="main-header mainHeaderJs">
                    ...
                    <div class="main-header-toolbar">
                        <div class="header-action">
                            ...
                            <div class="header-action__item dropdown header-account">
                                ...
                                <div
                                    class="header-action__target p-0 dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim">
                                    ...
                                    <nav class="nav nav--header-account">
                                        ...
                                        <a class="language-selector collapsed" data-toggle="collapse" href="#languages"
                                            role="button" aria-expanded="false" aria-controls="languages">
                                        ...
                                        <div class="languages collapse" id="languages" style="">
                                            ...
                                            <a class="languages-link <?php echo ($siteLangId == $languageId) ? 'class="is--active"' : ''; ?>"
                                                href=""
                                                onclick="setSiteDefaultLang(<?php echo $languageId; ?>)"><?php echo $language['language_name']; ?></a>
                                            <?php } ?>
                                        </div>
                                        <?php
                                        } ?>
            ...
            <div class="alert alert-solid-warning fade alertWarningJs show" role="alert">
                ...
                <div class="alert-close">
                    <button type="button" class="close closeAlertJs <?php echo 'alert_' . $pageData['plang_id']; ?>"
