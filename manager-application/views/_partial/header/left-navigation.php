<sidebar class="sidebar sidebar-hoverable" id="sidebar" data-close-on-click-outside="sidebar">
    <div class="sidebar-logo">
        <a href="#" class="logo">
            ...
            ?>
            <img width="34" height="34" <?php if ($fileData['afile_aspect_ratio'] > 0) { ?>
                ...
                src="<?php echo UrlHelper::getCachedUrl(UrlHelper::generateFileUrl('Image', 'siteAdminLogo', array($siteLangId)) . $uploadedTime, CONF_IMG_CACHE_TIME, '.jpg'); ?>"
    ...
    <div class="sidebar-menu sidebarMenuJs">
        <ul class="menu">
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs"
                    title="<?php echo Labels::getLabel('NAV_PRODUCT_CATALOG', $siteLangId); ?>">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('Brands'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('Shops'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_SHOPS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('ProductCategories'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_CATEGORIES', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('Options'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_OPTIONS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    title="<?php echo Labels::getLabel('NAV_REQUESTS', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                                xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#icon-requests">
                            </use>
                        </svg>
                    </span>
                ...
                <div class="sidebar-dropdown-menu">
                    <ul class="nav">
                        ...
                        <li class="nav_item">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('brandRequests'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_BRAND_REQUEST', $siteLangId); ?><?php if ($brandReqCount) { ?>(<?php echo $brandReqCount; ?>)<?php } ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        <?php if ($objPrivilege->canViewProductCategories(AdminAuthentication::getLoggedAdminId(), true)) { ?>
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('ProductCategoriesRequest'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_CATEGORIES_REQUESTS', $siteLangId); ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('sellerApprovalRequests'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_SELLER_APPROVAL_REQUESTS', $siteLangId); ?><?php if ($supReqCount) { ?>(<?php echo $supReqCount; ?>)<?php } ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('thresholdProducts'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_THRESHOLD_PRODUCTS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('RatingTypes'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
            ...
            <li class="menu-item dropdownJs">
                ...
                <div class="sidebar-dropdown-menu">
                    <ul class="nav">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                ...
                                <span class="nav_icon">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_ORDERS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('SubscriptionOrders'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_SUBSCRIPTION_ORDERS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('OrderCancelReasons'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_ORDER_CANCEL_REASONS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('OrderReturnReasons'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('OrderStatus'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_ORDER_STATUSES', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    title="<?php echo Labels::getLabel('NAV_USERS', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                ...
                                <span
                                    class="nav_text"><?php echo Labels::getLabel('NAV_ADMIN_USERS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('Users'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('Rewards'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                ...
                                <span
                                    class="nav_text"><?php echo Labels::getLabel('NAV_REWARDS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('Transactions'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('DeletedUsers'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('UsersAddresses'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                ...
                                <span
                                    class="nav_text"><?php echo Labels::getLabel('NAV_USERS_ADDRESSES', $siteLangId); ?></span>
                            </a>
                        </li>
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('userGdprRequests'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                ...
                                <span
                                    class="nav_text"><?php echo Labels::getLabel('NAV_GDPR_REQUESTS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    title="<?php echo Labels::getLabel('NAV_PROMOTIONS', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                ...
                <div class="sidebar-dropdown-menu">
                    <ul class="nav">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('SpecialPrice'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                ...
                                <span
                                    class="nav_text"><?php echo Labels::getLabel('NAV_SPECIAL_PRICE', $siteLangId); ?></span>
                            </a>
                        </li>

                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('VolumeDiscount'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                ...
                                <span
                                    class="nav_text"><?php echo Labels::getLabel('NAV_VOLUME_DISCOUNT', $siteLangId); ?></span>
                            </a>
                        </li>

                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('RelatedProducts'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('SmartRecomendedWeightages'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('RecomendedTagProducts'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                ...
                                <span
                                    class="nav_text"><?php echo Labels::getLabel('NAV_RECOMMENDED_TAG_PRODUCTS_WEIGHTAGES', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    title="<?php echo Labels::getLabel('NAV_BLOG', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                                xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#icon-blog">
                            </use>
                        </svg>
                    </span>
                ...
                <div class="sidebar-dropdown-menu">
                    <ul class="nav">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('BlogPostCategories'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_BLOG_POST_CATEGORIES', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('BlogPosts'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_BLOG_POSTS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('BlogContributions'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_BLOG_CONTRIBUTIONS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('BlogComments'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_BLOG_COMMENTS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    title="<?php echo Labels::getLabel('NAV_TAX', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                ...
                <div class="sidebar-dropdown-menu">
                    <ul class="nav">
                        ...
                        <li class="nav_item">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('TaxStructure'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_TAX_STRUCTURE', $siteLangId); ?></span>
                            </a>
                        </li>

                        <li class="nav_item">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('TaxCategories'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_TAX_CATEGORIES', $siteLangId); ?></span>
                            </a>
                        </li>
                        <li class="nav_item">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('TaxCategoriesRule'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_TAX_CATEGORIES_RULE', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    title="<?php echo Labels::getLabel('NAV_CMS', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                                xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#icon-CMS">
                            </use>
                        </svg>
                    </span>
                ...
                <div class="sidebar-dropdown-menu">
                    <ul class="nav">
                        ...
                        <li class="nav_item">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('ContentPages'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('ContentBlock'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_CONTENT_BLOCK', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('FaqCategories'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_FAQS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('Testimonials'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_TESTIMONIALS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs"
                    title="<?php echo Labels::getLabel('NAV_REPORTS', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                    ...
                    <ul class="nav" id="reportsNav">
                        ...
                        <li class="nav_item hasNestedChildJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom" data-toggle="collapse"
                                data-parent="#reportsNav" href="#salesReportNav" aria-expanded="true">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_SALES_REPORTS', $siteLangId); ?></span>
                            ...
                            <div id="salesReportNav" class="panel-collapse collapse collapseJs">
                                <ul class="nav nav-level">
                                    ...
                                    <li class="nav_item navItemJs">
                                        <a class="nav_link navLinkJs dropdown-toggle-custom"
                                            href="<?php echo UrlHelper::generateUrl('SalesReport'); ?>">
                                            <span
                                                class="nav_text"><?php echo Labels::getLabel('NAV_SALES_OVER_TIME', $siteLangId); ?></span>
                                        </a>
                                    </li>
                                    <?php } ?>
                                    ...
                                    <li class="nav_item navItemJs">
                                        <a class="nav_link navLinkJs dropdown-toggle-custom"
                                            href="<?php echo UrlHelper::generateUrl('CatalogReport'); ?>">
                                            <span
                                                class="nav_text"><?php echo Labels::getLabel('NAV_PRODUCTS', $siteLangId); ?></span>
                                        </a>
                                    </li>
                                    <?php } ?>
                                    ...
                                    <li class="nav_item navItemJs">
                                        <a class="nav_link navLinkJs dropdown-toggle-custom"
                                            href="<?php echo UrlHelper::generateUrl('ProductsReport'); ?>">
                                            <span
                                    ...
                                    <li class="nav_item navItemJs">
                                        <a class="nav_link navLinkJs dropdown-toggle-custom"
                                            href="<?php echo UrlHelper::generateUrl('ShopsReport'); ?>">
                                            <span
                                                class="nav_text"><?php echo Labels::getLabel('NAV_SHOPS', $siteLangId); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav_item navItemJs">
                                        <a class="nav_link navLinkJs dropdown-toggle-custom"
                                            href="<?php echo UrlHelper::generateUrl('BuyersReport'); ?>">
                                            <span
                                                class="nav_text"><?php echo Labels::getLabel('NAV_CUSTOMERS', $siteLangId); ?></span>
                                        </a>
                                    </li>
                                    <?php } ?>
                                </ul>
                        ...
                        <li class="nav_item hasNestedChildJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom" data-toggle="collapse"
                                data-parent="#financialReportNav" href="#financialReportNav" aria-expanded="true">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item hasNestedChildJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom" data-toggle="collapse"
                                data-parent="#subscriptionReportNav" href="#subscriptionReportNav" aria-expanded="true">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    title="<?php echo Labels::getLabel('NAV_IMPORT_EXPORT', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                ...
                                <span class="nav_icon">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_IMPORT_EXPORT', $siteLangId); ?></span>
                            </a>
                        </li>
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    title="<?php echo Labels::getLabel('NAV_SHIPPING/PICKUP', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                                xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#icon-shipping-pickup">
                            </use>
                        </svg>
                    </span>
                ...
                <div class="sidebar-dropdown-menu">
                    <ul class="nav">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('ShippingCompanyUsers'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_SHIPPING_COMPANY_USERS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                ...
                                <span
                                    class="nav_text"><?php echo Labels::getLabel('NAV_GENERATE_SITEMAP', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('PickupAddresses'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_PICKUP_ADDRESSES', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('ShippedProducts'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_SHIPPED_PRODUCTS', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('TrackingCodeRelation'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_TRACKING_CODE_RELATION', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
            ...
            <li class="menu-item dropdownJs">
                <div class="menu-section menuLinkJs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                    title="<?php echo Labels::getLabel('NAV_SEO', $siteLangId); ?>">
                    <span class="menu-icon">
                        <svg class="svg" width="24" height="24">
                            <use
                ...
                <div class="sidebar-dropdown-menu">
                    <ul class="nav">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('UrlRewriting'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_URL_REWRITING', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('ImageAttributes'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('sitemap', 'generate'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom" target="_blank"
                                ...
                                <span class="nav_icon">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_VIEW_HTML', $siteLangId); ?></span>
                            </a>
                        </li>
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom" target="_blank"
                                ...
                                <span class="nav_icon">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_VIEW_XML', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li class="nav_item navItemJs">
                            <a class="nav_link navLinkJs dropdown-toggle-custom"
                                href="<?php echo UrlHelper::generateUrl('MetaTags'); ?>">
                                <span class="nav_icon">
                                    <svg class="svg" width="24" height="24">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-aside-menu.svg#test">
                                    ...
                                    class="nav_text"><?php echo Labels::getLabel('NAV_META_TAGS_MANAGEMENT', $siteLangId); ?></span>
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
