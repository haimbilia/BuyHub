    ...
    <div class="card card--height-fluid-">
        <div class="card-head  card-head--noborder">
            ...
            <div class="card-head-toolbar">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-fit dropdown-menu-md" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(325px, 51px, 0px);">
                    <!--begin::Nav-->
