                                        ...
                                        <a class="settings-inner-link" rel=<?php echo $tabsId; ?> href="javascript:void(0)" onclick="<?php echo $onclick; ?>">
                                            <i class="settings-inner-icn">
                                                <svg class="svg" width="20" height="20">
                                                    <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.yokart.svg#<?php echo isset($svgIconNames[$formType]) ? $svgIconNames[$formType] : 'icon-system-setting' ?>">
                                                    </use>
                                                </svg>
                                            </i>
                                            <div>
