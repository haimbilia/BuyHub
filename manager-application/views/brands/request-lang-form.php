...
if (!empty($translatorSubscriptionKey) && $brand_lang_id != $siteDefaultLangId) {
    ...
    $langFld->htmlAfterField = '<a href="javascript:void(0);" onclick="brandRequestLangForm(' . $brand_id . ', ' . $brand_lang_id . ', 1)" class="btn" title="' .  Labels::getLabel('BTN_AUTOFILL_LANGUAGE_DATA', $siteLangId) . '">
