...
$keywordPlaceholder = Labels::getLabel('LBL_SEARCH_BRANDS', $siteLangId);
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <?php $data = [
                        ...
                        'recordsTitle' => CommonHelper::replaceStringData(Labels::getLabel('LBL_OVER_{COUNT}_BRANDS', $siteLangId), ['{COUNT}' => $recordCount]),
                        'newRecordBtn' => true,
                        'statusButtons' => true,
                        'deleteButton' => true
                    ];
