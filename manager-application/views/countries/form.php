...
<div class="modal-body form-edit">
    <div class="form-edit-head">
        <nav class="nav nav-tabs">
            <a class="nav-link active" href="javascript:void(0)" onclick="editRecord(<?php echo $countryId ?>);">
                <?php echo Labels::getLabel('LBL_General', $adminLangId); ?>
            </a>
            <a class="nav-link <?php echo $disabled; ?>" href="javascript:void(0);" <?php echo (0 < $countryId) ? "onclick='editLangData(" . $countryId . "," . FatApp::getConfig('conf_default_site_lang', FatUtility::VAR_INT, 1) . ");'" : ""; ?>>
