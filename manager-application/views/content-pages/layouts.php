				...
				<div class="sectionbody padd15">
					<div class="row">
						...
						<div class="shop-template"> 
							<a rel="facebox" onClick="displayImageInFacebox('<?php echo UrlHelper::generateFullUrl(); ?><?php echo CONF_WEBROOT_FRONT_URL; ?>images/cms_layouts/layout-1.jpg');" href="javascript:void(0)">
						...
						<div class="shop-template padding20">
							<a rel="facebox" onClick="displayImageInFacebox('<?php echo UrlHelper::generateFullUrl(); ?><?php echo CONF_WEBROOT_FRONT_URL; ?>images/cms_layouts/layout-2.jpg');" href="javascript:void(0)">
