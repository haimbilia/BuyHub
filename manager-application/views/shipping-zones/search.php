    ...
    foreach ($zones as $zone) {
        ...
        <div class="py-4 border-bottom zoneRates-js">
            <div id="" class="row justify-content-between my-4">
                ...
                <div class="col-auto">
                    <div class="dropdown">
                        <a class="btn btn-clean btn-sm btn-icon" href="javascript:void(0);" onClick="zoneForm(<?php echo $profile_id; ?>, <?php echo $zone['shipzone_id'] ?>)" title="<?php echo Labels::getLabel("LBL_Edit", $siteLangId); ?>">
                            <svg class="svg" width="18" height="18">
                            <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>/images/retina/sprite-actions.svg#edit">
                            </use>
                            </svg>
                        </a>
                        <a class="btn btn-clean btn-sm btn-icon" href="javascript:void(0);" onClick="deleteZone(<?php echo $shipProZoneId ?>)" title="<?php echo Labels::getLabel("LBL_Delete", $siteLangId); ?>">
                            <svg class="svg" width="18" height="18">
                    ...
                    <tbody>
                        <?php foreach ($shipRates as $rate) { ?>
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <a class="btn btn-clean btn-sm btn-icon" href="javascript:void(0);" onclick="addEditShipRates(<?php echo $rate['shiprate_shipprozone_id'] ?>, <?php echo $rate['shiprate_id'] ?>);" title="<?php echo Labels::getLabel("LBL_Edit", $siteLangId); ?>">
                                            <svg class="svg" width="18" height="18">
                                            <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>/images/retina/sprite-actions.svg#edit">
                                            </use>
                                            </svg>
                                        </a>
                                        <a class="btn btn-clean btn-sm btn-icon" href="javascript:void(0);" onClick="deleteRate(<?php echo $rate['shiprate_id'] ?>)" title="<?php echo Labels::getLabel("LBL_Delete", $siteLangId); ?>">
                                            <svg class="svg" width="18" height="18">
                                            <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>/images/retina/sprite-actions.svg#delete">
                                            </use>
                                            </svg>
            ...
            <?php } ?>
            <div class="row">
                <div class="col"><button type="button" class="btn btn-secondary" onclick="addEditShipRates(<?php echo $shipProZoneId; ?>, 0);"><i class="ion-ios-plus-empty icon"></i> <?php echo Labels::getLabel("LBL_Add_Rate", $siteLangId); ?></button>
                </div>
            </div>
        </div>
        <?php
