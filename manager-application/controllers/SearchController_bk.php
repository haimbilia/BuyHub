...
class SearchController extends ListingBaseController
{
    ...
    public function getSearchForm(array $fields = [])
    {
        ...
        $frm->addSelectBox(Labels::getLabel('FRM_ACTIVE', $this->siteLangId), 'user_active', array(-1 => 'Does not Matter', 0 => 'No', 1 => 'Yes'), -1, array(), Labels::getLabel('FRM_SELECT', $this->siteLangId));
