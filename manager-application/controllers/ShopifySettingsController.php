...
class ShopifySettingsController extends DataMigrationSettingsController
{
    ...
    public static function form($langId)
    {
        ...
        $frm->addHtml('info', 'info', '<p class="text-muted">'.Labels::getLabel('MSG_SHOPIFY_MULTIVENDOR_PLUGIN_INFO', $langId).'</br><a href="https://apps.shopify.com/multi-vendor-marketplace">https://apps.shopify.com/multi-vendor-marketplace</a></p></br>');
