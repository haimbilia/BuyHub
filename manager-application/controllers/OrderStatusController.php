...
class OrderStatusController extends ListingBaseController
{
    ...
    public function form()
    {
        ...
        if (0 < $recordId) {
            $data = OrderStatus::getAttributesByLangId(CommonHelper::getDefaultFormLangId(), $recordId, array('orderstatus_id', 'orderstatus_name', 'orderstatus_is_active', 'orderstatus_is_digital', 'orderstatus_color_class','orderstatus_type'), true);
    ...
    protected function getLangForm($recordId = 0, $langId = 0)
    {
        ...
        $frm->addRequiredField(Labels::getLabel('LBL_orderstatus_Name', $langId), 'orderstatus_name');       
        return $frm;
    }
