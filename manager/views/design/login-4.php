            ...
            <div class="login__wrapper">
                <div class="login-aside" style="background-image: url(./media/bg/bg-page-section.png)">
                    <div class="login-aside__head">
                        <a href="#" class="login-v3-aside__logo"><img
                                src="<?php echo CONF_WEBROOT_URL;?>images/logos/logo-icon-sm.png" /></a>
                    </div>
                    <div class="login-aside___body">
                        <div class="login-aside__content">
                            <h3>Welcome to fatbit!</h3>
                            <p>The ultimate Bootstrap & Angular 6 admin theme framework for next generation web apps.
                            </p>
                        </div>
                    </div>
                ...
                <div class="login-main form-center">
                    <div class="login-main__body">
                        <form class="form form--login">
                            <h3 class="mb-4">Sign in to YO!kart</h3>
                            <div class="form-group">
                                <input class="form-control" title="Username" placeholder="Username" type="text"
                                    value="">
                            </div>
                            <div class="form-group">
                                <input class="form-control" title="Password" placeholder="Password" type="password"
                                    value="">
                            </div>
