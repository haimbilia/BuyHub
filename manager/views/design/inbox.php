			...
			<div class="content content--fit-top  grid__item grid__item--fluid grid grid--hor" id="content">
				...
				<div class="container  grid__item grid__item--fluid">
					...
					<div class="grid grid--desktop grid--ver-desktop  inbox" id="inbox">
						...
						<!--Begin:: Inbox List-->
						<div class="grid__item grid__item--fluid    card    inbox__list inbox__list--shown" id="inbox_list">
							<div class="card-head">
							...
							<div class="card-body card__body--fit-x">
						...
						<!--Begin:: Inbox View-->
						<div class="grid__item grid__item--fluid    card    inbox__view inbox__view--shown-" id="inbox_view">
							<div class="card-head">
