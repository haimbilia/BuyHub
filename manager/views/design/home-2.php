...
?>
        <div class="body " id="body">
            <div class="content " id="content">
                    ...
                    <div class="card card--height-fluid">
                        <div class="card-body align-items-center card__body--fluid">
                                <div class="col-xl-6 col-md-6 col-sm-12">
                                    <h3 class="help-title">How Can We Help?</h3>
                                    <div class="wide-70">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <span class="home-media media-responsive-hide">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card iconbox iconbox--brand iconbox--animate-slower">
                        <div class="card-body">
                        ...
                        <div class="col-xl-4">
                            <div class="card iconbox iconbox--success iconbox--animate-slow">
                            <div class="card-body">
                            <div class="iconbox__body">
                            <div class="iconbox__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
                        ...
                        <div class="col-xl-4">
                            <div class="card iconbox iconbox--warning iconbox--animate-fast">
                            <div class="card-body">
                            <div class="iconbox__body">
                            <div class="iconbox__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
                ...
                <div class="row">
                    ...
                    <div class="card card--height-fluid">
                        <div class="card-head">
                            <div class="card-head-label">
                                <h3 class="card-head-title">AirPlus SAAS License</h3>
                            </div>
                        ...
                        <div class="card-body">
                                <div class="widget12">
                                    <div class="widget12__content">
                                        <h3 class="card-head-title">Basic License</h3>
                                ...
                                </div><div class="widget12">
                                    <div class="widget12__content">
                                        <h3 class="card-head-title">Extended License</h3>
                                        <p>Windows 10 automatically downloads and installs updates to make sure your device is secure and up to date. This means you receive the latest fixes and security updates, helping your device run efficiently and stay protected. In most cases, restarting your device completes the update. Make sure your device is plugged in when you know updates will be installed.</p>
                                        <a href="#">Read More</a>
                                    </div>
                                </div>
