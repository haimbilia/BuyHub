                            ...
                            <div class="subheader__toolbar">
                                <div class="subheader__wrapper">
                                    <a href="#" class="btn subheader__btn-secondary">
                                        Discard
                                    </a> <a href="#" class="btn btn-danger subheader__btn-options"
                    ...
                    <div class="container">
                        <div class="card">
                            <div class="card-body card__body--fit">
                                <div class="grid  wizard-v2 wizard-v2--white" id="wizard_v2"
                                    data-FATbitwizard-state="first">
                                    <div class="grid__item wizard-v2__aside">
                                        <!--begin: Form Wizard Nav -->
                                        <div class="wizard-v2__nav">
                                            <div class="wizard-v2__nav-items">
                                                <!--doc: Replace A tag with SPAN tag to disable the step link click -->
                                                <div class="wizard-v2__nav-item" data-FATbitwizard-type="step"
                                                    data-FATbitwizard-state="current">
                                                ...
                                                <div class="wizard-v2__nav-item" data-FATbitwizard-type="step"
                                                    data-FATbitwizard-state="pending">
                                                    <div class="wizard-v2__nav-body">
                                                        <div class="wizard-v2__nav-icon">
                                                ...
                                                <div class="wizard-v2__nav-item" href="#" data-FATbitwizard-type="step"
                                                    data-FATbitwizard-state="pending">
                                                    <div class="wizard-v2__nav-body">
                                                        <div class="wizard-v2__nav-icon">
                                    ...
                                    <div class="grid__item grid__item--fluid wizard-v2__wrapper">
                                        ...
                                        <form class="form" id="form" novalidate="novalidate">
                                            ...
                                            <div class="wizard-v2__content" data-FATbitwizard-type="step-content"
                                                data-FATbitwizard-state="current">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="fname"
                                                                        placeholder="Short sleeve t-shirt" value="">
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class=""><img src="../media/editor.jpg" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        name="fname" placeholder="7" value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        name="fname" placeholder="15" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form__section form__section--first">
                                                    <div class="wizard-v2__form">
                                                        <div class="row">
                                                            <div class="col-xl-8">
                                                                <div class="form-group">
                                                                    <label>Do you want to track inventory for this
                                                                        product?</label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control"
                                                                        name="postcode" placeholder="50" value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4">
                                                                <div class="form-group">
                                                ...
                                                <div class="form__section form__section--first">
                                                    <div class="wizard-v2__form">
                                                        <div class="row">
                                                            <div class="col-xl-8">
                                                                <div class="form-group">
                                                                    <label>This product has multiple options, like
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-4">
                                                                        <div class="form-group"><input type="text"
                                                                                ...
                                                                                placeholder="Color" value=""></div>
                                                                    </div>
                                                                    <div class="col-xl-8">
                                                                        <div class="form-group">
                                                                            <div class="icon-group">
                                                                                <input type="text" class="form-control"
                                                                                    name="" placeholder="tagify"
                                                                                    value="">

                                                                                <a href="javascript:;"
                                                                                    data-repeater-delete=""
                                                                                    class="btn btn-icon btn-label-brand ml-2">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-9">
                                                                <a href="javascript:;" data-repeater-create=""
                                                                    class="btn btn-bold btn-label-brand">
                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="icon-group"><input type="text"
                                            ...
                                            <div class="wizard-v2__content" data-FATbitwizard-type="step-content"
                                                ...
                                                <div class="form__section form__section--first">
                                                    ...
                                                    <div class="wizard-v2__form">
                                                        ...
                                                        <div class="row">
                                                            <label class="col-xl-3 col-form-label">Country of origin
                                                            </label>
                                                            <div class="col-xl-9">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" name=""
                                                        ...
                                                        <div class="shape-bg-color-1 p-3 rounded">
                                                            ...
                                                            <div class="form-group row">
                                                                <label
                                                                    class="col-lg-2 col-form-label">Collections</label>
                                                                <div class="col-lg-10">
                                                                    <input type="text" class="form-control" name=""
                                                                        placeholder="tagify" value="">

                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-2 col-form-label">Size
                                                                    Chart:</label>
                                                                <div class="col-lg-10">
                                                                    <div class="dropzone dropzone-multi"
                                                                        ...
                                                                        <div class="dropzone-panel">
                                                                            <a
                                                                                class="dropzone-select btn btn-label-brand btn-bold btn-sm dz-clickable">Attach
                                                                                files</a>
                                                                        </div>
                                                                        <div class="dropzone-items">

                                                                        </div>
                                                                        <div class="dz-default dz-message"><span>Drop
                                                                                files here to upload</span></div>
                                                                    </div><span class="form-text text-muted">Max file
                                                                        size is 1MB and max number of files is 5.</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="wizard-v2__content" data-FATbitwizard-type="step-content"
                                                ...
                                                <div class="form__section form__section--first">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label class="checkbox">
                                                                <input type="checkbox"> Upload separate images for each
                                                                color option <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="form-text text-muted">Only Youtube Video URL or
                                                            Youtube Embeded Code can be used.</span>
                                                        ...
                                                        <div class="col-xl-9">
                                                            ...
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control" readonly=""
                                                                    value="05/20/2017" id="datepicker_3">
                                            ...
                                            <div class="form__actions">
                                                <button
                                                    class="btn btn-secondary btn-md btn-tall btn-wide font-bold font-transform-u"
                                                    data-FATbitwizard-type="action-prev">
                                                    Previous
                                                </button>
                                                <button
                                                    class="btn btn-success btn-md btn-tall btn-wide font-bold font-transform-u"
                                                    data-FATbitwizard-type="action-submit">
                                                    Submit
                                                </button>
                                                <button
                                                    class="btn btn-brand btn-md btn-tall btn-wide font-bold font-transform-u"
                                                    data-FATbitwizard-type="action-next">
                                                    Next Step
                                                </button>
                                            </div>
                                            <!--end: Form Actions -->
