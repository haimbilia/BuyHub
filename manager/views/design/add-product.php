                        ...
                        <div class="subheader__toolbar">
                            <div class="subheader__wrapper">
                                <a href="#" class="btn subheader__btn-secondary">
                                    Discard
                                </a> <a href="#" class="btn btn-danger subheader__btn-options" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Save
                                </a>
                                        ...
                                        <div class="wizard-v2__content" data-FATbitwizard-type="step-content" data-FATbitwizard-state="current">
                                            <div class="form__section form__section--first">
                                                <div class="wizard-v2__form">
                                                    ...
                                                    <div class="separator separator--border-dashed separator--space-lg">
                                                    </div>
                                                    <div class="row mb-4">
                                                            ...
                                                            <div class="col-lg-10">
                                                                <div class="dropzone dropzone-multi" id="dropzone_5">
                                                                    <div class="dropzone-panel">
                                                                        <a class="dropzone-select btn btn-label-brand btn-bold btn-sm dz-clickable">Attach
                                                                            files</a>
                                                                    </div>
