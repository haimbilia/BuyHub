                ...
                <div class="container">
                    <div class="alert alert-light alert-elevate" role="alert">
                        ...
                        <div class="alert-text">
                            The Metronic Datatable supports language translations for the texts and messages.
                            You can either define the texts and messages the respective configuration options as shown in this demo. In this example we showed you spanish translation demo.
                        </div>
                    </div>
                    ...
                    <div class="card card--mobile">
                        ...
                        <div class="card-body card__body--fit">
                            <!--begin: Datatable -->
                            <div class="datatable datatable--default datatable--brand datatable--loaded" id="base_translation" style="">
                                ...
                                <div class="datatable__pager datatable--paging-loaded">
                                    <ul class="datatable__pager-nav">
                                        <li><a title="Primero" class="datatable__pager-link datatable__pager-link--first datatable__pager-link--disabled" data-page="1" disabled="disabled"><i class="flaticon2-fast-back"></i></a></li>
                                        <li><a title="Anterior" class="datatable__pager-link datatable__pager-link--prev datatable__pager-link--disabled" data-page="1" disabled="disabled"><i class="flaticon2-back"></i></a></li>
                                        <li style=""></li>
                                        <li style="display: none;"><input type="text" class="pager-input form-control" title="Número de página"></li>
                                        ...
                                        <li style=""></li>
                                        <li><a title="Siguiente" class="datatable__pager-link datatable__pager-link--next" data-page="2"><i class="flaticon2-next"></i></a></li>
                                        <li><a title="Último" class="datatable__pager-link datatable__pager-link--last" data-page="4"><i class="flaticon2-fast-next"></i></a></li>
                                    </ul>
                                    <div class="datatable__pager-info">
                                        <div class="dropdown bootstrap-select datatable__pager-size" style="width: 60px;"><select class="selectpicker datatable__pager-size" title="Seleccionar tamaño de página" data-width="60px" data-selected="10" tabindex="-98">
                                            ...
                                            </select><button type="button" class="btn dropdown-toggle btn-light" data-bs-toggle="dropdown" role="combobox" aria-owns="bs-select-3" aria-haspopup="listbox" aria-expanded="false" title="Seleccionar tamaño de página">
                                                <div class="filter-option">
                                                    <div class="filter-option-inner">
                                        ...
                                        </div><span class="datatable__pager-detail">Viendo 1 - 10 de 40 registros</span>
                                    </div>
                                </div>
                            </div>
                            <!--end: Datatable -->
