                        ...
                        <div class="row">
                                    ...
                                    <div class="card-head">
                                        ...
                                        <div class="card-head-toolbar">
                                            <div class="dropdown dropdown-inline">
                                                <button type="button" class="btn btn-clean btn-icon"
                                    ...
                                    <div class="card-foot hidden">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <span class="margin-left-10">or <a href="#"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="scroll scroll-y" data-scroll="true" data-height="200"
                                            data-scrollbar-shown="true" style="height: 200px;">
                                            Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        Lorem Ipsum is simply dummy text of the printing and dummy text of the printing
                                        dummy text of the printing typesetting industry. Lorem Ipsum has been the
                                        industry's standard dummy text ever since the 1500s, when an unknown printer
                                ...
                                <div class="card card--skin-solid bg-danger">
                                    ...
                                    <div class="card-body">
                                        Lorem Ipsum is simply dummy text of the printing and typesetting dummy text of
                                        the printing dummy text of the printing dummy text of the printing industry.
                                        Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
                                        when an unknown printer took a galley of type and scrambled. Lorem Ipsum is
                                ...
                                <div class="card card--skin-solid card-- bg-brand">
                                    <div class="card-head">
                                        ...
                                        <div class="card-head-toolbar">
                                            <div class="card-head-actions">
                                                <a href="#"
                                                    class="btn btn-outline-light btn-pill btn-sm btn-icon btn-icon-md">
                                    ...
                                    <div class="card-body">
                                        Lorem Ipsum is simply dummy text of the printing dummy text of the printing
                                        dummy text of the printing dummy text of the printing and typesetting industry.
                                        Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
                                        when an unknown printer took a galley of type and scrambled. Lorem Ipsum is
                                        simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                                        the industry's standard dummy text ever since the 1500s, when an unknown printer
