                                ...
                                <div class="widget widget--user-profile-3">
                                    <div class="widget__top">
                                        <div class="widget__media">
                                            <img src="<?php echo CONF_WEBROOT_URL;?>images/users/100_12.jpg"
                                                alt="image">
                                        </div>
                                        <div
                                            class="widget__pic widget__pic--danger font-danger font-bolder font-light hidden">
                                            JM
                                        </div>
                                        <div class="widget__content">
                                            <div class="widget__head">
                                                            ...
                                                            <ul class="nav">
                                                                ...
                                                                <li class="nav__foot">
                                                                    <a class="btn btn-clean btn-bold btn-sm" href="#"><i
                                                                            class="flaticon2-add-1 icon-sm"></i> Add
                                                                        new</a>
                                                                    <a class="btn btn-clean btn-bold btn-sm hidden"
                                                ...
                                                <div class="widget__action">
                                                    ...
                                                    <div class="dropdown dropdown-inline">
                                                        <a href="#"
                                                            class="btn btn-brand btn-sm btn-upper dropdown-toggle"
                                                        ...
                                                        <div
                                                            ...
                                                            <ul class="nav">
                                                                ...
                                                                <li class="nav__item">
                                                                    <a href="#" class="nav__link">
                                                                        <i
                                                                            class="nav__link-icon flaticon2-calendar-8"></i>
                                                                ...
                                                                <li class="nav__item">
                                                                    <a href="#" class="nav__link">
                                                                        <i
                                                                            class="nav__link-icon flaticon2-telegram-logo"></i>
                                                                ...
                                                                <li class="nav__item">
                                                                    <a href="#" class="nav__link">
                                                                        <i
                                                                            class="nav__link-icon flaticon2-new-email"></i>
                                            ...
                                            <div class="widget__info">
                                                <div class="widget__desc">
                                                    I distinguish three main text objektive could be merely to inform
                                                    people.
                                    ...
                                    <div class="widget__bottom hidden">
                                            ...
                                            <div class="widget__details">
                                                <div class="section__content section__content--solid">
                                                    <div class="badge badge__pics">
                                                        <a href="#" class="badge__pic" data-toggle="tooltip"
                                                        ...
                                                        <a href="#" class="badge__pic" data-toggle="tooltip"
                                                            ...
                                                            <img src="<?php echo CONF_WEBROOT_URL;?>images/users/100_13.jpg"
                                                                alt="image">
                                                        </a>
                                                        <a href="#" class="badge__pic" data-toggle="tooltip"
                                                            data-skin="brand" data-placement="top" title=""
                                ...
                                <div class="card card--head-noborder">
                                    <div class="card-head">
                                        <div class="card-head-label">
                                            <h3 class="card-head-title  font-danger">
                                                Important Notice
                                            </h3>
                                        </div>
                                    ...
                                    <div class="card-body card__body--fit-top">
                                        <div class="section section--space-sm">
                                            Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                            Lorem Ipsum has been the industry's standard dummy text ever since the
                                            1500s.
                                        </div>
                                        <div class="section section--last">
                                            <a href="#" class="btn btn-brand btn-sm btn-bold"><i class=""></i> Set
                                                up</a>&nbsp;
                                ...
                                <div class="card">
                                            ...
                                            <div
                                                ...
                                                <ul class="nav">
                                                    ...
                                                    <li class="nav__item">
                                                        <a href="#" class="nav__link">
                                                            <i class="nav__link-icon flaticon2-drop"></i>
                                                            <span class="nav__link-text">New Deal</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav__item">
                                                        <a href="#" class="nav__link">
                                                            <i class="nav__link-icon flaticon2-calendar-8"></i>
                                                            <span class="nav__link-text">New Lead</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav__item">
                                                        <a href="#" class="nav__link">
                                                            <i class="nav__link-icon flaticon2-link"></i>
                                                            <span class="nav__link-text">Change Settings</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav__item">
                                                        <a href="#" class="nav__link">
                                                    ...
                                                    <li class="nav__separator"></li>
                                                    <li class="nav__foot">
                                                        <a class="btn btn-label-danger btn-bold btn-sm" href="#">Manage
                                                            deals</a>
                                                        <a class="btn btn-clean btn-bold btn-sm" href="#"
                                    ...
                                    <div class="card-body">
                                        <div class="section section--space-md">
                                            <div class="widget24 widget24--solid">
                                                <div class="widget24__details">
                                                    <div class="widget24__info">
                                                        <a href="#" class="widget24__title" title="Click to edit">
                                                            Hardware Purchase
                                                        </a>
                                        ...
                                        <div class="section section--last">
                                            <a href="#" class="btn btn-label-brand btn-sm btn-bold"><i class=""></i> See
                                                all deals</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div
                                                ...
                                                <ul class="nav">
                                                    ...
                                                    <li class="nav__item">
                                                        <a href="#" class="nav__link">
                                                            <i class="nav__link-icon flaticon2-drop"></i>
                                                            <span class="nav__link-text">Update Details</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav__item">
                                                        <a href="#" class="nav__link">
                                                            <i class="nav__link-icon flaticon2-calendar-8"></i>
                                                            <span class="nav__link-text">New Staff</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav__item">
                                                        <a href="#" class="nav__link">
                                                            <i class="nav__link-icon flaticon2-link"></i>
                                                            <span class="nav__link-text">New Owner</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav__item">
                                                        <a href="#" class="nav__link">
                                    ...
                                    <div class="form form--label-right">
                                        <div class="card-body">
                                            <div class="form-group form-group-xs row">
                                                ...
                                                <div class="col-8">
                                                    <span class="form-control-plaintext font-bolder">Loop Inc.</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-group-xs row">
                                                <label class="col-4 col-form-label">Location:</label>
                                                <div class="col-8">
                                                    <span class="form-control-plaintext font-bolder">London, UK.</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-group-xs row">
                                            ...
                                            <div class="form-group form-group-xs row">
                                                ...
                                                <div class="col-8">
                                                    <span class="form-control-plaintext font-bolder">+456 7890456</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-group-xs row">
                                                <label class="col-4 col-form-label">Email:</label>
                                                <div class="col-8">
                                                    <span class="form-control-plaintext font-bolder">
                                        ...
                                        <div class="card-foot">
                                            <div class="form__actions space-between">
                                                <a href="#" class="btn btn-label-brand btn-sm btn-bold">Manage
                                                    company</a>
                                ...
                                <div class="card card--tabs">
                                            ...
                                            <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand"
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab"
                                                        href="#YK_apps_contacts_view_tab_1" role="tab">
                                                        <i class="flaticon2-note"></i> Notes
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab"
                                                        href="#YK_apps_contacts_view_tab_2" role="tab">
                                                        <i class="flaticon2-time"></i> Activities
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab"
                                                        href="#YK_apps_contacts_view_tab_3" role="tab">
                                                        <i class="flaticon2-calendar-3"></i> Personal
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab"
                                                        href="#YK_apps_contacts_view_tab_4" role="tab">
                                                        <i class="flaticon2-user-outline-symbol"></i> Account
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab"
                                                        href="#YK_apps_contacts_view_tab_5" role="tab">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content margin-t-20">
                                            <!--Begin:: Tab Content-->
                                            <div class="tab-pane active" id="YK_apps_contacts_view_tab_1"
                                                role="tabpanel">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <a href="#" class="btn btn-label-brand btn-bold">Add
                                                                notes</a>
                                                ...
                                                <div class="notes scroll scroll--pull ps ps--active-y"
                                                    data-scroll="true" style="height: 700px; overflow: hidden;">
                                                    <div class="notes__items">
                                                        <div class="notes__item">
                                                            <div class="notes__media">
                                                                <img class="hidden-"
                                                                    src="<?php echo CONF_WEBROOT_URL;?>images/users/100_3.jpg"
                                                                    alt="image">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="nav">
                                                                                <li class="nav__item">
                                                                                    <a href="#" class="nav__link">
                                                                                        <i
                                                                                            class="nav__link-icon flaticon2-line-chart"></i>
                                                                                        <span
                                                                                            class="nav__link-text">Reports</span>
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav__item">
                                                                                    <a href="#" class="nav__link">
                                                                                        <i
                                                                                            class="nav__link-icon flaticon2-send"></i>
                                                                                        <span
                                                                                            class="nav__link-text">Messages</span>
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav__item">
                                                                                    <a href="#" class="nav__link">
                                                                                        <i
                                                                                            class="nav__link-icon flaticon2-pie-chart-1"></i>
                                                                                        <span
                                                                                            class="nav__link-text">Charts</span>
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav__item">
                                                                                    <a href="#" class="nav__link">
                                                                                        <i
                                                                                            class="nav__link-icon flaticon2-avatar"></i>
                                                                                        <span
                                                                                            class="nav__link-text">Members</span>
                                                                                    </a>
                                                                                </li>
                                                                                <li class="nav__item">
                                                                                    <a href="#" class="nav__link">
                                                                                        <i
                                                                                            class="nav__link-icon flaticon2-settings"></i>
                                                                                        <span
                                                                                            class="nav__link-text">Settings</span>
                                                                                    </a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                        ...
                                                        <div class="notes__item">
                                                            ...
                                                            <div class="notes__content">
                                                                <div class="notes__section">
                                                                    ...
                                                                    <div class="notes__dropdown">
                                                                        <a href="#"
                                                                            ...
                                                                            data-toggle="dropdown">
                                                                            <i
                                                                                class="flaticon2-rectangular font-brand"></i>
                                                                        </a>
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="nav">
                                                                                <li class="nav__item">
                                                                ...
                                                                <span class="notes__body">
                                                                    Sed ut perspiciatis unde omnis iste natus error sit
                                                                    voluptatem, totam rem aperiam, eaque ipsa quae ab
                                                        ...
                                                        <div class="notes__item">
                                                            <div class="notes__media">
                                                                <span class="notes__icon">
                                                                    <i class="flaticon2-poll-symbol font-success"></i>
                                                                </span>
                                                            </div>
                                                            <div class="notes__content">
                                                                <div class="notes__section">
                                                        ...
                                                        <div class="notes__item notes__item--clean">
                                                            ...
                                                            <div class="notes__content">
                                                                ...
                                                                <span class="notes__body">
                                                                    Sed ut sit voluptatem accusantium doloremque
                                            ...
                                            <!--Begin:: Tab Content-->
                                            <div class="tab-pane" id="YK_apps_contacts_view_tab_2" role="tabpanel">
                                            ...
                                            <!--Begin:: Tab Content-->
                                            <div class="tab-pane" id="YK_apps_contacts_view_tab_3" role="tabpanel">
                                                <form class="form form--label-right" action="">
                                                        ...
                                                        <div class="section section--first">
                                                            <div class="section__body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Photo</label>
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <div class="avatar avatar--outline"
                                                                            id="YK_apps_user_add_avatar">
                                                                            <div class="avatar__holder"
                                                                                style="background-image: url('media/users/100_12.jpg');">
                                                                            </div>
                                                    ...
                                                    <div
                                                        class="separator separator--space-lg separator--fit separator--border-solid">
                                                    </div>
                                            ...
                                            <!--Begin:: Tab Content-->
                                            <div class="tab-pane" id="YK_apps_contacts_view_tab_4" role="tabpanel">
                                                <form class="form form--label-right">
                                                    <div class="form__body">
                                                        <div class="alert alert-solid-danger alert-bold fade show margin-b-20"
                                                            role="alert">
                                                            ...
                                                            <div class="section__body">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        ...
                                                                        <span class="form-text text-muted">Email will
                                                                            not be publicly displayed. <a href="#"
                                                                                class="link">Learn more</a>.</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label
                                                        ...
                                                        <div
                                                            class="separator separator--border-dashed separator--card-fit separator--space-lg">
                                                        </div>
                                                        ...
                                                        <div class="section section--first">
                                                            <div class="section__body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Login
                                                                        verification</label>
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <button type="button"
                                                                            class="btn btn-label-brand btn-bold btn-sm margin-t-5 margin-b-5">Setup
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-xl-3 col-lg-3 col-form-label">Password
                                                                ...
                                                                <div class="form-group row margin-t-10 margin-b-10">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <button type="button"
                                                                            class="btn btn-label-danger btn-bold btn-sm margin-t-5 margin-b-5">Deactivate
                                                                            your account ?</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <!--Begin:: Tab Content-->
                                            <div class="tab-pane" id="YK_apps_contacts_view_tab_5" role="tabpanel">
                                                <form class="form form--label-right">
                                                    <div class="form__body">
                                                        <div class="section section--first">
                                                            <div class="section__body">
                                                                ...
                                                                <div class="form-group form-group-last row">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">Send
                                                        ...
                                                        <div class="section section--first">
                                                            <div class="section__body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-xl-3 col-lg-3 col-form-label">When
                                                                        To Email</label>
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <div class="checkbox-list">
                                                                            ...
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"> You're sent a
                                                                                direct message
                                                                                <span></span>
                                                                            </label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                    checked="checked"> Someone adds you
                                                                                as a connection
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                            ...
                                                            <div class="section__body">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <div class="checkbox-list">
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"> News about
                                                                                Metronic product and feature updates
                                                                                <span></span>
                                                                            </label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"> Tips on getting
                                                                                more out of Keen
                                                                                <span></span>
                                                                            </label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                    checked="checked"> Things you missed
                                                                                since you last logged into Keen
                                                                                <span></span>
                                                                            </label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                    checked="checked"> News about
                                                                                Metronic on partner products and other
                                                                                services
                                                                                <span></span>
                                                                            </label>
                                                                            <label class="checkbox">
                                                                                <input type="checkbox"
                                                                                    checked="checked"> Tips on Metronic
                                                                                business products
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
