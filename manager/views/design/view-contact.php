                                    ...
                                    <ul class="nav">
                                        ...
                                        <li class="nav__item">
                                            <a href="#" class="nav__link" data-toggle="status-change" data-status="4">
                                                <span class="nav__link-text"><span class="badge badge--unified-info badge--inline badge--lg badge--bold">On Hold</span></span>
                                            </a>
                                        </li>
                                        <li class="nav__item">
                                            <a href="#" class="nav__link" data-toggle="status-change" data-status="4">
                                        ...
                                        <li class="nav__foot">
                                            <a class="btn btn-clean btn-bold btn-sm" href="#"><i class="flaticon2-add-1 icon-sm"></i> Add new</a>
                                            <a class="btn btn-clean btn-bold btn-sm hidden" href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="Click to learn more...">Learn more</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="form form--label-right">
                <div class="card-body">
                    ...
                    <div class="form-group form-group-xs row">
                        ...
                        <div class="col-8">
                            <span class="form-control-plaintext"><span class="font-bolder">345,000M</span> &nbsp;<span class="badge badge--inline badge--danger badge--bold">Q4, 2019</span></span>
                        </div>
                    </div>
                    <div class="form-group form-group-xs row">
        ...
        <circle fill="#000000" opacity="0.3" cx="18.5" cy="5.5" r="2.5"></circle>
                    ...
                    <div class="tab-pane" id="YK_apps_contacts_view_tab_3" role="tabpanel">
                        <form class="form form--label-right" action="">
                                    ...
                                    <div class="section__body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <h3 class="section__title section__title-sm">Personal Info:</h3>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="avatar avatar--outline" id="YK_apps_user_add_avatar">
                                                    <div class="avatar__holder" style="background-image: url('media/users/100_12.jpg');"></div>
                            ...
                            <div class="separator separator--space-lg separator--fit separator--border-solid"></div>
                    ...
                    <div class="tab-pane" id="YK_apps_contacts_view_tab_4" role="tabpanel">
                        <form class="form form--label-right">
                            <div class="form__body">
                                ...
                                <div class="separator separator--border-dashed separator--card-fit separator--space-lg"></div>
                                ...
                                <div class="section section--first">
                                    <div class="section__body">
                                        <div class="row">
                                            <label class="col-xl-3"></label>
                                            <div class="col-lg-9 col-xl-6">
                                                <h3 class="section__title section__title-sm">Setup Email Notification:</h3>
                                            </div>
                                        </div>
                                ...
                                <div class="section section--first">
                                    <div class="section__body">
                                        <div class="row">
                                            <label class="col-xl-3"></label>
                                            <div class="col-lg-9 col-xl-6">
                                                <h3 class="section__title section__title-sm">Activity Related Emails:</h3>
                                            </div>
                                        </div>
                                        <div class="form-group row">
