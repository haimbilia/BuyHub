                            ...
                            <div class="card card--head-noborder">
                                <div class="card-head">
                                    ...
                                    <div class="card-head-toolbar">
                                        <span class="badge badge-bolder badge badge-inline badge-danger">Now</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="section section--space-md">
                                        <div class="widget24 widget24--solid">
                                            ...
                                            <div class="progress progress--sm">
                                                <div class="progress-bar bg-brand" role="progressbar" style="width: 15%;" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                ...
                                <div class="form form--label-right">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group form-group-xs row">
                                            ...
                                            <div class="col-8">
                                                <span class="form-control-plaintext"><span class="font-bolder">345,000M</span> &nbsp;<span class="badge badge-inline badge-danger badge-bold">Q4,
                                                        2019</span></span>
                                            </div>
                                        </div>
                                        <div class="form-group form-group-xs row">
                            ...
                            <div class="card card-tabs">
                                <div class="card-head">
                                    <div class="card-head-toolbar">
                                        <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#YK_apps_contacts_view_tab_1" role="tab">
                                                    <i class="flaticon2-note"></i> Notes
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#YK_apps_contacts_view_tab_2" role="tab">
                                                    <i class="flaticon2-time"></i> Activities
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#YK_apps_contacts_view_tab_3" role="tab">
                                                    <i class="flaticon2-calendar-3"></i> Personal
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#YK_apps_contacts_view_tab_4" role="tab">
                                                    <i class="flaticon2-user-outline-symbol"></i> Account
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#YK_apps_contacts_view_tab_5" role="tab">
                                ...
                                <div class="card-body">
                                    <div class="tab-content margin-t-20">
                                        <!--Begin:: Tab Content-->
                                        <div class="tab-pane active" id="YK_apps_contacts_view_tab_1" role="tabpanel">
                                            ...
                                            <div class="notes scroll scroll--pull ps ps--active-y" data-scroll="true" style="height: 700px; overflow: hidden;">
                                        ...
                                        <div class="tab-pane" id="YK_apps_contacts_view_tab_3" role="tabpanel">
                                            <form class="form form--label-right" action="">
                                                    ...
                                                    <div class="section section--first">
                                                        <div class="section__body">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-6">
                                                                    <div class="avatar avatar--outline" id="YK_apps_user_add_avatar">
                                                                        <div class="avatar__holder" style="background-image: url('media/users/100_12.jpg');">
                                                                        </div>
                                                ...
                                                <div class="separator separator--space-lg separator--fit separator--border-solid">
                                                </div>
                                        ...
                                        <div class="tab-pane" id="YK_apps_contacts_view_tab_4" role="tabpanel">
                                            <form class="form form--label-right">
                                                <div class="form__body">
                                                    <div class="alert alert-solid-danger alert-bold fade show margin-b-20" role="alert">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-6">
                                                                    ...
                                                                    <span class="form-text text-muted">Email will
                                                                        not be publicly displayed. <a href="#" class="link">Learn more</a>.</span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                    ...
                                                    <div class="separator separator--border-dashed separator--card-fit separator--space-lg">
                                                    </div>
                                                        ...
                                                        <div class="section__body">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-xl-3 col-lg-3 col-form-label">Login
                                                                    verification</label>
                                                                <div class="col-lg-9 col-xl-6">
                                                                    <button type="button" class="btn btn-label-brand btn-bold btn-sm margin-t-5 margin-b-5">Setup
                                                            ...
                                                            <div class="form-group row margin-t-10 margin-b-10">
                                                                ...
                                                                <div class="col-lg-9 col-xl-6">
                                                                    <button type="button" class="btn btn-label-danger btn-bold btn-sm margin-t-5 margin-b-5">Deactivate
                                                                        your account ?</button>
                                                                </div>
                                                            </div>
                                                        </div>
