                                    ...
                                    <div class="card-body">
                                        <ul class="list-stats list-stats-double">
                                            ...
                                            <li>
                                                ...
                                                <span class="value">
                                                    <i class="fas fa-arrow-up font-success"></i>
                                                    100%</span>
                                            </li>
                                            <li>
                                                <span class="label">REACHED CHECKOUT</span>
                                                <span class="value">
                                                    <i class="fas fa-arrow-down font-danger"></i>
                                                    -66.67% </span>
                                            </li>
                                            <li>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="widget26">
                                                    <div class="widget26__content">
                                                        <div class="row align-items-center justify-content-between">
                                                            <div class="col"><span class="widget26__number">$81</span>
                                                            </div>
                                                            <div class="col-auto">
                                                                <span class="widget26__cents font-success"><i
                                            ...
                                            <div class="tab-pane active" id="widget11_tab1_content">
                                                ...
                                                <div class="widget11">
                                                    ...
                                                    <div class="widget11__action align-right">
                                                        <button type="button"
                                                            class="btn btn-outline-brand btn-bold btn-sm">Import
                                                            Report</button>
                                                    </div>
                                                </div>
                                                <!--end::Widget 11-->
                                            ...
                                            <div class="widget25__items">
                                                <div class="widget25__item">
                                                    <span class="widget25__number">
                                                        63%
                                                    </span> <span class="widget25__cents"><span class="font-success"><i
                                                                class="la la-arrow-up"></i>
                                                            50.6%</span></span>
                                                ...
                                                <div class="widget25__item">
                                                    <span class="widget25__number">
                                                        39%
                                                    </span><span class="widget25__cents"><span class="font-danger"><i
                                                                class="la la-arrow-down"></i>
                                                            50.6%</span></span>
