                            ...
                            <form class="form" action="#">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <input type="search" class="form-control" name="search" value="" placeholder="Search by product name">
                                            </div>
                                            <div class="col-md-5">
                                                    ...
                                                    <td>
                                                        <div class="media-profile">
                                                            <figure class="media-profile_photo">
                                                                <img width="40" height="40" title="Macbook pro" alt="Macbook pro" src="<?php echo CONF_WEBROOT_URL; ?>images/products/product15.jpg">
                                                            </figure>
                                                            <div class="media-profile_data">
                                                                <h5 class="media-profile_title">Apple iPhone 12</h5>
                                                                <p>
                                                                    <span class="text-muted fw-bold">Storage: 128 GB</span>
                                                                    <span class="text-muted fw-bold">Color: Black</span>
                                                                    <span class="text-muted fw-bold">Seller: michael</span>
                                                                </p>
                                    ...
                                    <form class="modal-body form form-edit">
                                        ...
                                        <div class="form-edit-body">
                                            <div class="alert alert-solid-info" role="alert">
                                                <div class="alert-text text-xs"> Disclaimer: you can edit here only brand detail
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
