                            ...
                            <div class="card">
                                <div class="card-head">
                                    <div class="card-head-label">
                                        <h3 class="card-head-title">Related Products </h3>
                                    </div>
                                                    ...
                                                    <td>
                                                        <div class="media-profile">
                                                            <figure class="media-profile_photo">
                                                                <img data-aspect-ratio="1:1" width="40" height="40" title="Macbook pro" alt="Macbook pro" src="<?php echo CONF_WEBROOT_URL; ?>images/products/product15.jpg">
                                                            </figure>
