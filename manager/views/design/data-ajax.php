                    ...
                    <div class="container  grid__item grid__item--fluid">
                        <div class="alert alert-light alert-elevate" role="alert">
                            ...
                            <div class="alert-text">
                                ...
                                you
                                can specify a remote data source that returns data in JSON/JSONP format. In this example
                                the
                                grid fetches its data from a remote JSON file.
                                It also defines the schema model of the data source received from the remote data
                                source. In
                                addition to the visualization, the Datatable provides built-in support for operations
                                over
                                data such as sorting, filtering and paging
                                    ...
                                    <table class="datatable__table" style="display: block;">
                                        <thead class="datatable__head">
                                            <tr class="datatable__row" style="left: 0px;">
                                                <th data-field="RecordID"
                                                    class="datatable__cell--center datatable__cell datatable__cell--sort datatable__cell--sorted"
                                                ...
                                                <th data-field="CompanyName"
                                                    ...
                                                    <span style="width: 148px;">Company Name</span>
                                                </th>
                                        ...
                                        <tbody class="datatable__body" style="">
                                            <tr data-row="0" class="datatable__row" style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">1</span></td>
                                                ...
                                                <td data-field="CompanyName" class="datatable__cell"><span
                                                        style="width: 148px;">Gleichner, Ziemann and Gutkowski</span>
                                                </td>
                                                    ...
                                                    class="datatable__cell"><span
                                                        ...
                                                        <div class="dropdown"> <a data-toggle="dropdown"
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"> <a href="#"
                                                                    ...
                                                                    Edit
                                                                    Details</a> <a href="#" class="dropdown-item"><i
                                                            ...
                                                            class="btn btn-sm btn-clean btn-icon btn-icon-sm"> <i
                                                                class="flaticon2-paper"></i> </a> <a title="Delete"
                                                            class="btn btn-sm btn-clean btn-icon btn-icon-sm"> <i
                                            ...
                                            <tr data-row="1" class="datatable__row datatable__row--even"
                                                style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">2</span></td>
                                                <td data-field="OrderID" class="datatable__cell"><span
                                            ...
                                            <tr data-row="2" class="datatable__row" style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">3</span></td>
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                ...
                                                <td data-field="CompanyName" class="datatable__cell"><span
                                                        style="width: 148px;">Kulas, Cassin and Batz</span></td>
                                                <td data-field="Status" class="datatable__cell"><span
                                                        style="width: 148px;"><span
                                            ...
                                            <tr data-row="3" class="datatable__row datatable__row--even"
                                                style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">4</span></td>
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                ...
                                                <td data-field="CompanyName" class="datatable__cell"><span
                                                        style="width: 148px;">Pfannerstill-Treutel</span></td>
                                                <td data-field="Status" class="datatable__cell"><span
                                                        style="width: 148px;"><span
                                                            class="badge badge--brand badge--inline badge--pill">Pending</span></span>
                                                </td>
                                            ...
                                            <tr data-row="4" class="datatable__row" style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">5</span></td>
                                                <td data-field="OrderID" class="datatable__cell"><span
                                            ...
                                            <tr data-row="5" class="datatable__row datatable__row--even"
                                                style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">6</span></td>
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                ...
                                                <td data-field="CompanyName" class="datatable__cell"><span
                                                        style="width: 148px;">Gleason, Kub and Marquardt</span></td>
                                                <td data-field="Status" class="datatable__cell"><span
                                                        style="width: 148px;"><span
                                            ...
                                            <tr data-row="6" class="datatable__row" style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">7</span></td>
                                                <td data-field="OrderID" class="datatable__cell"><span
                                            ...
                                            <tr data-row="7" class="datatable__row datatable__row--even"
                                                style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">8</span></td>
                                                <td data-field="OrderID" class="datatable__cell"><span
                                            ...
                                            <tr data-row="8" class="datatable__row" style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">9</span></td>
                                                <td data-field="OrderID" class="datatable__cell"><span
                                            ...
                                            <tr data-row="9" class="datatable__row datatable__row--even"
                                                style="left: 0px;">
                                                <td class="datatable__cell--sorted datatable__cell--center datatable__cell"
                                                    data-field="RecordID"><span style="width: 30px;">10</span></td>
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                ...
                                                <td data-field="CompanyName" class="datatable__cell"><span
                                                        style="width: 148px;">Labadie, Predovic and Hammes</span></td>
                                                <td data-field="Status" class="datatable__cell"><span
                                                        style="width: 148px;"><span
                                                            class="badge badge--brand badge--inline badge--pill">Pending</span></span>
                                                </td>
