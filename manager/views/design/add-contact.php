                                ...
                                <div class="grid__item">
                                    ...
                                    <div class="wizard-v1__nav">
                                        <div class="wizard-v1__nav-items">
                                            ...
                                            <div class="wizard-v1__nav-item" data-ktwizard-type="step" data-ktwizard-state="current">
                                                <div class="wizard-v1__nav-body">
                                                    <div class="wizard-v1__nav-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon svg-icon--xl">
                                            ...
                                            <div class="wizard-v1__nav-item" data-ktwizard-type="step" data-ktwizard-state="pending">
                                                <div class="wizard-v1__nav-body">
                                                    <div class="wizard-v1__nav-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon svg-icon--xl">
                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div class="grid__item grid__item--fluid wizard-v1__wrapper">
                                    ...
                                    <form class="form" id="YK_contacts_add_form" novalidate="novalidate">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12">
                                                            <div class="section__body">
                                                                <div class="form-group row">
                                                                    <div class="col-lg-9 col-xl-6">
                                                                        <h3 class="section__title section__title-md">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-9 col-xl-9">
                                                                        ...
                                                                        <span class="form-text text-muted">Email
                                                                            will not be publicly displayed. <a href="#" class="link">Learn
                                                                                more</a>.</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                        ...
                                        <div class="form__actions">
                                            <div class="btn btn-secondary btn-md btn-tall btn-wide font-bold font-transform-u" data-ktwizard-type="action-prev">
                                                Previous
                                            </div>
                                            <div class="btn btn-success btn-md btn-tall btn-wide font-bold font-transform-u" data-ktwizard-type="action-submit">
                                                Submit
                                            </div>
                                            <div class="btn btn-brand btn-md btn-tall btn-wide font-bold font-transform-u" data-ktwizard-type="action-next">
                                                Next Step
                                            </div>
                                        </div>
                                        <!--end: Form Actions -->
