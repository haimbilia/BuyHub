				...
				<div class="container  grid__item grid__item--fluid">
					<div class="card">
						<div class="card-body card__body--fit">
							<div class="grid wizard-v3 wizard-v3--white" id="wizard_v3" data-FATbitwizard-state="first">
								<div class="grid__item">
									<!--begin: Form Wizard Nav -->
									<div class="wizard-v3__nav">
										<div class="wizard-v3__nav-items">
											...
											<div class="wizard-v3__nav-item" data-FATbitwizard-type="step" data-FATbitwizard-state="current">
												<div class="wizard-v3__nav-body" data-toggle="tab" href="#form_step_1">
													...
													<div class="wizard-v3__nav-bar"></div>
												</div>
											</div>
								...
								<div class="grid__item grid__item--fluid wizard-v3__wrapper">
									...
									<div class="tab-pane active" id="form_step_1">
										...
										<div class="wizard-v3__content" data-FATbitwizard-type="step-content" data-FATbitwizard-state="current">
											<div class="heading heading--md">Setup Your Current Location</div>
											<div class="form__section form__section--first">
												<div class="wizard-v3__form">
										...
										<!--end: Form Wizard Step 1--></div>
									<div class="tab-pane" id="form_step_2">
									<!--begin: Form Wizard Step 2-->
									<div class="wizard-v3__content" data-FATbitwizard-type="step-content">
											...
											<div class="form__section form__section--first">
												<div class="wizard-v3__form">
													...
													<div class="wizard-v3__form-label">Package Dimensions</div>
													<div class="row">
														<div class="col-xl-4">
															<div class="form-group">
									...
									<div class="wizard-v3__content" data-FATbitwizard-type="step-content">
											...
											<div class="form__section form__section--first">
												<div class="wizard-v3__review">
													<div class="wizard-v3__review-item">
														<div class="wizard-v3__review-title">
															Current Address
														</div>
														<div class="wizard-v3__review-content">
															Address Line 1<br>
															Address Line 2<br>
