                    ...
                    <div class="container">
                        <div class="alert alert-light alert-elevate" role="alert">
                            ...
                            <div class="alert-text">
                                The draggable cards powered with jQueryUI Sortable Plugin. You can use the jQueryUI
                                Sortable API to store the card positions in your backend.
                                <br>For more info please check out <a class="link link--brand font-bold"
                                    href="http://jqueryui.com/sortable/#cards" target="_blank">the official
                                    documentation.</a>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card card--mobile card--sortable" style="">
                                    <div class="card-head ui-sortable-handle">
                                        ...
                                        <div class="card-head-toolbar">
                                            <div class="card-head-group">
                                                <a href="#" class="btn btn-sm btn-icon btn-clean btn-icon-md"><i
                                    ...
                                    <div class="card-body">
                                        ...
                                        took a galley of type and scrambled. Lorem Ipsum is simply dummy text of the
                                ...
                                <div class="card card--mobile card--sortable">
                                    ...
                                    <div class="card-body">
                                        ...
                                        text of the printing and typesetting industry. Lorem Ipsum has been the
                                        industry's standard dummy text ever since the 1500s, when an unknown printer
                                        took a galley of type and scrambled. Lorem Ipsum has been the industry's
                                ...
                                <div class="card card--mobile card--sortable">
                                    <div class="card-head ui-sortable-handle">
                                        ...
                                        <div class="card-head-toolbar">
                                            <div class="card-head-group">
                                                <a href="#"
                                                    class="btn btn-sm btn-icon btn-brand btn-pill btn-icon-md"><i
                                                        class="la la-angle-down"></i></a>
                                                <a href="#"
                                                    class="btn btn-sm btn-icon btn-danger btn-pill btn-icon-md"><i
                                                        class="la la-refresh"></i></a>
                                                <a href="#"
                                                    class="btn btn-sm btn-icon btn-success btn-pill btn-icon-md"><i
                                                        class="la la-close"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card card--sortable">
                                    <div class="card-head ui-sortable-handle">
                                        ...
                                        <div class="card-head-toolbar">
                                            <div class="card-head-group">
                                                <a href="#"
                                                    class="btn btn-sm btn-icon btn-brand btn-elevate btn-icon-md"><i
                                                        class="la la-angle-down"></i></a>
                                                <a href="#"
                                                    class="btn btn-sm btn-icon btn-danger btn-elevate btn-icon-md"><i
                                                        class="la la-refresh"></i></a>
                                                <a href="#"
                                                    class="btn btn-sm btn-icon btn-success btn-elevate btn-icon-md"><i
                                                        class="la la-close"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                            ...
                                            <ul class="nav nav-tabs nav-tabs-line  nav-tabs-line-right" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab"
                                                        href="#card_base_demo_1_tab_content" role="tab">
                                                        Logs
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab"
                                                        href="#card_base_demo_2_tab_content" role="tab">
                                                        Messages
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab"
                                                        href="#card_base_demo_3_tab_content" role="tab">
                                                        Settings
                                                    </a>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="card_base_demo_2_tab_content">
                                                ...
                                                industry. Lorem Ipsum has been the industry's standard dummy text ever
                                                since the 1500s, when an unknown printer took a galley of type and
                                                scrambled. Lorem Ipsum is simply dummy text.
                                            </div>
                                ...
                                <div class="card card--responsive-tablet-and-mobile card--sortable">
                                    <div class="card-head ui-sortable-handle">
                                        ...
                                        <div class="card-head-toolbar">
                                            <div class="btn-group btn-group btn-group-pill" role="group"
                                                aria-label="...">
                                ...
                                <div class="card card-tabs card--brand card--head-solid-bg card--sortable">
                                    <div class="card-head ui-sortable-handle">
                                        ...
                                        <div class="card-head-toolbar">
                                            <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand nav-tabs-line-danger"
                                                role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab"
                                                        href="#card_base_demo_1_1_tab_content" role="tab">
                                                ...
                                                <li class="nav-item dropdown">
                                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"
                                                        role="button" aria-haspopup="true" aria-expanded="true"><i
                                                            class="la la-map-marker"></i> Settings</a>
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" data-toggle="tab"
                                                            href="#card_base_demo_1_1_tab_content">Action</a>
                                                        <a class="dropdown-item" data-toggle="tab"
                                                            href="#card_base_demo_1_3_tab_content">Another action</a>
                                                        <a class="dropdown-item" data-toggle="tab"
                                                            href="#card_base_demo_1_2_tab_content">Something else
                                                            here</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" data-toggle="tab"
                                                            href="#card_base_demo_1_3_tab_content">Separated link</a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="card card-tabs card--sortable">
                                    <div class="card-head ui-sortable-handle">
                                        <div class="card-head-toolbar">
                                            <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-primary" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab"
                                                        href="#card_base_demo_2_1_tab_content" role="tab">
                                                        <i class="la la-cog"></i> Messages
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab"
                                                        href="#card_base_demo_2_2_tab_content" role="tab">
                                                        <i class="la la-briefcase"></i> Settings
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab"
                                                        href="#card_base_demo_2_3_tab_content" role="tab">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="card_base_demo_2_1_tab_content"
                                                role="tabpanel">
                                                Lorem Ipsum is simply dummy text of the printing and typesetting
                                                industry. Lorem Ipsum has been the industry's standard dummy text ever
                                                since the 1500s, when an unknown printer took a galley of type and
