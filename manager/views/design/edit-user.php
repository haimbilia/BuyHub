                        ...
                        <div class="card-body">
                            <form action="" method="">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="user_edit_tab_1" role="tabpanel">
                                    ...
                                    <div class="tab-pane" id="user_edit_tab_2" role="tabpanel">
                                        <div class="form form--label-right">
                                            <div class="form__body">
                                                <div class="section section--first">
                                                    <div class="section__body">
                                    ...
                                    <div class="tab-pane" id="user_edit_tab_3" role="tabpanel">
                                        <div class="form form--label-right">
                                            <div class="form__body">
                                                <div class="section section--first">
                                                    <div class="section__body">
                                                        <div class="alert alert-solid-danger alert-bold fade show margin-t-20 margin-b-40" role="alert">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                ...
                                                                <a href="#" class="link font-sm font-bold margin-t-5">Forgot password ?</a>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                    ...
                                    <div class="tab-pane" id="user_edit_tab_4" role="tabpanel">
                                        <div class="form form--label-right">
                                            <div class="form__body">
                                                <div class="section section--first">
                                                    <div class="section__body">
