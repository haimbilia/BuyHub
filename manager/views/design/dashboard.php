                        ...
                        <div class="subheader grid__item" id="subheader">
                            ...
                            <div class="subheader__toolbar">
                                <div class="subheader__wrapper">
                                    <a href="#" class="btn subheader__btn-daterange" id="dashboard_daterangepicker"
                                        data-toggle="tooltip" title="" data-placement="left"
                                        data-original-title="Select dashboard daterange">
                                        <span class="subheader__btn-daterange-title"
                                            id="dashboard_daterangepicker_title">Today:</span>&nbsp;
                                        <span class="subheader__btn-daterange-date"
                                            id="dashboard_daterangepicker_date">Oct 3</span>
                                                    ...
                                                    <div class="widget26">
                                                        <div class="widget26__content">
                                                            <div class="row align-items-center justify-content-between">
                                                                <div class="col"><span
                                                                        class="widget26__number">$9581</span></div>
                                                                <div class="col-auto">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="widget15__item">
                                                                        ...
                                                                        <div
                                                                            class="progress widget15__chart-progress--sm">
                                                    ...
                                                    <div class="widget26">
                                                        <div class="widget26__content">
                                                            <div class="row align-items-center justify-content-between">
                                                                ...
                                                                <div class="col-auto">
                                                                    <span class="widget26__cents font-success"><i
                                                                            class="la la-arrow-up"></i> 96.6%</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="widget26__content">
                                                            <div class="row align-items-center justify-content-between">
                                                                <div class="col"><span
                                                                        class="widget26__number">$9581</span></div>
                                                                <div class="col-auto">
                                                                    <span class="widget26__cents font-danger"><i
                                                                            class="la la-arrow-down"></i> 2.6%</span>
                                                                </div>
                                                            </div>

                                                            <div class="row align-items-center justify-content-between">
                                                                <div class="col"><span class="widget26__desc">Total
                                                                        Online store visitors <i
                                                                            class="fa fa-question-circle"></i></span>
                                                                </div>
                                                                <div class="col-auto"><a class="link" href="#">View
                                                                        Report</a>
                                                    ...
                                                    <div class="widget26">
                                                        <div class="widget26__content">
                                                            <div class="row align-items-center justify-content-between">
                                                                ...
                                                                <div class="col-auto">
                                                                    <span class="widget26__cents font-success"><i
                                                                            class="la la-arrow-up"></i> 50.6%</span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="widget26">
                                                        <div class="widget26__content">
                                                            <div class="row align-items-center justify-content-between">
                                                                <div class="col"><span
                                                                        class="widget26__number">$81</span></div>
                                                                <div class="col-auto">
                                                                    <span class="widget26__cents font-success"><i
                                                                            class="la la-arrow-up"></i> 8.6%</span>
                                                                </div>
                                                            </div>

                                                            <div class="row align-items-center justify-content-between">
                                                                <div class="col"><span class="widget26__desc">Total
                                                                        Sales Attributed to marketing campaigns <i
                                                                            class="fa fa-question-circle"></i></span>
                                                                </div>
                                                                <div class="col-auto"><a class="link" href="#">View
                                                                        Report</a>
                                                ...
                                                <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand"
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab"
                                                            href="#widget11_tab2_content" role="tab">
                                                            All Time
                                                        </a>
                                                    </li>
                                                </ul>
                                                            ...
                                                            <table class="table js--table-scrollable">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>1.458</td>
                                                                        <td class="align-right">
                                                                            <span class="font-danger"><i
                                                                                    class="la la-arrow-down"></i>
                                                                                25.5%</span>
                                                                        </td>
                                ...
                                <div class="col-xl-7">
                                    ...
                                    <div class="card card--bordered-semi card--space card--height-fluid">
                                        <div class="card-head">
                                            ...
                                            <div class="card-head-toolbar">
                                                <button type="button" class="btn btn-label-brand btn-bold btn-sm">View
                                                    All</button>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="widget25">
                                                ...
                                                <span class="widget25__subtitle"><span class="font-success"><i
                                                            class="la la-arrow-up"></i> 50.6%</span></span>
                                                <div class="widget25__items">
                                                    <div class="widget25__item">
                                                        <span class="widget25__number">
                                                            63%
                                                        </span> <span class="widget25__cents"><span
                                                                class="font-success"><i class="la la-arrow-up"></i>
                                                                50.6%</span></span>
                                                    ...
                                                    <div class="widget25__item">
                                                        <span class="widget25__number">
                                                            39%
                                                                ...
                                                                class="font-danger"><i class="la la-arrow-down"></i>
                                                                50.6%</span></span>
                                                    ...
                                                    <table class="table js--table-scrollable">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="align-right">
                                                                    <span class="font-success"><i
                                                                            class="la la-arrow-up"></i> 75.5%</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td class="align-right">
                                                                    <span class="font-danger"><i
                                                                            class="la la-arrow-down"></i> 25.5%</span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-right">
                                                                    <span class="font-success"><i
                                                                            class="la la-arrow-up"></i> 15.5%</span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-right">
                                                                    <span class="font-danger"><i
                                                                            class="la la-arrow-down"></i> 67.5%</span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-right">
                                                                    <span class="font-success"><i
                                                                            class="la la-arrow-up"></i> 5.5%</span>
                                                                </td>
