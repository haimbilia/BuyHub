                                        ...
                                        <div class="card-body">
                                            <ul class="list-started">
                                                ...
                                                <li class="completed">
                                                    <a class="target" href="#" target="_blank">
                                                        <div class="list-started_icon"> <svg class="svg">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-getting-started.svg#setup-homepage">
                                                                </use>
                                                            </svg> </div>
                                                        <div class="list-started_data">
                                                        ...
                                                        <div class="list-started_action">
                                                            <img src="<?php echo CONF_WEBROOT_URL; ?>images/retina/tick-green.svg" alt="">
                                                ...
                                                <li class="">
                                                    <a class="target" href="#" target="_blank">
                                                        <div class="list-started_icon"> <svg class="svg">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-getting-started.svg#setup-payment-gateway">
                                                                </use>
                                                            </svg> </div>
                                                        <div class="list-started_data">
                                                            <h5> Setup
                                                ...
                                                <li class="completed">
                                                    <a class="target" href="#" target="_blank">
                                                        <div class="list-started_icon"> <svg class="svg">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-getting-started.svg#setup-shipping-charges">
                                                                </use>
                                                            </svg> </div>
                                                        <div class="list-started_data">
                                                            <h5> Setup
                                                ...
                                                <li class="completed">
                                                    <a class="target" href="#" target="_blank">
                                                        <div class="list-started_icon"> <svg class="svg">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-getting-started.svg#setup-tax-rates">
                                                                </use>
                                                            </svg> </div>
                                                        <div class="list-started_data">
                                                            <h5> Setup Tax
                                                ...
                                                <li class="completed">
                                                    <a class="target" href="#" target="_blank">
                                                        <div class="list-started_icon"><svg class="svg">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-getting-started.svg#setup-brand">
                                                                </use>
                                                            </svg> </div>
                                                        <div class="list-started_data">
                                                            <h5> Add Brands </h5>
                                                ...
                                                <li class="completed">
                                                    <a class="target" href="#" target="_blank">
                                                        <div class="list-started_icon"> <svg class="svg">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-getting-started.svg#setup-categoriess">
                                                                </use>
                                                            </svg> </div>
                                                        <div class="list-started_data">
                                                ...
                                                <li class="completed">
                                                    <a class="target" href="#" target="_blank">
                                                        <div class="list-started_icon"> <svg class="svg">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-getting-started.svg#setup-products">
                                                                </use>
                                                            </svg> </div>
                                                        <div class="list-started_data">
                                                            <h5> Add
                                                ...
                                                <li class="">
                                                    <a class="target" href="#" target="_blank">
                                                        <div class="list-started_icon">
                                                            <svg class="svg">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-getting-started.svg#setup-content-pages">
                                                                </use>
                                                            </svg>
