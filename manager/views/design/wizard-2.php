								...
								<div class="grid__item grid__item--fluid wizard-v2__wrapper">
									...
									<div class="tab-pane active" id="form_step_1">
										...
										<div class="wizard-v2__content" data-FATbitwizard-type="step-content" data-FATbitwizard-state="current">
											<div class="heading heading--md">Enter your Account Details</div>
									...
									<div class="wizard-v2__content" data-FATbitwizard-type="step-content">
											<div class="heading heading--md">Enter your Payment Details</div>
											<div class="form__section form__section--first">
												<div class="wizard-v2__form">
													<div class="row">
														<div class="col-xl-6">
									...
									<div class="wizard-v2__content" data-FATbitwizard-type="step-content">
											...
											<div class="form__section form__section--first">
												<div class="wizard-v2__review">
													<div class="wizard-v2__review-item">
														<div class="wizard-v2__review-title">
															Account Details
														</div>
														<div class="wizard-v2__review-content">
															John Wick<br>
