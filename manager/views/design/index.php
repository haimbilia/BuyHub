                                    ...
                                    <div class="card-head">
                                        ...
                                        <div class="card-head-toolbar">
                                            <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand"
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#widget11_tab2_content"
                                                        role="tab">
                                                        All Time
                                                    </a>
                                                </li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="widget11_tab1_content">
                                                ...
                                                <div class="widget11">
                                                    ...
                                                    <div class="widget11__action align-right">
                                                        <button type="button"
                                                            class="btn btn-label-brand btn-bold btn-sm">Import
                                                            Report</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane" id="widget11_tab2_content">
                                                ...
                                                <div class="widget11">
                                                    ...
                                                    <div class="widget11__action align-right">
                                                        <button type="button"
                                                            class="btn btn-label-success btn-bold btn-sm">Generate
                                                            Report</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="timeline-v2">
                                            <div class="timeline-v2__items  padding-top-25 padding-bottom-30">
                                                ...
                                                <div class="timeline-v2__item">
                                                    ...
                                                    <div class="timeline-v2__item-text padding-top-5">
                                                        Make Deposit <a href="#"
                                                            class="link link--brand font-bolder">USD 700</a> To ESL.
                                                    </div>
                                                </div>
                                                <div class="timeline-v2__item">
                                                ...
                                                <thead class="datatable__head">
                                                    <tr class="datatable__row">
                                                        ...
                                                        <th
                                                            ...
                                                            <span>Company <i class="flaticon2-arrow-up"></i></span></th>
                                                        <th class="datatable__cell datatable__cell--sort">
                                                            <span>Date</span></th>
                                                        <th class="datatable__cell datatable__cell--sort">
                                                            <span>Status</span></th>
                                                        <th data-field="Type"
                                                            class="datatable__cell datatable__cell--sort"><span>Managed
                                                                By</span></th>
                                                ...
                                                <tbody class="datatable__body">
                                                    <tr class="datatable__row">
                                                        ...
                                                        <td data-field="Status" class="datatable__cell"><span><span
                                                                    class="btn btn-bold btn-sm btn-font-sm  btn-label-success">Success</span></span>
                                                        </td>
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <ul class="nav nav--block">
                                                                            <li class="nav__item"> <a class="nav__link"
                                                                                    href="#"> <i
                                                                                        class="nav__link-icon flaticon2-expand"></i>
                                                                                    <span
                                                                                        class="nav__link-text">View</span>
                                                                                </a> </li>
                                                                            <li class="nav__item"> <a class="nav__link"
                                                                                    href="#"> <i
                                                                                        class="nav__link-icon flaticon2-contract"></i>
                                                                                    <span
                                                                                        class="nav__link-text">Edit</span>
                                                                                </a> </li>
                                                                            <li class="nav__item"> <a class="nav__link"
                                                                                    href="#"> <i
                                                                                        class="nav__link-icon flaticon2-trash"></i>
                                                                                    <span
                                                                                        class="nav__link-text">Delete</span>
                                                                                </a> </li>
                                                                            <li class="nav__item"> <a class="nav__link"
                                                                                    href="#"> <i
                                                                                        class="nav__link-icon flaticon2-mail-1"></i>
                                                                                    <span
                                                                                        class="nav__link-text">Export</span>
                                                                                </a> </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <tr data-row="1" class="datatable__row datatable__row--even">
                                                        ...
                                                        <td data-field="Status" class="datatable__cell"><span><span
                                                                    class="btn btn-bold btn-sm btn-font-sm  btn-label-danger">Done</span></span>
                                                        </td>
                                                        <td data-field="Type" class="datatable__cell"><span>
                                                                <div class="user-card-v2">
                                                                    <div class="user-card-v2__pic">
                                                    ...
                                                    <tr data-row="2" class="datatable__row">
                                                        ...
                                                        <td data-field="Status" class="datatable__cell"><span><span
                                                                    class="btn btn-bold btn-sm btn-font-sm  btn-label-brand">Pending</span></span>
                                                        </td>
                                                        <td data-field="Type" class="datatable__cell"><span>
                                                                <div class="user-card-v2">
                                                                    <div class="user-card-v2__pic"> <img alt="photo"
                                                    ...
                                                    <tr data-row="4" class="datatable__row">
                                                            ...
                                                            class="datatable__cell"><span>
                                                                <div class="user-card-v2">
                                                                    ...
                                                                    <div class="user-card-v2__details"> <a
                                                                            ...
                                                                            class="user-card-v2__email">MangoDB,
                                                                            Java</span> </div>
                                                                </div>
                                                            </span></td>
                                                        <td data-field="ShipDate" class="datatable__cell"><span><span
                                                        ...
                                                        <td data-field="Status" class="datatable__cell"><span><span
                                                                    class="btn btn-bold btn-sm btn-font-sm  btn-label-danger">Processing</span></span>
                                                        </td>
                                                        <td data-field="Type" class="datatable__cell"><span>
                                                                <div class="user-card-v2">
                                                                    <div class="user-card-v2__pic"> <img alt="photo"
                                                    ...
                                                    <tr data-row="5" class="datatable__row datatable__row--even">
                                                        ...
                                                        <td data-field="Status" class="datatable__cell"><span><span
                                                                    class="btn btn-bold btn-sm btn-font-sm  btn-label-warning">Canceled</span></span>
                                                        </td>
                                                        <td data-field="Type" class="datatable__cell"><span>
                                                                <div class="user-card-v2">
                                                                    <div class="user-card-v2__pic"> <img alt="photo"
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="widget11_tab1_content">
                                                ...
                                                <div class="widget11">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="widget11__chart">
                                                                            <canvas id="chart_sales_by_apps_1_3"
                                                    ...
                                                    <div class="widget11__action align-right">
                                                        <button type="button"
                                                            class="btn btn-label-success btn-sm btn-bold">View All
                                                            Records</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane" id="widget11_tab2_content">
                                                ...
                                                <div class="widget11">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="widget11__chart">
                                                                            <canvas id="chart_sales_by_apps_2_2"
                                                    ...
                                                    <div class="widget11__action align-right">
                                                        <button type="button"
                                                            class="btn btn-outline-brand btn-bold">View All
                                                            Records</button>
                                                    </div>
                                                </div>
