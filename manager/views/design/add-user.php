        ...
        <div class="body grid__item grid__item--fluid grid grid--hor grid--stretch" id="body">
            <div class="content content--fit-top  grid__item grid__item--fluid grid grid--hor" id="content">
                ...
                <div class="container  grid__item grid__item--fluid">
                    <div class="wizard-v4" id="user_add_user">
                            ...
                            <div class="card-body card__body--fit">
                                <div class="grid">
                                    <div class="grid__item grid__item--fluid wizard-v4__wrapper">
                                        ...
                                        <form class="form" id="user_add_form" novalidate="novalidate">
                                        <!-- begin TAB CONTENT -->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-12">
                                                                <div class="section__body">
                                                                    <div class="form-group row">
                                                                        <div class="col-lg-9 col-xl-6">
                                                                            <h3 class="section__title section__title-md">User's Account Details</h3>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-xl-3 col-lg-3 col-form-label">Last Name</label>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-lg-9 col-xl-6">
                                                                            <h3 class="section__title section__title-md">User's Account Settings</h3>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                        ...
                                        <!-- END TAB CONTENT -->
                                            ...
                                            <div class="form__actions">
                                                <div class="btn btn-secondary btn-md btn-tall btn-wide font-bold font-transform-u" data-wizard-type="action-prev">
                                                    Previous
                                                </div>
                                                <div class="btn btn-success btn-md btn-tall btn-wide font-bold font-transform-u" data-wizard-type="action-submit">
                                                    Submit
                                                </div>
                                                <div class="btn btn-brand btn-md btn-tall btn-wide font-bold font-transform-u" data-wizard-type="action-next">
                                                    Next Step
                                                </div>
                                            </div>
                                            <!--end: Form Actions -->
