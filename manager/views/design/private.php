                                    ...
                                    <div class="scroll scroll-pull ps ps--active-y" data-mobile-height="350">
                                        ...
                                        <div class="messages">
                                            ...
                                            <div class="d-flex flex-column mb-4 align-items-start">
                                                ...
                                                <div class="mt-2 rounded p-4 bg-light-success text-dark-50 font-weight-normal font-size-lg text-left max-w-400px">
                                            ...
                                            <div class="d-flex flex-column mb-4 align-items-end">
                                                ...
                                                <div class="mt-2 rounded p-4 bg-light-primary text-dark-50 font-weight-normal font-size-lg text-right max-w-400px">
