                                        ...
                                        <div class="categories-accordion-item">
                                            <div class="categories-accordion-item-level">
                                                ...
                                                <div class="categories-accordion-label">
                                                    ...
                                                    <span class="categories-accordion-title" data-bs-toggle="collapse" data-bs-target="#level1" aria-expanded="true" aria-controls="level1">
                                                        <i class="categories-accordion">
                                                            <svg class="svg" width="18" height="18">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-actions.svg#expand">
                                                                </use>
                                                            </svg>
                                                        </i> Category 1 <span class="count badge badge-success">8</span></span>
                                                ...
                                                <div class="categories-accordion-action">
                                                    ...
                                                    <button type="button" class="btn btn-clean btn-sm btn-icon">
                                                        <svg class="svg" width="18" height="18">
                                                            <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-actions.svg#link">
                                                            </use>
                                                        </svg>
                                            ...
                                            <div id="level1" class="collapse" aria-labelledby="level1" data-parent="#categories-accordion">
                                                ...
                                                <div class="categories-accordion-item">
                                                    <div class="categories-accordion-item-level">
                                                        <div class="categories-accordion-label">
                                                            ...
                                                            <span class="categories-accordion-title" data-bs-toggle="collapse" data-bs-target="#level1-1" aria-expanded="true" aria-controls="level1-1">
                                                                <i class="categories-accordion">
                                                                    <svg class="svg" width="18" height="18">
                                                                        <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-actions.svg#expand">
                                                                        </use>
                                                                    </svg>
                                                                </i> Category 1.1 <span class="count badge badge-success">25</span>
                                                            </span>
                                                    ...
                                                    <div id="level1-1" class="collapse" aria-labelledby="level1-1" data-parent="#categories-accordion">
                                                        ...
                                                        <div class="categories-accordion-item">
                                                            <div class="categories-accordion-item-level">
                                                                <div class="categories-accordion-label">
                                                                    ...
                                                                    <span class="categories-accordion-title" data-bs-toggle="collapse" data-bs-target="#level1-1-1" aria-expanded="true" aria-controls="level1-1-1">
                                                                        <i class="categories-accordion">
                                                                            <svg class="svg" width="18" height="18">
                                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-actions.svg#expand">
                                                                                </use>
                                                                            </svg>
                                                                        </i> Category 1.1.1 <span class="count badge badge-success">25</span>
                                                                    </span>
