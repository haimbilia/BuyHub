                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <label class="col-lg-4 col-form-label label">
                                                            ...
                                                            <i class="fas fa-exclamation-circle ms-1 fs-7"
                                                                data-toggle="tooltip" title=""
                                                                data-original-title="Phone number must be active"
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <label class="col-lg-4 col-form-label label">
                                                            ...
                                                            <i class="fas fa-exclamation-circle ms-1 fs-7"
                                                                data-toggle="tooltip" title=""
                                                                data-original-title="Country of origination"
                                                        ...
                                                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                                            <select name="country" aria-label="Select a Country"
                                                                ...
                                                                data-select2-id="select2-data-10-ho3h" tabindex="-1"
                                                                aria-hidden="true">
                                                                <option value="" data-select2-id="select2-data-12-ef9m">
                                                                    Select a
                                                                    Country...</option>
                                                                ...
                                                                <option data-kt-flag="flags/kyrgyzstan.svg" value="KG">
                                                                    Kyrgyzstan</option>
                                                                <option data-kt-flag="flags/laos.svg" value="LA">Lao
                                                                ...
                                                                <option data-kt-flag="flags/saint-pierre.svg"
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                                            ...
                                                            <select name="language" aria-label="Select a Language"
                                                                ...
                                                                data-select2-id="select2-data-13-8di9" tabindex="-1"
                                                                aria-hidden="true">
                                                                <option value="" data-select2-id="select2-data-15-hgpo">
                                                                    Select a
                                                                    Language...</option>
                                                                <option data-kt-flag="flags/indonesia.svg" value="id">
                                                                ...
                                                                <option data-kt-flag="flags/united-kingdom.svg"
                                                                    value="en-gb">English UK - British English
                                                                </option>
                                                                <option data-kt-flag="flags/spain.svg" value="es">
                                                                ...
                                                                <option data-kt-flag="flags/gabon.svg" value="ga">
                                                                    Gaeilge - Irish (beta)</option>
                                                                <option data-kt-flag="flags/greenland.svg" value="gl">
                                                                    Galego - Galician (beta)</option>
                                                                <option data-kt-flag="flags/croatia.svg" value="hr">
                                                            ...
                                                            <!--end::Input-->
                                                            <!--begin::Hint-->
                                                            <div class="form-text">Please select a preferred
                                                                language, including date, time, and number
                                                                formatting.</div>
                                                            <!--end::Hint-->
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                            </div>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                                            <select name="timezone" aria-label="Select a Timezone"
                                                                ...
                                                                class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                                                data-select2-id="select2-data-16-y1ed" tabindex="-1"
                                                                aria-hidden="true">
                                                                <option value="" data-select2-id="select2-data-18-ws79">
                                                                    Select a
                                                                    Timezone..</option>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-lg-8 fv-row">
                                                            <select name="currnecy" aria-label="Select a Timezone"
                                                                ...
                                                                class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                                                data-select2-id="select2-data-19-4nau" tabindex="-1"
                                                                aria-hidden="true">
                                                                <option value="" data-select2-id="select2-data-21-jrlg">
                                                                    Select a
                                                                    currency..</option>
                                                                <option data-kt-flag="flags/united-states.svg"
                                                                    value="USD">
