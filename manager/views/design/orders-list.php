                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-anim dropdown-menu-fit dropdown-menu-anim scroll scroll-y">
                                                    <ul class="list-checkbox list-drag-drop ui-sortable">
                                                        ...
                                                        <li> <svg class="svg" width="18" height="18">
                                                            ...
                                                            <label class="checkbox"><input type="checkbox" checked value="2">
                                                                Customer
                                                        ...
                                                        <li> <svg class="svg" width="18" height="18">
                                                            ...
                                                            </svg><label class="checkbox"><input type="checkbox" checked value="cod">
                                                                Purchased
                                                        ...
                                                        <li> <svg class="svg" width="18" height="18">
                                                            ...
                                                            </svg><label class="checkbox"><input type="checkbox" checked value="cod"> Order date & time

                                                                <span></span></label> </li>
                                                        <li> <svg class="svg" width="18" height="18">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-actions.svg#drag">
                                                                </use>
                                                            </svg><label class="checkbox"><input type="checkbox" checked value="cod"> Payment Status
                                                        ...
                                                        <li> <svg class="svg" width="18" height="18">
                                                            ...
                                                            </svg><label class="checkbox"><input type="checkbox" checked value="cod"> Fulfillment Status

                                                                <span></span></label> </li>
                                                        <li> <svg class="svg" width="18" height="18">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-actions.svg#drag">
                                                                </use>
                                                            </svg><label class="checkbox"><input type="checkbox" value="cod">
                                                                Payment Mode
                                                        ...
                                                        <li> <svg class="svg" width="18" height="18">
                                                            ...
                                                            </svg><label class="checkbox"><input type="checkbox" checked value="cod"> Total
                                                                <span></span></label> </li>
