                            ...
                            <div class="col-lg-4">
                                <button class="float-btn" type="button" data-trigger="card-aside">
                                    <svg class="svg" width="20" height="20">
                                        <use
                                            xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-actions.svg#nav">
                                        </use>
                                    </svg>
                                </button>
                                <div class="card sticky-sidebar card-aside" id="card-aside"
                                    data-close-on-click-outside="card-aside">
                                    <div class="card-head">
                                        ...
                                        <div class="card-toolbar">
                                            <button class="btn btn-gray card-aside-close"
                                                data-target-close="card-aside">
                                                <svg class="svg" width="24" height="24">
                                                    <use
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="radio-button-group">
                                                            <div class="item">
                                                                <input type="radio" name="button-group"
                                                                    class="radio-button" value="1" id="button1"
                                                                    checked="">
                                                                <label for="button1">1:1</label>
                                                            </div>
                                                            <div class="item">
                                                                <input type="radio" name="button-group"
                                                                    class="radio-button" value="2" id="button2"
                                                                    checked="">
                                                                <label for="button2">16:9</label>
                                                            </div>
                                                            <div class="item">
                                                                <input type="radio" name="button-group"
                                                                    class="radio-button" value="3" id="button3"
                                                                    checked="">
