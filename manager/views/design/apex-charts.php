                        ...
                        <div class="card card--height-fluid">
                            <div class="card-body card__body--fluid">
                                <p>JQVMap is a jQuery plugin that renders Vector Maps with resizable Scalable Vector
                                    Graphics (SVG). For more info please check JQVMap's Home.</p>
                            </div>
                        </div>
                        <!-- END POPRTAL-->
                        <!--START MAIN PORTAL-->
                        <div class="row">
                                ...
                                <div class="card card--height-fluid">
                                    ...
                                    <div class="card-body card__body--fluid">
                                        <div class="iframe-container">
                                            <iframe width="100%" height="100%" src="stock-chart.php"></iframe>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card card--height-fluid">
                                    <div class="card-head">
                                        <div class="card-head-label">
                                            <h3 class="card-head-title">Stock Chart With Numeric Axis</h3>
                                        </div>
                                    </div>
                                    <div class="card-body card__body--fluid">
                                        <div class="iframe-container">
                                            <iframe width="100%" height="100%" src="bar-chart.php"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card card--height-fluid">
                                    <div class="card-head">
                                        <div class="card-head-label">
                                            <h3 class="card-head-title">Multi Series Chart</h3>
                                        </div>
                                    </div>
                                    <div class="card-body card__body--fluid">
                                        <div class="iframe-container">
                                            <iframe width="100%" height="100%" src="multi-series-chart.php"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card card--height-fluid">
                                    <div class="card-head">
                                        <div class="card-head-label">
                                            <h3 class="card-head-title">Exchange Rate</h3>
                                        </div>
                                    </div>
                                    <div class="card-body card__body--fluid">
                                        <div class="iframe-container">
                                            <iframe width="100%" height="100%" src="exchange-rate-chart.php"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
