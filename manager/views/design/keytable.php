                ...
                <div class="container">
                    <div class="alert alert-light alert-elevate" role="alert">
                        ...
                        <div class="alert-text">
                            ...
                            See official documentation <a class="link font-bold" href="https://datatables.net/extensions/keytable/" target="_blank">here</a>.
                        </div>
                    </div>
                            ...
                            <div id="table_1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <table class="table table-striped- table-bordered table-hover table-checkable dataTable dtr-inline" id="table_1" role="grid" aria-describedby="table_1_info" style="position: relative; width: 1268px;">
                                            <thead>
                                                <tr role="row">
