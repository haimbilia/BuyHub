                                    ...
                                    <div class="card-body">
                                        <form class="form">
                                            <div class="form-group">
                                                <label class="label">Logo aspect ratio</label>
                                                <div class="radio-button-group">
                                                    <div class="item">
                                                        <input type="radio" name="button-group" class="radio-button"
                                                            value="1" id="button1" checked />
                                                        <label for="button1">1:1</label>
                                                    </div>
                                                    <div class="item">
                                                        <input type="radio" name="button-group" class="radio-button"
                                                            value="2" id="button2" checked />
                                                        <label for="button2">16:9</label>
                                                    </div>
                                                    <div class="item">
                                                        <input type="radio" name="button-group" class="radio-button"
                                                            value="3" id="button3" checked />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p class="form-text"><strong>Image Disclaimer:</strong>
                                                    File type must be a .jpg, .gif or .png smaller than 2MB and at least
                                                    160x90 in 16:9 aspect ratio
                                                </p>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <ul class="click-to-copy">
                                                    <li title="" data-val="{websiteName}"
                                                        data-original-title="Click to copy"
                                                        aria-describedby="__bv_tooltip_152__">
                                                        <div class="text">Website Name <span class="icn">
                                                                <svg class="svg" width="20" height="20">
                                                                    <use
                                                                        xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#copy">
                                                                    </use>
                                                                </svg>
                                                            </span></div>
                                                    </li>
                                                    ...
                                                    <li title="" data-val="{termsUrl}"
                                                        data-original-title="Click to copy"
                                                        aria-describedby="__bv_tooltip_156__">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <ul class="list-switch list-switch--three web-social-switch">
                                                    <li class="active facebook"><span><i class="svg--icon"><svg
                                                                    width="24px" height="24px" class="svg">
                                                                    <use
                                                                        xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#facebook">
                                                                    </use>
                                                                </svg></i>
                                                        </span></li>
                                                    <li class="active twitter"><span><i class="svg--icon"><svg
                                                                    width="24px" height="24px" class="svg">
                                                                    <use
                                                    ...
                                                    <li class="youtube"><span><i class="svg--icon"><svg width="24px"
                                                                    height="24px" class="svg">
                                                                    <use
                                                                        xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#youtube">
                                                                    </use>
                                                                </svg></i>

                                                        </span></li>
                                                    <li class="instagram"><span><i class="svg--icon"><svg width="24px"
                                                                    height="24px" class="svg">
                                                                    <use
                                                                        xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#instagram">
                                                                    </use>
                                                                </svg></i>

                                                        </span></li>
                                                    <li class="pinterest"><span><i class="svg--icon"><svg width="24px"
                                                                    height="24px" class="svg">
                                                                    <use
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-body">
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                            style="font-size: 16px; font-family: 'Poppins', sans-serif;background-color: #F6F6F6;background-image: url(bg-top.png), url(bg-center.png), url(bg-bottom.png);background-repeat: no-repeat, no-repeat, no-repeat;background-position: top left, right center, bottom left;">
                                            <tr>
                                                <td style="padding:40px;"></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <p style="text-align: center;">Subject: Verification code for
                                                        Account on {Website name}</p>
                                                    <table width="600px" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="padding:30px 40px 50px 40px; text-align: center;">
                                                                <h1
                                                                    style="font-size: 40px;letter-spacing: -0.4px;margin: 0 0 30px 0;font-weight: 700;color: #212529;">
                                                                    Welcome to {website name}</h1>
                                                                <p
                                                                    style="font-size: 16px;line-height: 1.5;letter-spacing: -0.32px;color: #212529;margin: 0 0 10px 0;">
                                                                    Hello {Username},</p>
                                                                <p
                                                                    style="opacity: 0.7;font-size: 14px;letter-spacing: -0.28px;color: #212529;line-height: 1.71;margin: 0 0 20px 0;">
                                                                    You are almost ready to start enjoying {website
                                                                    name} , use the verification code below to activate
                                                                    your account</p>
                                                                <p
                                                                    style="font-size: 32px;font-weight: 500;letter-spacing: 16px;font-weight: 600;">
                                                                    0845</p>
                                                                <p
                                                                    style="opacity: 0.7;font-size: 14px;letter-spacing: -0.28px;color: #212529;line-height: 1.71;margin: 0 0 20px 0;">
                                                                    If you did not sign up to {website name} then please
                                                                    ignore this email or contact us at {email ID}</p>
                                                                <p
                                                                    style="font-size: 14px;line-height: 1.71;letter-spacing: -0.28px;color: #212529;margin: 0;">
                                                                    Thank You<br> Team {website name}
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table width="600px" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td style="text-align:center;">
                                                                <p
                                                                    style="font-family: 'Poppins', sans-serif;font-size: 14px;letter-spacing: -0.2px;display: block;box-sizing: border-box;font-weight: 400;color: #212529;line-height: 26px;margin:0 0 20px 0;">
                                                                    Contact {website name} at<br />
                                                                    <a href="mailto:tribe@sv.com"
                                                                        style="color: #F13925;text-decoration: none;">{Email}</a>
                                                                    or call at <a href="tel:+1235546464"
                                                                        style="color: #F13925;text-decoration: none;">{Phone}</a>
                                                                </p>
                                ...
                                display: block;margin: 0 0 15px 0;color:#212529;">Get In Touch</h5>
                                                                <a href="javascript:void(0);"
                                                                    style="display: inline-block;margin: 0 4px;"><img
                                                                        src="img/fb.png" alt="facebook" /></a>
                                                                <a href="javascript:void(0);"
                                                                    style="display: inline-block;margin: 0 4px;"><img
                                                                        src="img/twt.png" alt="Twitter" /></a>
                                                                <a href="javascript:void(0);"
                                                                    style="display: inline-block;margin: 0 4px;"><img
                                                                        src="img/insta.png" alt="Instagram" /></a>
                                                                <a href="javascript:void(0);"
                                                                    style="display: inline-block;margin: 0 4px;"><img
                                                                        src="img/in.png" alt="Linkedin" /></a>
                                                                <span style="    display: block;
                                width: 100%;
                                font-size: 12px;
                                padding: 10px 0;color: #212529;"></span>
                                                                <a href="javascript:void(0);"
                                                                    style="display: inline-block;font-size: 14px;font-weight: 500;color: 212529;text-decoration: underline;">Terms
                                                                    & Conditions</a>
                                                                <a href="javascript:void(0);"
                                                                    style="display: inline-block;font-size: 14px;font-weight: 500;color: 212529;text-decoration: underline;border-left: 1px solid #212529;line-height: 12px;padding:0 15px;margin:0 15px;">Privacy
                                                                    Policy</a>
                                                            </td>
                                                        </tr>
                                                    </table>
