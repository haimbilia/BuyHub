                                        ...
                                        <div class="form-group">
                                            ...
                                            <ul class="list-switch list-switch--three web-social-switch">
                                                ...
                                                <li class="youtube"><span><i class="svg--icon"><svg width="24px" height="24px" class="svg">
                                                                <use xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#youtube">
                                                                </use>
                                                            </svg></i>
                            ...
                            <div class="card">
                                                ...
                                                <table width="600px" cellspacing="0" cellpadding="0" style="margin:0 auto;table-layout:fixed;background:#ffffff;border-radius: 4px;box-shadow: 0 0 10px rgba(0,0,0,0.04);">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align:center;padding-top: 60px;">
                                                                        <div class="logo-wrapper" style="max-width: 200px;margin: 0 auto;">
                                                                            <img style="max-width: 100%;" src="img/email-logo.png" alt="" />
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td style="padding:30px 40px 50px 40px; text-align: center;">
                                                            <h1 style="font-size: 40px;letter-spacing: -0.4px;margin: 0 0 30px 0;font-weight: 700;color: #212529;">
                                                                Welcome to {website name}</h1>
                                                            <p style="font-size: 16px;line-height: 1.5;letter-spacing: -0.32px;color: #212529;margin: 0 0 10px 0;">
                                                                Hello {Username},</p>
                                                            <p style="opacity: 0.7;font-size: 14px;letter-spacing: -0.28px;color: #212529;line-height: 1.71;margin: 0 0 20px 0;">
                                                                You are almost ready to start enjoying {website
                                                                name} , use the verification code below to activate
                                                                your account</p>
                                                            <p style="font-size: 32px;font-weight: 500;letter-spacing: 16px;font-weight: 600;">
                                                                0845</p>
                                                            <p style="opacity: 0.7;font-size: 14px;letter-spacing: -0.28px;color: #212529;line-height: 1.71;margin: 0 0 20px 0;">
                                                                If you did not sign up to {website name} then please
                                                                ignore this email or contact us at {email ID}</p>
                                                            <p style="font-size: 14px;line-height: 1.71;letter-spacing: -0.28px;color: #212529;margin: 0;">
                                                ...
                                                <table width="600px" cellspacing="0" cellpadding="0" style="margin:0 auto;table-layout:fixed;">
                                                    <tr>
                                                        <td style="text-align:center;">
                                                            <p style="font-family: 'Poppins', sans-serif;font-size: 14px;letter-spacing: -0.2px;display: block;box-sizing: border-box;font-weight: 400;color: #212529;line-height: 26px;margin:0 0 20px 0;">
                                                                Contact {website name} at<br />
                                                                <a href="mailto:tribe@sv.com" style="color: #F13925;text-decoration: none;">{Email}</a>
                                                                or call at <a href="tel:+1235546464" style="color: #F13925;text-decoration: none;">{Phone}</a>
                                                            </p>
                                ...
                                padding: 10px 0;color: #212529;"></span>
                                                            <a href="javascript:void(0);" style="display: inline-block;font-size: 14px;font-weight: 500;color: 212529;text-decoration: underline;">Terms
                                                                & Conditions</a>
                                                            <a href="javascript:void(0);" style="display: inline-block;font-size: 14px;font-weight: 500;color: 212529;text-decoration: underline;border-left: 1px solid #212529;line-height: 12px;padding:0 15px;margin:0 15px;">Privacy
                                                                Policy</a>
                                                        </td>
                                                    </tr>
                                                </table>
