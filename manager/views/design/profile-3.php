                            ...
                            <div class="card-body  card__body--fit">
                                <div class="row row-no-padding row-col-separator-xl">
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card card--height-fluid">
                                            <div class="widget14">
                                                <div class="widget14__header margin-b-30">
                                                    <h3 class="widget14__title">
                                                        Daily Sales
                                                    </h3>
                                                    <span class="widget14__desc">
                                                        Check out each collumn for more details
                                                    </span>
                                                </div>
                                                <div class="widget14__chart" style="height:120px;">
                                                    ...
                                                    <canvas id="chart_daily_sales" style="display: block; width: 396px; height: 120px;" width="396" height="120" class="chartjs-render-monitor"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card card--height-fluid">
                                            <div class="widget14">
                                                ...
                                                <div class="widget14__content">
                                                    <div class="widget14__chart">
                                                        <div class="chartjs-size-monitor">
                                                            <div class="chartjs-size-monitor-expand">
                                                                <div class=""></div>
                                                            </div>
                                                        ...
                                                        <div class="widget14__stat">45</div>
                                                        <canvas id="chart_profit_share" style="height: 140px; width: 140px; display: block;" width="140" height="140" class="chartjs-render-monitor"></canvas>
                                                    </div>
                                                    <div class="widget14__legends">
                                                        <div class="widget14__legend">
                                                            <span class="widget14__bullet bg-success"></span>
                                                            <span class="widget14__stats">37% Sport Tickets</span>
                                                        </div>
                                                        <div class="widget14__legend">
                                                            <span class="widget14__bullet bg-warning"></span>
                                                            <span class="widget14__stats">47% Business Events</span>
                                                        </div>
                                                        <div class="widget14__legend">
                                                            <span class="widget14__bullet bg-brand"></span>
                                                            <span class="widget14__stats">19% Others</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card card--height-fluid">
                                            <div class="widget14">
                                                ...
                                                <div class="widget14__content">
                                                    <div class="widget14__chart">
                                                        <div id="chart_revenue_change" style="height: 150px; width: 150px;"><svg height="150" version="1.1" width="150" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="overflow: hidden; position: relative; left: -0.8125px; top: -0.578125px;">
                                                                ...
                                                                <path fill="none" stroke="#366cf3" d="M82.89188458674082,32.39136313554092A43.333333333333336,43.333333333333336,0,1,0,74.98638643205842,118.33333119491907" stroke-width="2" opacity="1" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); opacity: 1;"></path>
                                                                <path fill="#366cf3" stroke="#ffffff" d="M83.43824582736133,29.441534429539914A46.333333333333336,46.333333333333336,0,1,0,74.98544395427786,121.333331046875L74.97957964808764,139.9999967923786A65,65,0,1,1,86.83782688011121,11.087044703311392Z" stroke-width="3" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path><text x="75" y="65" text-anchor="middle" font-family="&quot;Arial&quot;" font-size="15px" stroke="none" fill="#000000" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: Arial; font-size: 15px; font-weight: 800;" font-weight="800" transform="matrix(0.9848,0,0,0.9848,1.1364,1.1515)" stroke-width="1.0153846153846153">
                                                                    <tspan dy="6" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">Paris</tspan>
                                                                </text><text x="75" y="85" text-anchor="middle" font-family="&quot;Arial&quot;" font-size="14px" stroke="none" fill="#000000" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); text-anchor: middle; font-family: Arial; font-size: 14px;" transform="matrix(0.9028,0,0,0.9028,7.3015,7.4861)" stroke-width="1.1076923076923078">
                                                                    <tspan dy="5" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">20</tspan>
                                                                </text>
                                                            </svg></div>
                                                    </div>
                                                    <div class="widget14__legends">
                                                        <div class="widget14__legend">
                                                            <span class="widget14__bullet bg-success"></span>
                                                            <span class="widget14__stats">+10% New York</span>
                                                        </div>
                                                        <div class="widget14__legend">
                                                            <span class="widget14__bullet bg-warning"></span>
                                                            <span class="widget14__stats">-7% London</span>
                                                        </div>
                                                        <div class="widget14__legend">
                                                            <span class="widget14__bullet bg-brand"></span>
                                                            <span class="widget14__stats">+20% California</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="widget4">
                                        <div class="widget4__item">
                                            <div class="widget4__pic widget4__pic--icon">
                                                <img src="/metronic/themes/metronic/theme/default/demo4/dist/assets/media/files/doc.svg" alt="">
                                            </div>
                                        ...
                                        <div class="widget4__item">
                                            <div class="widget4__pic widget4__pic--icon">
                                                <img src="/metronic/themes/metronic/theme/default/demo4/dist/assets/media/files/jpg.svg" alt="">
                                            </div>
                                            <a href="#" class="widget4__title">
                                        ...
                                        <div class="widget4__item">
                                            <div class="widget4__pic widget4__pic--icon">
                                                <img src="/metronic/themes/metronic/theme/default/demo4/dist/assets/media/files/pdf.svg" alt="">
                                            </div>
                                            <a href="#" class="widget4__title">
                                        ...
                                        <div class="widget4__item">
                                            <div class="widget4__pic widget4__pic--icon">
                                                <img src="/metronic/themes/metronic/theme/default/demo4/dist/assets/media/files/javascript.svg" alt="">
                                            </div>
                                            <a href="#" class="widget4__title">
                                                Make JS Development
                                            </a>
                                        ...
                                        <div class="widget4__item">
                                            <div class="widget4__pic widget4__pic--icon">
                                                <img src="/metronic/themes/metronic/theme/default/demo4/dist/assets/media/files/zip.svg" alt="">
                                            </div>
                                            <a href="#" class="widget4__title">
