                                    ...
                                    <form class="form form-search" action="#">
                                        <div class="card-head">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="input-group">
                                                            ...
                                                            <a class="btn advanced-trigger ml-2 collapsed"
                                                                data-toggle="collapse" href="#collapseExample"
                                                                aria-expanded="false" aria-controls="collapseExample">
                                                                <svg class="svg" width="22" height="22">
                                                                    <use
                                                                        xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite-actions.svg#double-arrow">
                                                                    </use>
                                                                </svg>
                                                            </a>
                                            ...
                                            <div class="card-toolbar">
                                                <ul>
                                                    <li>
                                                        <a class="btn btn-outline-brand btn-icon"
