                                    ...
                                    <div class="widget widget--user-profile-1">
                                        ...
                                        <div class="widget__body">
                                            ...
                                            <div class="widget__items">
                                                ...
                                                <a href="profile-personal-information.php" class="widget__item widget__item--active">
                                                    <span class="widget__section">
                                                        <span class="widget__icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-head">
                                            <div class="card-head-label">
                                                <h3 class="card-head-title">Personal Information <small>update your personal informaiton</small></h3>
                                            </div>
                                            <div class="card-head-toolbar">
