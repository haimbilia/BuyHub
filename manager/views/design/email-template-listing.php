                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a class="btn btn-link collapsed" data-bs-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Advanced
                                                    Search</a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input data-field-caption="template Name" type="text" name="template_name" value="Abandoned Cart Deleted Discount Notification">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input data-field-caption="email subject " type="text" name="subject_name" value="Verification link for changing your email on {websiteName}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
