                        ...
                        <div class="col">
                            <div class="alert alert-light alert-elevate fade show" role="alert">
                                ...
                                <div class="alert-text">
                                    ...
                                    <br>
                                    For more info please visit the plugin's <a class="link font-bold" href="http://mimo84.github.io/bootstrap-maxlength/" target="_blank">Demo
                                        Page</a> or <a class="link font-bold" href="https://github.com/mimo84/bootstrap-maxlength" target="_blank">Github
                                        Repo</a>.
                                </div>
                            </div>
                        </div>
                        ...
                        <form class="form form--label-right">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <a href="" class="btn btn-brand btn-pill" data-bs-toggle="modal" data-bs-target="#maxlength_modal">Launch maxlength inputs on modal</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-foot">
