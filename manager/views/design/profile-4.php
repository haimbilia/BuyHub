                                    ...
                                    <div class="widget widget--user-profile-2">
                                        <div class="widget__head">
                                            <div class="widget__media">
                                                <img class="widget__img hidden-" src="/metronic/themes/metronic/theme/default/demo4/dist/assets/media//users/100_6.jpg" alt="image">
                        ...
                        <div class="grid__item grid__item--fluid app__content">
                                            ...
                                            <div class="row row-no-padding row-col-separator-xl">
                                                ...
                                                <div class="col-md-12 col-lg-12 col-xl-4">
                                                    ...
                                                    <div class="widget1">
                                                        <div class="widget1__item">
                                                            <div class="widget1__info">
                                                                <h3 class="widget1__title">IPO Margin</h3>
                                                                <span class="widget1__desc">Awerage IPO Margin</span>
                                                            </div>
                                                            <span class="widget1__number font-success">+24%</span>
                                                        </div>

                                                        <div class="widget1__item">
                                                            <div class="widget1__info">
                                                                <h3 class="widget1__title">Payments</h3>
                                                                <span class="widget1__desc">Yearly Expenses</span>
                                                            </div>
                                                            <span class="widget1__number font-info">+$560,800</span>
                                                        </div>

                                                        <div class="widget1__item">
                                                            <div class="widget1__info">
                                                                <h3 class="widget1__title">Logistics</h3>
                                                                <span class="widget1__desc">Overall Regional Logistics</span>
                                                            </div>
                                                            <span class="widget1__number font-warning">-10%</span>
                                                        </div>
                                                ...
                                                <div class="col-md-12 col-lg-12 col-xl-4">
                                                    ...
                                                    <div class="widget1">
                                                        <div class="widget1__item">
                                                            <div class="widget1__info">
                                                                <h3 class="widget1__title">Orders</h3>
                                                                <span class="widget1__desc">Awerage Weekly Orders</span>
                                                            </div>
                                                            <span class="widget1__number font-success">+15%</span>
                                                        </div>

                                                        <div class="widget1__item">
                                                            <div class="widget1__info">
                                                                <h3 class="widget1__title">Transactions</h3>
                                                                <span class="widget1__desc">Daily Transaction Increase</span>
                                                            </div>
                                                            <span class="widget1__number font-danger">+80%</span>
                                                        </div>

                                                        <div class="widget1__item">
                                                            <div class="widget1__info">
                                                                <h3 class="widget1__title">Revenue</h3>
                                                                <span class="widget1__desc">Overall Revenue Increase</span>
                                                            </div>
                                                            <span class="widget1__number font-primary">+60%</span>
                                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="card card--bordered-semi card--height-fluid">
                                        <div class="card-head">
                                            <div class="card-head-label">
                                                <h3 class="card-head-title">
                                                    Authors Profit
                                        ...
                                        <div class="card-body">
                                            <div class="widget4">
                                                <div class="widget4__item">
                                                    <div class="widget4__pic widget4__pic--logo">
                                                        <img src="/metronic/themes/metronic/theme/default/demo4/dist/media/client-logos/logo5.png" alt="">
                                                    </div>
                                                    ...
                                                    <span class="widget4__number font-brand">+$2500</span>
                                                </div>

                                                <div class="widget4__item">
                                                    <div class="widget4__pic widget4__pic--logo">
                                                        <img src="/metronic/themes/metronic/theme/default/demo4/dist/media/client-logos/logo4.png" alt="">
                                                    </div>
                                                    <div class="widget4__info">
                                                        <a href="#" class="widget4__title">
                                                            StarBucks
                                                    ...
                                                    <span class="widget4__number font-brand">-$290</span>
                                                </div>
                                                ...
                                                <div class="widget4__item">
                                                    ...
                                                    <span class="widget4__number font-brand">+$17</span>
                                                </div>
                                                ...
                                                <div class="widget4__item">
                                                    ...
                                                    <span class="widget4__number font-brand">-$2.50</span>
                                                </div>
                                                ...
                                                <div class="widget4__item">
                                                    ...
                                                    <span class="widget4__number font-brand">+$200</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="widget3">
                                                <div class="widget3__item">
                                                    <div class="widget3__header">
                                                        ...
                                                        <span class="widget3__status font-info">
                                                            Pending
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="widget3__item">
                                                    <div class="widget3__header">
                                                        ...
                                                        <span class="widget3__status font-brand">
                                                            Open
                                                        </span>
                                                    </div>
                                                    <div class="widget3__body">
                                                ...
                                                <div class="widget3__item">
                                                    <div class="widget3__header">
                                                        ...
                                                        <span class="widget3__status font-success">
                                                            Closed
                                                        </span>
                                                    </div>
                                                    <div class="widget3__body">
