                            ...
                            <div class="card">
                                <div class="card-head">
                                    <div class="card-head-label">
                                        <h3 class="card-head-title">Subscription Packages</h3><span class="text-muted">Over 500 new products</span>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="packages-data">
                                                        <div class="h6">
                                                            <a href="" data-bs-toggle="collapse" data-bs-target="#plan1" aria-expanded="false" aria-controls="plan1">
                                                                Silver Plan
                                                                <i class="">
                                                                    <svg class="svg" width="18" height="18">
