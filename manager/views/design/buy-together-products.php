                                                        ...
                                                        <div class="product-profile">
                                                            ...
                                                            <div class="product-profile__data">
                                                                ...
                                                                <ul class="list-options list-options--horizontal">
                                                                    <li class="storage"><span class="label">Storage:</span><span class="value"> 128GB</span>
                                                                    </li>
                                                                    <li class="color"><span class="label">Color: </span><span class="value">Black</span>
                                                                    </li>
                                                                    <li class="seller"><span class="label">Seller: </span><span class="value">Michael</span></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </td>
