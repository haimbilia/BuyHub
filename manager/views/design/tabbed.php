                                ...
                                <div class="card-head">
                                    ...
                                    <div class="card-head-toolbar">
                                        <ul class="nav nav-tabs nav-tabs-bold nav-tabs-line   nav-tabs-line-right nav-tabs-line-brand" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#card_tab_1_1" role="tab">
                                                    Logs
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#card_tab_1_2" role="tab">
                                                    Messages
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#card_tab_1_3" role="tab">
                                                    Settings
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            <div class="card card-tabs">
                                <div class="card-head">
                                    ...
                                    <div class="card-head-toolbar">
                                        <ul class="nav nav-tabs nav-tabs-bold nav-tabs-line nav-tabs-line-right nav-tabs-line-brand" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#card_tab_2_1" role="tab">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-anim ">
                                                    <a class="dropdown-item" data-bs-toggle="tab" href="#card_tab_2_2">Action</a>
                                                    <a class="dropdown-item" data-bs-toggle="tab" href="#card_tab_2_3">Another action</a>
                                                    <a class="dropdown-item" data-bs-toggle="tab" href="#card_tab_2_1">Something else here</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" data-bs-toggle="tab" href="#card_tab_2_3">Separated link</a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="card-head">
                                    ...
                                    <div class="card-head-toolbar">
                                        <ul class="nav nav-tabs nav-tabs-bold nav-tabs-line nav-tabs-line-brand  nav-tabs-line-right nav-tabs-line-danger" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#card_tab_3_1" role="tab">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-anim ">
                                                    <a class="dropdown-item" data-bs-toggle="tab" href="#card_tab_3_2">Action</a>
                                                    <a class="dropdown-item" data-bs-toggle="tab" href="#card_tab_3_3">Another action</a>
                                                    <a class="dropdown-item" data-bs-toggle="tab" href="#card_tab_3_2">Something else here</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" data-bs-toggle="tab" href="#card_tab_3_3">Separated link</a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-2x nav-tabs-line-success" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#tabs_4_1" role="tab">Messages</a>
                                        </li>
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" data-bs-toggle="tab" href="#tabs_4_3">Another action</a>
                                                <a class="dropdown-item" data-bs-toggle="tab" href="#tabs_4_1">Something else here</a>
                                                <div class="dropdown-divider"></div>
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" data-bs-toggle="tab" href="#tabs_5_1">Another action</a>
                                                <a class="dropdown-item" data-bs-toggle="tab" href="#tabs_5_3">Something else here</a>
                                                <div class="dropdown-divider"></div>
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-danger" role="tablist">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" data-bs-toggle="tab" href="#tabs_6_3">Another action</a>
                                                <a class="dropdown-item" data-bs-toggle="tab" href="#tabs_6_2">Something else here</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item" data-bs-toggle="tab" href="#tabs_6_1">Separated link</a>
                                            </div>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="card-head">
                                    ...
                                    <div class="card-head-toolbar">
                                        <ul class="nav nav-pills nav-pills-sm" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#tabs_7_1" role="tab">
                                                    Logs
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#tabs_7_2" role="tab">
                                                    Messages
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#tabs_7_3" role="tab">
                                                    Settings
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <div class="card-head">
                                    ...
                                    <div class="card-head-toolbar">
                                        <ul class="nav nav-pills nav-pills" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#tabs_8_1" role="tab">
                                                    Logs
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#tabs_8_2" role="tab">
                                                    Messages
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#tabs_8_3" role="tab">
                                                    Settings
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <div class="card-head">
                                    <div class="card-head-toolbar">
                                        <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-brand nav-tabs-line-2x nav-tabs-line-right nav-tabs-bold" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#card_base_demo_3_3_tab_content" role="tab">
                                                    <i class="flaticon2-heart-rate-monitor" aria-hidden="true"></i>Messages
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#card_base_demo_3_2_tab_content" role="tab">
                                                    <i class="flaticon2-pie-chart-2" aria-hidden="true"></i>Settings
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#card_base_demo_3_3_tab_content" role="tab">
