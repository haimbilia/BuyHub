                    ...
                    <div class="container">
                        <div class="alert alert-light alert-elevate" role="alert">
                            ...
                            <div class="alert-text">
                                The Metronic Datatable allows the end user to select single or multiple rows using
                                checkbox to perform operations over rows.
                            </div>
                        </div>
                        ...
                        <div class="card card--mobile">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form form--label-align-right margin-t-20 collapse"
                                    id="datatable_group_action_form">
                                    <div class="row align-items-center">
                                        <div class="col-xl-12">
                                            <div class="form__group form__group--inline">
                                                ...
                                                <div class="form__control">
                                                    <div class="btn-toolbar">
                                                        <div class="dropdown">
                                                            <button type="button"
                                                                class="btn btn-brand btn-sm dropdown-toggle"
                                                        ...
                                                        <button class="btn btn-sm btn-danger" type="button"
                                                            id="datatable_delete_all">Delete All</button>
                                                        &nbsp;&nbsp;&nbsp;
                                                        <button class="btn btn-sm btn-success" type="button"
                                                            data-toggle="modal" data-target="#modal_fetch_id">Fetch
                            ...
                            <div class="card-body card__body--fit">
                                ...
                                <div class="datatable datatable--default datatable--brand datatable--scroll datatable--loaded"
                                    id="local_record_selection" style="">
                                    <table class="datatable__table" style="display: block; max-height: 350px;">
                                        ...
                                        <tbody class="datatable__body ps ps--active-y" style="max-height: 297px;">
                                            <tr data-row="0" class="datatable__row" style="left: 0px;">
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">61715-075</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">China CN</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">746 Pine View Junction</span></td>
                                                ...
                                                <td class="datatable__cell--left datatable__cell" data-field="Actions"
                                                    data-autohide-disabled="false"><span
                                                        ...
                                                        <div class="dropdown"> <a data-toggle="dropdown"
                                                            ...
                                                            class="btn btn-sm btn-clean btn-icon btn-icon-sm"> <i
                                                                class="flaticon2-file"></i> </a> <a title="Delete"
                                                            class="btn btn-sm btn-clean btn-icon btn-icon-sm"> <i
                                            ...
                                            <tr data-row="1" class="datatable__row datatable__row--even"
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">63629-4697</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">Indonesia ID</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">01652 Fulton Trail</span></td>
                                                <td data-field="ShipDate" class="datatable__cell"><span
                                            ...
                                            <tr data-row="2" class="datatable__row" style="left: 0px;">
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">68084-123</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">Argentina AR</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">2 Pine View Park</span></td>
                                                <td data-field="ShipDate" class="datatable__cell"><span
                                            ...
                                            <tr data-row="3" class="datatable__row datatable__row--even"
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">67457-428</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">Indonesia ID</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">3050 Buell Terrace</span></td>
                                                <td data-field="ShipDate" class="datatable__cell"><span
                                            ...
                                            <tr data-row="4" class="datatable__row" style="left: 0px;">
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">31722-529</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">Austria AT</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">3038 Trailsway Junction</span></td>
                                                <td data-field="ShipDate" class="datatable__cell"><span
                                            ...
                                            <tr data-row="5" class="datatable__row datatable__row--even"
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">64117-168</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">China CN</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">023 South Way</span></td>
                                                <td data-field="ShipDate" class="datatable__cell"><span
                                            ...
                                            <tr data-row="6" class="datatable__row" style="left: 0px;">
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">43857-0331</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">China CN</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">56482 Fairfield Terrace</span></td>
                                                <td data-field="ShipDate" class="datatable__cell"><span
                                            ...
                                            <tr data-row="7" class="datatable__row datatable__row--even"
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">64980-196</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">Croatia HR</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">0 Elka Street</span></td>
                                                <td data-field="ShipDate" class="datatable__cell"><span
                                            ...
                                            <tr data-row="8" class="datatable__row" style="left: 0px;">
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">0404-0360</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">Colombia CO</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">38099 Ilene Hill</span></td>
                                                <td data-field="ShipDate" class="datatable__cell"><span
                                            ...
                                            <tr data-row="9" class="datatable__row datatable__row--even"
                                                ...
                                                <td data-field="OrderID" class="datatable__cell"><span
                                                        style="width: 148px;">52125-267</span></td>
                                                <td data-field="Country" class="datatable__cell"><span
                                                        style="width: 148px;">Thailand TH</span></td>
                                                <td data-field="ShipAddress" class="datatable__cell"><span
                                                        style="width: 148px;">8696 Barby Pass</span></td>
                                                <td data-field="ShipDate" class="datatable__cell"><span
                        ...
                        <div class="card card--mobile">
                            ...
                            <div class="card-body">
                                ...
                                <!--begin: Selected Rows Group Action Form -->
                                <div class="form form--label-align-right margin-t-20 collapse"
                                    id="datatable_group_action_form1">
                                    <div class="row align-items-center">
                                        <div class="col-xl-12">
                                            <div class="form__group form__group--inline">
                                                <div class="form__label form__label-no-wrap">
                                                ...
                                                <div class="form__control">
                                                    <div class="btn-toolbar">
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;
                                                        <button class="btn btn-sm btn-danger" type="button"
                                                            id="datatable_delete_all1">Delete All</button>
                                                        &nbsp;&nbsp;&nbsp;
                                                        <button class="btn btn-sm btn-success" type="button"
                                                            data-toggle="modal"
                                                            data-target="#modal_fetch_id_server">Fetch Selected
                                                            Records</button>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body card__body--fit">
                                ...
                                <!--begin::Modal-->
                                <div class="modal fade" id="modal_fetch_id" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="scrollable" data-scrollbar-shown="true"
                                ...
                                <!--begin::Modal-->
                                <div class="modal fade" id="modal_fetch_id_server" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
