                ...
                <div class="container">
                    ...
                    <div class="card card--mobile">
                        ...
                        <div class="card-body card__body--fit">
                            <!--begin: Datatable -->
                            <div class="datatable datatable--default datatable--brand datatable--scroll datatable--loaded" id="local_record_selection" style="">
                                <table class="datatable__table" style="display: block; max-height: 350px;">
                                    <thead class="datatable__head">
                                        <tr class="datatable__row" style="left: 0px;">
                                            <th data-field="RecordID" class="datatable__cell--center datatable__cell datatable__cell--check">
                                            ...
                                            <th data-field="Actions" data-autohide-disabled="false" class="datatable__cell--left datatable__cell datatable__cell--sort">
                                    ...
                                    <tbody class="datatable__body ps ps--active-y" style="max-height: 297px;">
                                        <tr data-row="0" class="datatable__row" style="left: 0px;">
                                            ...
                                            <td class="datatable__cell--left datatable__cell" data-field="Actions" data-autohide-disabled="false"><span style="overflow: visible; position: relative; width: 110px;">
                                                    ...
                                                    </div> <a title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-sm"> <i class="flaticon2-file"></i> </a> <a title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-sm"> <i class="flaticon2-delete"></i> </a>
                                                </span></td>
                                        </tr>
                    ...
                    <div class="card card--mobile">
                        ...
                        <div class="card-body card__body--fit">
                            <!--begin: Datatable -->
                            <div class="datatable datatable--default datatable--brand datatable--scroll datatable--loaded" id="server_record_selection" style="">
                                <table class="datatable__table" style="display: block; max-height: 350px;">
                                    <thead class="datatable__head">
                                        <tr class="datatable__row" style="left: 0px;">
                                            <th data-field="RecordID" class="datatable__cell--center datatable__cell datatable__cell--check">
