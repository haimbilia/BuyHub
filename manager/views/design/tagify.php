                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group form-group-last row">
                                            <label class="col-form-label col-lg-3 col-sm-12">Templates
                                                examples</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <input class="form-tagify" id="tagify_5" name="tags3" placeholder="Add users" value="Chris Muller, Lina Nilson">
                                        ...
                                        <div class="form-group form-group-last row">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                ...
                                                <input class="form-tagify" id="tagify_3" name="tags-outside" class="tagify tagify--outside" value="css, html, javascript" placeholder="write some tags">
                                        ...
                                        <div class="form-group form-group-last row">
                                            <label class="col-form-label col-lg-3 col-sm-12">Advance
                                                examples</label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <input class="form-tagify" id="tagify_4" name="tags3" placeholder="Write some tags" pattern="^[A-Za-z_✲ ]{1,15}$" value="css, html, javascript, angular, vue, react">
