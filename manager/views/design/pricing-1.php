...
?>
                                        ...
                                        <div class="pricing">
                                            <div class="widget_price align-center">
                                                ...
                                                <div class="widget-price-body">
                                                    ...
                                                    <p class="pt-20 mb-30">Lorem ipsum dolor sit amet edipiscing elit
                                                        sed do eiusmod elpors labore et dolore magna siad enim aliqua
                                                    </p>
                                        ...
                                        <div class="pricing">
                                            <div class="widget_price align-center">
                                                ...
                                                <div class="widget-price-body">
                                                    <h3 class="bold-title">Free</h3>
                                                    <p class="text-semi">1 End Product License</p>
                                                    <p class="pt-20 mb-30">Lorem ipsum sed do eiusmod magna siad enim
                                                        aliqua</p>
                                                    <button type="button" class="btn btn-primary">Get For Free</button>
                                                </div>
                                            </div>
			...
			c12.983,0,23.546-10.563,23.546-23.546V23.547C495.97,16.797,493.068,10.362,488.008,5.895z" />
                                            ...
                                            <div class="widget_price align-center">
                                                ...
                                                <div class="widget-price-body">
                                                    ...
                                                    <p class="pt-20 mb-30">Lorem ipsum sed do eiusmod magna siad enim
                                                        aliqua</p>
                                                    <button type="button"
                                                        class="btn btn-warning text-white">Purchase</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!--begin::Modal-->
                    <div class="modal fade" id="datatable_records_fetch_modal" tabindex="-1" role="dialog"
