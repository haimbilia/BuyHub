                        ...
                        <form class="form form--label-right">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <a href="" class="btn btn-label-brand" data-bs-toggle="modal" data-bs-target="#datetimepicker_modal">Launch Modal Date Time pickers</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-foot">
                            ...
                            <div class="modal-content">
                                ...
                                <form class="form form--fit form--label-right">
                                    ...
                                    <div class="modal-footer">
                                        <button type="reset" class="btn btn-brand" data-bs-dismiss="modal">Close</button>
