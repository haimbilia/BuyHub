                ...
                <ul class="accounts-nav">
                                                ...
                                                <li class="search-results_item">
                                                    ...
                                                    <div class="search-results_data">
                                                        <i class="search-results_icn">
                                                            <svg class="svg" height="16" viewBox="0 0 16 16" width="16"
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle no-after" data-toggle="dropdown" href="">
                            <img class="accounts-nav_avatar" aria-expanded="false"
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-anim">
                            <ul class="nav nav-block">
                                ...
                                <li class="nav__item "><a class="dropdown-item nav__link" data-org-url="#"
                                        href="#">Dashboard</a></li>
                                <li class="nav__item logout"><a class="dropdown-item nav__link" data-org-url="#"
                                        href="#">Logout </a></li>
                            </ul>
                        </div>
                    </li>
