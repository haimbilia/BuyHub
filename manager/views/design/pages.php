...
<body class="">
        ...
        <div class="body" id="body">
            ...
            <div class="demo">
                ...
                <div class="demo__content">
                    ...
                    <div class="demo__content-switch">
                    ...
                    <div class="demo__content-action">
                        <ul class="list-items list-items--icon">
                            <li class="list-item">
                                <a href="javascript:0;">
                                    <span class="icon">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="list-group">
                                        <li class="list-group-item"><a target="_blank" href="dashboard-new.php">Add products(seller) </a></li>
                                        ...
                                        <li class="list-group-item"><a target="_blank" href="order-detail.php">Order
                                                detail</a></li>
                                        <li class="list-group-item"><a href="collections-managements.php">Collections Managements</a></li>
                                        <li class="list-group-item"><a target="_blank" href="products.php">Products</a></li>
                                        <li class="list-group-item"><a target="_blank" href="listing.php">Listing</a></li>
                                        <li class="list-group-item"><a target="_blank" href="seller-packages.php">Seller
                                                Packages</a></li>
                                        <li class="list-group-item"><a target="_blank" href="login-1.php">Login</a>
                                        </li>
                                        <li class="list-group-item"><a target="_blank" href="password-reset.php">Password Reset</a>
                                        </li>
                                        <li class="list-group-item"><a target="_blank" href="profile-management.php">Profile
                                                Management</a></li>
                                        <li class="list-group-item"><a target="_blank" href="get-started.php">Getting Started</a>
                                        </li>
                                        <li class="list-group-item"><a target="_blank" href="settings.php">Settings</a></li>
                                        <li class="list-group-item"><a target="_blank" href="settings-theme.php">Theme Setting</a>
                                        </li>
                                        <li class="list-group-item"><a target="_blank" href="settings-plugins.php">Plugins
                                                Setting</a></li>
                                        <li class="list-group-item"><a target="_blank" href="settings-media.php">Media Setting</a>
                                        </li>
                                        <li class="list-group-item"><a target="_blank" href="messages.php">Messages</a></li>
                                        <li class="list-group-item"><a target="_blank" href="buy-together-products.php">Buy Together
                                                Products</a></li>
                                        <li class="list-group-item"><a target="_blank" href="related-products.php">Related
                                                Products</a></li>
                                        <li class="list-group-item"><a target="_blank" href="email-template-settings.php" target="_blank">Email temaplate -
                                                Settings</a> </li>
                                        <li class="list-group-item"><a target="_blank" href="email-template-listing.php" target="_blank">Email temaplate -
                                                listing</a></li>
                                        <li class="list-group-item"><a target="_blank" href="navigation-management.php">Navigation
                                                Management</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="fontawesome5.php">Fontawesome
                                                                                5</a></li>
                                                                        <li><a href="lineawesome.php">Lineawesome</a>
                                                                        </li>
                                                        ...
                                                        <li><a href="#">Form & Controls</a>
                                                            <ul>
                                                                ...
                                                                <li><a href="#">Form Widget</a>
                                                                    <ul>
                                                                        <li><a href="bootstrap-datepicker.php">Datepicker</a>
                                                                        </li>
                                                                        <li><a href="bootstrap-datetimepicker.php">DateTimepicker</a>
                                                                        </li>
                                                                        <li><a href="bootstrap-timepicker.php">Timepicker</a>
                                                                        </li>
                                                                        <li><a href="bootstrap-daterangepicker.php">Daterangepicker</a>
                                                                        </li>
                                                                        <li><a href="tagify.php">Tagify</a></li>
                                                                        <li><a href="bootstrap-touchspin.php">Touchspin</a>
                                                                        </li>
                                                                        <li><a href="bootstrap-maxlength.php">Maxlength</a>
                                                                        </li>
                                                                        <li><a href="bootstrap-switch.php">Switch</a>
                                                                        </li>
                                                                        <li><a href="bootstrap-multipleselectsplitter.php">Multiple
                                                            ...
                                                            <ul>
                                                                <li><a href="#">Base</a>
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="translation.php">Translation</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                ...
                                                <li>
                                                    <a href="">Emails</a>
                                                    <ul>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/account-verification.html" target="_blank">Account Verification</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/account-verification-admin.html" target="_blank">Account Verification Admin</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/admin-message.html" target="_blank">Admin Message</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/admin-review-recived-approval.html" target="_blank">Admin Review Approval</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/admin-review-recived-without-approval.html" target="_blank">Admin Review Without
                                                                Approval</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/buyer-give-review.html" target="_blank">Buyer Give Review</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/buyer-message.html" target="_blank">Buyer Message</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/cancellation-requested-admin.html" target="_blank">Cancellation Requested Admin</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/cancellation-requested-buyer.html" target="_blank">Cancellation Requested Buyer</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/COD-payment-link.html" target="_blank">COD Payment Link</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/COD-verification.html" target="_blank">COD Verification</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/contact-us-admin.html" target="_blank">Contact Us Admin</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/contact-us-buyer.html" target="_blank">Contact Us Buyer</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/digital-download.html" target="_blank">Digital Download</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/discount-coupon-buyer.html" target="_blank">Discount Coupon Buyer</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/email-from-admin-buyer.html" target="_blank">Email from Admin To Buyer</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/failed-login-attempt.html" target="_blank">Failed Login Attempt</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/failed-login-attempt-admin.html" target="_blank">Failed Login Attempt Admin</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/favorite-email-buyer.html" target="_blank">Favorite Email Buyer</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/favorite-price-drop-buyer.html" target="_blank">Favorite Price Drop Buyer</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/forgot-password.html" target="_blank">Forgot Password</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/forgot-password-admin.html" target="_blank">Forgot Password Admin</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/GDPR-delete-account.html" target="_blank">GDPR Delete Account</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/GDPR-information-buyer.html" target="_blank">GDPR Information Buyer</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/general-email.html" target="_blank">General Email</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/new-order-admin.html" target="_blank">New Order Admin</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/newsletter-subscribe-admin.html" target="_blank">Newsletter subscribe admin</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/newsletter-subscribe-buyer.html" target="_blank">Newsletter subscribe buyer</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/newsletter-unsubscribe-admin.html" target="_blank">Newsletter unsubscribe admin</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/newsletter-unsubscribe-buyer.html" target="_blank">Newsletter unsubscribe buyer</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/new-user-sign-up.html" target="_blank">New user sign up</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-Comment-admin.html" target="_blank">Order Comment Admin</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-comment-buyer.html" target="_blank">Order Comment Buyer</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-cancelled-admin.html" target="_blank">Order Cancelled Admin</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-cancelled-buyer.html" target="_blank">Order cancelled buyer</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-confirmation.html" target="_blank">Order confirmation</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-confirmation-email-2.html" target="_blank">Order confirmation email-2</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-confirmation-email-3.html" target="_blank">Order confirmation email-3</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-delivered-digital.html" target="_blank">Order delivered digital</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-delivered-physical.html" target="_blank">Order delivered physical</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-ready-digital.html" target="_blank">Order ready digital</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-ready-physical.html" target="_blank">Order ready physical</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-shipped-digital.html" target="_blank">Order shipped digital</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-shipped-physical.html" target="_blank">Order shipped physical</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/order-shipping-email.html" target="_blank">Order shipping email</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/payment-failed-payment-link.html" target="_blank">Payment failed payment link</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/pending-cart-buyer.html" target="_blank">Pending cart buyer</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/return-requested-admin.html" target="_blank">Return requested admin</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/return-requested-buyer.html" target="_blank">Return requested buyer</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/return-requested-buyer-approved.html" target="_blank">Return requested buyer
                                                                approved</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/return-requested-buyer-declined.html" target="_blank">Return requested buyer
                                                                declined</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/return-requested-buyer-item-recived.html" target="_blank">Return requested buyer item
                                                                recived</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/rewards-earned-on-birthday.html" target="_blank">Rewards earned on birthday</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/rewards-earned-on-order.html" target="_blank">Rewards earned on order</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/rewards-earned-on-social-sharing.html" target="_blank">Rewards earned on social
                                                                sharing</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/rewards-share-earn.html" target="_blank">Rewards share & earn</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/rewards-expired.html" target="_blank">Rewards expired</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/rewards-spent-on-order.html" target="_blank">Rewards spent on order</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/sub-admin-welcome.html" target="_blank">Sub admin welcome</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/test-email.html" target="_blank">Test email</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/threshold-notification-admin.html" target="_blank">Threshold notification admin</a>
                                                        </li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/to-do-assigned.html" target="_blank">To do assigned</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/to-do-reminder.html" target="_blank">To do reminder</a></li>
                                                        <li class=""><a href="<?php echo BASE_URL ?>manager/design/email/welcome-email.html" target="_blank">Welcome email</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <a href="">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="email-template-settings.php" target="_blank">Email temaplate - Settings</a>
                                                        </li>
                                                        <li><a href="email-template-listing.php" target="_blank">Email temaplate - listing</a>
                                                        </li>
    ...
    <script>
        $('.d-toggle-js').on("click", function() {
            $(this).toggleClass('is-active');
            $('.demo').toggleClass('is-visible');
        });
    </script>
