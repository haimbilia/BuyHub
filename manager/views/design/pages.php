                            ...
                            <div class="restore">
                                <div class="restore-icon">
                                    <div class="icon">
                                        <svg class="svg">
                                            <use
                                                xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#d-restore">
                                            </use>
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <li class="list-item">
                                    <a href="javascript:0;">
                                        <span class="icon">
                                            <svg class="svg">
                                                <use
                                                    xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#d-about">
                                                </use>
                                            </svg>
                                        </span>
                                        <span class="label">
                                ...
                                <li class="list-item">
                                    <a href="javascript:0;">
                                        <span class="icon">
                                            <svg class="svg">
                                                <use
                                                    xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#d-mobile">
                                                </use>
                                            </svg>
                                        </span>
                                        <span class="label">
                                ...
                                <li class="list-item">
                                    <a href="javascript:0;">
                                        <span class="icon">
                                            <svg class="svg">
                                                <use
                                                    xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#d-desktop">
                                                </use>
                                            </svg>
                                        </span>
                                        <span class="label">
                                ...
                                <li class="list-item">
                                    <a href="javascript:0;">
                                        <span class="icon">
                                            <svg class="svg">
                                                <use
                                                    xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#d-admin">
                                                </use>
                                            </svg>
                                        </span>
                                        <span class="label">
                                ...
                                <li class="list-item">
                                    <a href="javascript:0;">
                                        <span class="icon">
                                            <svg class="svg">
                                                <use
                                                    xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#d-marketplace">
                                                </use>
                                            </svg>
                                        </span>
                                        <span class="label">
                                ...
                                <li class="list-item">
                                    <a href="javascript:0;">
                                        <span class="icon">
                                            <svg class="svg">
                                                <use
                                                    xlink:href="<?php echo CONF_WEBROOT_URL; ?>images/retina/sprite.svg#d-request">
                                                </use>
                                            </svg>
                                        </span>
                                        <span class="label">
