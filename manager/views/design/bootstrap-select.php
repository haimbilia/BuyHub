                                ...
                                <div class="alert alert-light alert-elevate fade show" role="alert">
                                    ...
                                    <div class="alert-text">
                                        ...
                                        For more info please visit the plugin's <a class="link font-bold"
                                            ...
                                            target="_blank">Demo Page</a> or <a class="link font-bold"
                                            href="https://github.com/snapappointments/bootstrap-select"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            ...
                                            <span class="form-text text-muted">Add key words to options to improve their
                                                searchability using <code>data-tokens</code></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Limited Selection</label>
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <select class="form-control form-control--fixed selectpicker" multiple=""
                                                data-max-options="2" data-width="200" tabindex="-98">
                                                <option>Mustard</option>
                                                <option>Ketchup</option>
                                                <option>Relish</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <select class="form-control selectpicker"
                                                title="Choose one of the following..." tabindex="-98">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <select class="form-control selectpicker" multiple=""
                                                ...
                                                <option title="Combo 3" selected="">Sugar, Spice and all things nice
                                                </option>
                                            </select>
                                            <div class="space-10"></div>
                                            <select class="form-control selectpicker" multiple=""
                                                data-selected-text-format="count > 3" tabindex="-98">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class="dropdown bootstrap-select form-control "><select
                                                    class="form-control selectpicker" title="" tabindex="-98">
                                                    ...
                                                    data-toggle="dropdown" role="button" title="Mustard">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class="dropdown bootstrap-select form-control "><select
                                                    class="form-control selectpicker" data-width="" title="Auto"
                                                    tabindex="-98">
                                                    <option class="bs-title-option" value=""></option>
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    ...
                                                    data-toggle="dropdown" role="button" title="Auto">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                            ...
                                            <div class="space-10"></div>
                                            <div class="dropdown bootstrap-select form-control " style="width: 200px;">
                                                <select class="form-control selectpicker" data-width="200px"
                                                    title="Fixed: 200px" tabindex="-98">
                                                    <option class="bs-title-option" value=""></option>
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    <option>Relish</option>
                                                    ...
                                                    class="btn dropdown-toggle bs-placeholder btn-light"
                                                    data-toggle="dropdown" role="button" title="Fixed: 200px">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                            ...
                                            <div class="space-10"></div>
                                            <div class="dropdown bootstrap-select form-control " style="width: 75%;">
                                                <select class="form-control selectpicker" data-width="75%"
                                                    title="Fixed: 75%" tabindex="-98">
                                                    <option class="bs-title-option" value=""></option>
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    <option>Relish</option>
                                                    ...
                                                    class="btn dropdown-toggle bs-placeholder btn-light"
                                                    data-toggle="dropdown" role="button" title="Fixed: 75%">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class="dropdown bootstrap-select form-control "><select
                                                    ...
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                                            <div class="filter-option-inner-inner"><i
                                                                    class=" la la-bullhorn"></i> Mustard</div>
                                                        </div>
                                                    </div>
                                                </button>
                                                <div class="dropdown-menu " role="combobox">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Select/deselect all
                                            options</label>
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class="dropdown bootstrap-select show-tick form-control "><select
                                                    ...
                                                    class="btn dropdown-toggle bs-placeholder btn-light"
                                                    data-toggle="dropdown" role="button" title="Nothing selected">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class="dropdown bootstrap-select form-control "><select
                                                    class="form-control selectpicker" data-header="Select an option"
                                                    tabindex="-98">
                                                    <option data-subtext="French's">Mustard</option>
                                                    <option data-subtext="Heinz">Ketchup</option>
                                                    <option data-subtext="Sweet">Relish</option>
                                                ...
                                                <div class="dropdown-menu " role="combobox">
                                                    <div class="popover-header"><button type="button" class="close"
                                                            aria-hidden="true">×</button>Select an option</div>
                                                    <div class="inner show" role="listbox" aria-expanded="false"
                                                        tabindex="-1">
                                                        <ul class="dropdown-menu inner show"></ul>
                                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class="dropdown bootstrap-select disabled form-control "><select
                                                    class="form-control selectpicker" disabled="" tabindex="-98">
                                                    <option data-subtext="French's">Mustard</option>
                                                    <option data-subtext="Heinz">Ketchup</option>
                                                    <option data-subtext="Sweet">Relish</option>
                                                </select><button type="button"
                                                    class="btn dropdown-toggle disabled btn-light"
                                                    data-toggle="dropdown" role="button" tabindex="-1"
                                                    aria-disabled="true" title="Mustard">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                                            <div class="filter-option-inner-inner">Mustard</div>
                                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <div class="dropdown bootstrap-select form-control  dropup"><select
                                                    class="form-control selectpicker" title="Success"
                                                    data-style="btn-success" tabindex="-98">
                                                    <option class="bs-title-option" value=""></option>
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    <option>Relish</option>
                                                </select><button type="button"
                                                    class="btn dropdown-toggle bs-placeholder btn-success"
                                                    data-toggle="dropdown" role="button" title="Success"
                                                    aria-expanded="false">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                                ...
                                                <div class="dropdown-menu" role="combobox"
                                                    style="max-height: 1883.95px; overflow: hidden; min-height: 0px; position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, -3px, 0px);"
                                                    x-placement="top-start">
                                                    <div class="inner show" role="listbox" aria-expanded="false"
                                                        tabindex="-1"
                                                        style="max-height: 1857.95px; overflow-y: auto; min-height: 0px;">
                                                        <ul class="dropdown-menu inner show">
                                                            <li><a role="option" class="dropdown-item"
                                                                    aria-disabled="false" tabindex="0"
                                                                    aria-selected="false"><span
                                                                        class="text">Mustard</span></a></li>
                                                            <li><a role="option" class="dropdown-item"
                                                                    aria-disabled="false" tabindex="0"
                                                                    aria-selected="false"><span
                                                                        class="text">Ketchup</span></a></li>
                                                            <li><a role="option" class="dropdown-item"
                                                                    aria-disabled="false" tabindex="0"
                                                                    aria-selected="false"><span
                                                                        class="text">Relish</span></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="space-10"></div>
                                            <div class="dropdown bootstrap-select form-control "><select
                                                    class="form-control selectpicker" title="Warning"
                                                    data-style="btn-warning" tabindex="-98">
                                                    <option class="bs-title-option" value=""></option>
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    <option>Relish</option>
                                                </select><button type="button"
                                                    class="btn dropdown-toggle bs-placeholder btn-warning"
                                                    data-toggle="dropdown" role="button" title="Warning">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                            ...
                                            <div class="space-10"></div>
                                            <div class="dropdown bootstrap-select form-control "><select
                                                    class="form-control selectpicker" title="Danger"
                                                    data-style="btn-danger" tabindex="-98">
                                                    <option class="bs-title-option" value=""></option>
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    <option>Relish</option>
                                                    ...
                                                    data-toggle="dropdown" role="button" title="Danger">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                            ...
                                            <div class="space-10"></div>
                                            <div class="dropdown bootstrap-select form-control "><select
                                                    class="form-control selectpicker" title="Brand"
                                                    data-style="btn-brand" tabindex="-98">
                                                    <option class="bs-title-option" value=""></option>
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    <option>Relish</option>
                                                </select><button type="button"
                                                    class="btn dropdown-toggle bs-placeholder btn-brand"
                                                    data-toggle="dropdown" role="button" title="Brand">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                            ...
                                            <div class="space-10"></div>
                                            <div class="dropdown bootstrap-select form-control "><select
                                                    class="form-control selectpicker" title="Primary"
                                                    data-style="btn-primary" tabindex="-98">
                                                    <option class="bs-title-option" value=""></option>
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    <option>Relish</option>
                                                </select><button type="button"
                                                    class="btn dropdown-toggle bs-placeholder btn-primary"
                                                    data-toggle="dropdown" role="button" title="Primary">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12">
                                            <a href="" class="btn btn-success btn btn--pill" data-toggle="modal"
                                                data-target="#select_modal">Launch modal examples</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-foot">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form class="form form--label-right">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-form-label col-lg-3 col-sm-12">Optgroups
                                                    Example</label>
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="dropdown bootstrap-select form-control "><select
                                                            class="form-control selectpicker" tabindex="-98">
                                                    ...
                                                    <span class="form-text text-muted">Select boxes with
                                                        optgroups</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row margin-b-20">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="dropdown bootstrap-select form-control "><select
                                                            ...
                                                            class="btn dropdown-toggle btn-light" data-toggle="dropdown"
                                                            role="button" title="Hot Dog, Fries and a Soda">
                                                            <div class="filter-option">
                                                                <div class="filter-option-inner">
                                                                    <div class="filter-option-inner-inner">Hot Dog,
                                                                        Fries and a Soda</div>
                                                                </div>
                                                            </div>
                                                        </button>
                                                        <div class="dropdown-menu " role="combobox">
                                                    ...
                                                    <span class="form-text text-muted">You can add a search input by
                                                        passing <code>data-live-search="true"</code> attribute</span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12 validate">
                                            <div class="dropdown bootstrap-select form-control is-valid "><select
                                                    class="form-control is-valid selectpicker" tabindex="-98">
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    <option>Relish</option>
                                                </select><button type="button" class="btn dropdown-toggle btn-light"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-12 validate">
                                            <div class="dropdown bootstrap-select form-control is-invalid "><select
                                                    class="form-control is-invalid selectpicker" tabindex="-98">
                                                    <option>Mustard</option>
                                                    <option>Ketchup</option>
                                                    <option>Relish</option>
                                                </select><button type="button" class="btn dropdown-toggle btn-light"
                                            ...
                                            <div class="invalid-feedback">Shucks, check the formatting of that and try
                                                again.</div>
                                            <span class="form-text text-muted">Example help text that remains
                                                unchanged.</span>
                                        </div>
