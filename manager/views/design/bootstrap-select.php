                        ...
                        <form class="form form--label-right">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        ...
                                        <div class="dropdown bootstrap-select form-control " style="width: 200px;">
                                            <select class="form-control selectpicker" data-width="200px" title="Fixed: 200px" tabindex="-98">
                                                <option class="bs-title-option" value=""></option>
                                                <option>Mustard</option>
                                                <option>Ketchup</option>
                                                <option>Relish</option>
                                        ...
                                        <div class="dropdown bootstrap-select form-control " style="width: 75%;">
                                            <select class="form-control selectpicker" data-width="75%" title="Fixed: 75%" tabindex="-98">
                                                <option class="bs-title-option" value=""></option>
                                                <option>Mustard</option>
                                                <option>Ketchup</option>
                                                <option>Relish</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <div class="dropdown bootstrap-select form-control "><select class="form-control selectpicker" tabindex="-98">
                                                <option data-content="<span class='badge badge-success badge-inline badge-rounded'>Relish</span>">
                                                    Mustard</option>
                                                <option data-content="<span class='badge badge-warning badge-inline badge-rounded'>Ketchup</span>">
                                                    Ketchup</option>
                                                <option data-content="<span class='badge badge-brand badge-inline badge-rounded'>Relish</span>">
                                                    Relish</option>
                                        ...
                                        <div class="dropdown bootstrap-select show-tick form-control "><select class="form-control selectpicker" multiple="" data-actions-box="true" tabindex="-98">
                                            ...
                                            <div class="dropdown-menu " role="combobox">
                                                <div class="bs-actionsbox">
                                                    <div class="btn-group btn-group-sm btn-block"><button type="button" class="actions-btn bs-select-all btn btn-light">Select
                                                            All</button><button type="button" class="actions-btn bs-deselect-all btn btn-light">Deselect
                                                            All</button></div>
                                                </div>
                                                <div class="inner show" role="listbox" aria-expanded="false" tabindex="-1">
                                                    <ul class="dropdown-menu inner show"></ul>
