        ...
        <div class="body " id="body">
            <div class="content " id="content">
                ...
                <div class="container">
                        ...
                        <div class="col">
                            <div class="alert alert-light alert-elevate fade show" role="alert">
                                ...
                                <div class="alert-text">
                                    ...
                                    <br>
                                    For more info please visit the plugin's <a class="link font-bold" href="http://www.daterangepicker.com/" target="_blank">Demo Page</a> or <a class="link font-bold" href="https://github.com/dangrossman/daterangepicker" target="_blank">Github Repo</a>.
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <input type="text" class="form-control" id="daterangepicker_1" readonly="" placeholder="Select time">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <div class="input-icon pull-right" id="daterangepicker_3">
                                            ...
                                            <span class="input-icon__icon input-icon__icon--right"><span><i class="la la-calendar-check-o"></i></span></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <a href="" class="btn btn-label-brand" data-bs-toggle="modal" data-bs-target="#daterangepicker_modal">Launch modal Date Range Pickers</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-foot">
                    ...
                    <!--begin::Modal-->
                    <div class="modal fade" id="daterangepicker_modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group row margin-t-20">
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <input type="text" class="form-control" id="daterangepicker_1_modal" readonly="" placeholder="Select time">
                                            </div>
                                        </div>
                                        <div class="form-group row">
