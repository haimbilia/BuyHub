...
?>
            <div class="body " id="body">
                <div class="content " id="content">
                    ...
                    <!-- begin:: Content -->
                    <div class="container">
                        <div class="wizard-v4" id="wizard_v4" data-FATbitwizard-state="first">
                            <!--begin: Form Wizard Nav -->
                            <div class="wizard-v4__nav">
                                <div class="wizard-v4__nav-items">
                                    <!--doc: Replace A tag with SPAN tag to disable the step link click -->
                                    <div class="wizard-v4__nav-item" data-FATbitwizard-type="step"
                                        ...
                                        <div class="wizard-v4__nav-body" data-toggle="tab" href="#form-step-1">
                                            ...
                                            <div class="wizard-v4__nav-label">
                                                <div class="wizard-v4__nav-label-title">
                                                    Add Account
                                                </div>
                                                <div class="wizard-v4__nav-label-desc">
                            ...
                            <div class="card">
                                <div class="card-body card__body--fit">
                                    <div class="grid">
                                        <div class="grid__item grid__item--fluid wizard-v4__wrapper">
                                            <!--begin: Form Wizard Form-->
                                            <form class="form" id="form" novalidate="novalidate">
                                                <!-- begin TAB CONTENT -->
                                                <div class="tab-content">
                                                    <!-- begin form step-1 -->
                                                    <div class="tab-pane active" id="form-step-1">
                                                        <!--begin: Form Wizard Step 1-->
                                                        <div class="wizard-v4__content"
                                                            data-FATbitwizard-type="step-content"
                                                            data-FATbitwizard-state="current">
                                                            <div class="heading heading--md">Enter your Account Details
                                                            </div>
                                                            <div class="form__section form__section--first">
                                                                <div class="wizard-v4__form">
                                                    ...
                                                    <!-- begin form step-2 -->
                                                    <div class="tab-pane" id="form-step-2">
                                                    ...
                                                    <!-- begin form step-3 -->
                                                    <div class="tab-pane" id="form-step-3">
                                                        <!--begin: Form Wizard Step 3-->
                                                        <div class="wizard-v4__content"
                                                            data-FATbitwizard-type="step-content">
                                                            <div class="heading heading--md">Enter your Payment Details
                                                            </div>
                                                            <div class="form__section form__section--first">
                                                                <div class="wizard-v4__form">
                                                                    <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-xl-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number"
                                                                                    class="form-control" name="ccmonth"
                                                                                    placeholder="Card Expiry Month"
                                                                                    value="01">
                                                                                <span
                                                                                    class="form-text text-muted">Please
                                                                                    enter your Card Expiry Month.</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xl-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number"
                                                                                    class="form-control" name="ccyear"
                                                                                    placeholder="Card Expire Year"
                                                                                    value="21">
                                                                                <span
                                                                                    class="form-text text-muted">Please
                                                                                    enter your Card Expiry Year.</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xl-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="password"
                                                                                    class="form-control" name="cccvv"
                                                                                    placeholder="Card CVV Number"
                                                                                    value="123">
                                                                                <span
                                                                                    class="form-text text-muted">Please
                                                                                    enter your Card CVV Number.</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <!-- begin form step-4 -->
                                                    <div class="tab-pane" id="form-step-4">
                                                        <!--begin: Form Wizard Step 4-->
                                                        <div class="wizard-v4__content"
                                                            data-FATbitwizard-type="step-content">
                                                            <div class="heading heading--md">Review your Details and
                                                                Submit</div>
                                                            <div class="form__section form__section--first">
                                                                <div class="wizard-v4__review">
                                                                    <div class="wizard-v4__review-item">
                                                                        <div class="wizard-v4__review-title">
                                                                            Your Account Details
                                                                        </div>
                                                                        <div class="wizard-v4__review-content">
                                                                            John Wick<br>
