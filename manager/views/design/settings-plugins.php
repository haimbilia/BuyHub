                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="label">
                                                                    ...
                                                                    <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-original-title="This Is The
                                                ...
                                                <div class="form-section-body">
                                                    <div class="row form-group">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="">
                                                                <select data-field-caption="Default Child Order Status" name="CONF_DEFAULT_ORDER_STATUS">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div>
                                                                ...
                                                                <select data-field-caption="Default Paid Order Status" name="CONF_DEFAULT_PAID_ORDER_STATUS">
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-6">
                                                            <label class="label">Default Approved
                                                                ...
                                                                Status</label>
                                                            <div>
                                                                <select data-field-caption="Default Approved Order Status" name="CONF_DEFAULT_APPROVED_ORDER_STATUS">
                                                                    <option value="1">Payment Pending
                                                                    </option>
                                                                    <option value="16">cash on delivery
                                                                    </option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="label">Status Used By
                                                                ...
                                                                Completed</label>
                                                            <div>
                                                                <select data-field-caption="Status Used By System To Mark Order As Completed" name="CONF_DEFAULT_COMPLETED_ORDER_STATUS">
                                                                    <option value="1" selected="selected">Payment
                                                                        Pending</option>
                                                                    <option value="16">cash on delivery
                                                                    </option>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Default Delivered Order
                                                                        Status</label></div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><select data-field-caption="Default Delivered Order Status" name="CONF_DEFAULT_DEIVERED_ORDER_STATUS">
                                                                            <option value="1">Payment Pending
                                                                            </option>
                                                                            <option value="16">cash on delivery
                                                                            </option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Default Cancelled Order
                                                                        Status</label></div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><select data-field-caption="Default Cancelled Order Status" name="CONF_DEFAULT_CANCEL_ORDER_STATUS">
                                                                            <option value="1">Payment Pending
                                                                            </option>
                                                                            <option value="16">cash on delivery
                                                                            </option>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Return Requested Order
                                                                        Status</label></div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><select data-field-caption="Return Requested Order Status" name="CONF_RETURN_REQUEST_ORDER_STATUS">
                                                                            <option value="1">Payment Pending
                                                                            </option>
                                                                            <option value="16">cash on delivery
                                                                            </option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Return Request Withdrawn
                                                                        Order Status</label></div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><select data-field-caption="Return Request Withdrawn Order Status" name="CONF_RETURN_REQUEST_WITHDRAWN_ORDER_STATUS">
                                                                            <option value="1">Payment Pending
                                                                            </option>
                                                                            <option value="16">cash on delivery
                                                                            </option>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Return Request Approved
                                                                        Order Status</label></div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><select data-field-caption="Return Request Approved Order Status" name="CONF_RETURN_REQUEST_APPROVED_ORDER_STATUS">
                                                                            <option value="1">Payment Pending
                                                                            </option>
                                                                            <option value="16">cash on delivery
                                                                            </option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Pay
                                                                        ...
                                                                        Status</label></div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><select data-field-caption="Pay At Store Order Status" name="CONF_PAY_AT_STORE_ORDER_STATUS">
                                                                            <option value="1">Payment Pending
                                                                            </option>
                                                                            <option value="16">cash on delivery
                                                                            </option>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Cash On Delivery Order
                                                                        Status</label></div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><select data-field-caption="Cash On Delivery Order Status" name="CONF_COD_ORDER_STATUS">
                                                                            <option value="1">Payment Pending
                                                                            </option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Ready For Pickup Order
                                                                        Status</label></div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><select data-field-caption="Ready For Pickup Order Status" name="CONF_PICKUP_READY_ORDER_STATUS">
                                                                            <option value="1">Payment Pending
                                                                            </option>
                                                                            <option value="16">cash on delivery
                                                                            </option>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Status Used By System To
                                                                        Mark Order As Completed</label></div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><select data-field-caption="Status Used By System To Mark Order As Completed" name="CONF_DEFAULT_COMPLETED_ORDER_STATUS">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="field-set">
                                                                <div class="caption-wraper"><label class="label">Default Return Age
                                                                        [days]<span class="spn_must_field">*</span></label>
                                                                </div>
                                                                <div class="field-wraper">
                                                                    <div class="field_cover"><input data-field-caption="Default Return Age [days]" data-fatreq="{&quot;required&quot;:true,&quot;integer&quot;:true}" type="text" name="CONF_DEFAULT_RETURN_AGE" value="7"><small>It Will Considered If
