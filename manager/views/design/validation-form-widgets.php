                ...
                <div id="subheader" class="subheader">
                    <div class="container ">
                        <div class="subheader__main">
                            <h3 class="subheader__title">Form Widgets</h3>
                            ...
                            <div class="card-body">
                                <div class="form__content">
                                    <div class="alert m-alert--icon alert alert-danger hidden" role="alert" id="form_1_msg">
                                        ...
                                        <div class="alert__close">
                                            <button type="button" class="btn-close" data-close="alert" aria-label="Close">
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <div class="dropdown bootstrap-select show-tick form-control bootstrap-select"><select class="form-control bootstrap-select" id="bootstrap_select" multiple="" name="select" tabindex="-98">
                                            ...
                                            </select><button type="button" class="btn dropdown-toggle bs-placeholder btn-light" data-bs-toggle="dropdown" role="button" data-id="bootstrap_select" title="Nothing selected">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        ...
                                        </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="1" style="width: 409.983px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-select2-container"><span class="select2-selection__rendered" id="select2-select2-container" role="textbox" aria-readonly="true"><span class="select2-selection__placeholder">Select a state</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-9 col-sm-12">
                                        <div class="typeahead">
                                            <span class="twitter-typeahead" style="position: relative; display: inline-block;"><input class="form-control tt-hint" type="text" style="position: absolute; top: 0px; left: 0px; border-color: transparent; box-shadow: none; opacity: 1; background: rgb(255, 255, 255) none repeat scroll 0% 0% padding-box;" readonly="" autocomplete="off" spellcheck="false" tabindex="-1" dir="ltr"><input class="form-control tt-input" id="typeahead" type="text" name="typeahead" placeholder="States of USA" autocomplete="off" spellcheck="false" dir="auto" style="position: relative; vertical-align: top; background-color: transparent;">
                                                <pre aria-hidden="true" style="position: absolute; visibility: hidden; white-space: pre; font-family: Poppins; font-size: 13px; font-style: normal; font-variant: normal; font-weight: 400; word-spacing: 0px; letter-spacing: 0px; text-indent: 0px; text-rendering: optimizelegibility; text-transform: none;"></pre>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-12">
                                        <div class="md-editor" id="1565261630580">
                                            <div class="md-header btn-toolbar">
                                                ...
                                                <div class="btn-group"><button class="btn-sm btn btn-primary" type="button" title="Preview" tabindex="-1" data-provider="bootstrap-markdown" data-handler="bootstrap-markdown-cmdPreview" data-hotkey="Ctrl+P" data-bs-toggle="button"><span class="fa fa-search"></span> Preview</button></div>
