			...
			<div class="content " id="content">
				...
				<div id="subheader" class="subheader" >
					<div class="container ">
						<div class="subheader__main">
							<h3 class="subheader__title">Sticky Action Bar</h3>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<!--begin::card-->
							<div class="card card--last card--head-lg card--responsive-mobile" id="page_card">
								<div class="card-head card-head--lg" style="">
									<div class="card-head-label">
										<h3 class="card-head-title">Sticky Form Actions <small>try to scroll the page</small></h3>
									</div>
									<div class="card-head-toolbar">
										<a href="#" class="btn btn-clean margin-r-10">
												...
												<ul class="nav">
													<li class="nav__item">
														<a href="#" class="nav__link">
															<i class="nav__link-icon flaticon2-reload"></i>
															<span class="nav__link-text">Save &amp; continue</span>
														</a>
													</li>
													<li class="nav__item">
														<a href="#" class="nav__link">
															<i class="nav__link-icon flaticon2-power"></i>
															<span class="nav__link-text">Save &amp; exit</span>
														</a>
													</li>
													<li class="nav__item">
														<a href="#" class="nav__link">
															<i class="nav__link-icon flaticon2-edit-interface-symbol-of-pencil-tool"></i>
															<span class="nav__link-text">Save &amp; edit</span>
														</a>
													</li>
													<li class="nav__item">
														<a href="#" class="nav__link">
															<i class="nav__link-icon flaticon2-add-1"></i>
											...
											<div class="col-xl-8">
												<div class="section section--first">
													<div class="section__body">
														<h3 class="section__title section__title-lg">Customer Info:</h3>
												...
												<div class="section">
													<div class="section__body">
														<h3 class="section__title section__title-lg">Address Details:</h3>
														<div class="form-group row">
												...
												<div class="section">
													<div class="section__body">
														<h3 class="section__title section__title-lg">Account:</h3>
														<div class="form-group row">
												...
												<div class="section section--last">
													<div class="section__body">
														<h3 class="section__title section__title-lg">Security:</h3>
														<div class="form-group row">
															<label class="col-3 col-form-label">Login verification</label>
															<div class="col-9">
																<button type="button" class="btn btn-outline-primary btn-sm margin-t-5 margin-b-5">Setup login verification</button>
														...
														<div class="form-group row margin-t-10 margin-b-10">
															<label class="col-3 col-form-label"></label>
															<div class="col-9">
																<button type="button" class="btn btn-outline-danger btn-sm margin-t-5 margin-b-5">Deactivate your account ?</button>
															</div>
														</div>
													</div>
												</div>
