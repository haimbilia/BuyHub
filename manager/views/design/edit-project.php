                                            ...
                                            <div class="widget__details">
                                                <div class="section__content section__content--solid">
                                                    <div class="media-group">
                                                        ...
                                                        <a href="#" class="media media--sm media--circle"
                                                            data-toggle="tooltip" data-skin="brand" data-placement="top"
                                                            title="" data-original-title="Alison Brandy">
                                                            <img src="<?php echo CONF_WEBROOT_URL;?>images/users/100_10.jpg"
                                                                alt="image">
                                                        </a>
                                                        <a href="#" class="media media--sm media--circle"
                                                            data-toggle="tooltip" data-skin="brand" data-placement="top"
                                                            title="" data-original-title="Selina Cranson">
                                                            <img src="<?php echo CONF_WEBROOT_URL;?>images/users/100_11.jpg"
                                                                alt="image">
                                                        </a>
                                                        <a href="#" class="media media--sm media--circle"
                                                            data-toggle="tooltip" data-skin="brand" data-placement="top"
                                                            title="" data-original-title="Micheal York">
                        ...
                        <div class="card card--tabs">
                            <div class="card-head">
                                <div class="card-head-toolbar">
                                    <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand"
                                        role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#YK_contacts_view_tab_1"
                                                role="tab">
                                                <i class="flaticon2-calendar-3"></i> Personal
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " data-toggle="tab" href="#YK_contacts_view_tab_2"
                                                role="tab">
                                                <i class="flaticon2-user-outline-symbol"></i> Access Control
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#YK_contacts_view_tab_3"
                                                role="tab">
                                                <i class="flaticon2-gear"></i> Settings
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " data-toggle="tab" href="#YK_contacts_view_tab_4"
                                                role="tab">
                            ...
                            <div class="card-body">
                                <div class="tab-content  margin-t-20">
                                    <!--Begin:: Tab Content-->
                                    <div class="tab-pane active" id="YK_contacts_view_tab_1" role="tabpanel">
                                                    ...
                                                    <div class="section__body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <h3 class="section__title section__title-sm">Personal
                                                                    Info:</h3>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-lg-3 col-form-label">Customer
                                                                Name</label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <input class="form-control" type="text"
                                                                    value="Loop Inc.">
                                                                <span class="form-text text-muted">If you want your
                                                                    invoices addressed to a company. Leave blank to use
                                                                    your full name.</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <label class="col-xl-3"></label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <h3 class="section__title section__title-sm">Contact
                                                                    Info:</h3>
                                                            </div>
                                                        </div>
                                    ...
                                    <!--Begin:: Tab Content-->
                                    <div class="tab-pane" id="YK_contacts_view_tab_2" role="tabpanel">
                                                ...
                                                <div class="section">
                                                    <div class="section__body">
                                                        <div class="row">
                                                            <label class="col-xl-3"></label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <h3 class="section__title section__title-sm">Account:
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                ...
                                                                <span class="form-text text-muted">Email will not be
                                                                    publicly displayed. <a href="#" class="link">Learn
                                                                        more</a>.</span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <select class="form-control">
                                                                    ...
                                                                    <option data-offset="-21600"
                                                                        value="Central America">(GMT-06:00) Central
                                                                        America</option>
                                                                    ...
                                                                    <option data-offset="3600"
                                                                        value="West Central Africa">(GMT+01:00) West
                                                                    ...
                                                                    <option data-offset="19800"
                                                                        value="Sri Jayawardenepura">(GMT+05:30) Sri
                                                ...
                                                <div class="section section--first">
                                                    <div class="section__body">
                                                        <div class="row">
                                                            <label class="col-xl-3"></label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <h3 class="section__title section__title-sm">Security:
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                    ...
                                    <!--Begin:: Tab Content-->
                                    <div class="tab-pane" id="YK_contacts_view_tab_3" role="tabpanel">
                                        <form class="form form--label-right">
                                            <div class="form__body">
                                                <div class="section section--first">
                                                    <div class="section__body">
                                                        <div class="row">
                                                            <label class="col-xl-3"></label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <h3 class="section__title section__title-sm">Setup Email
                                                                    Notification:</h3>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="section section--first">
                                                    <div class="section__body">
                                                        <div class="row">
                                                            <label class="col-xl-3"></label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <h3 class="section__title section__title-sm">Activity
                                                                    Related Emails:</h3>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                ...
                                                <div class="section section--first">
                                                    <div class="section__body">
                                                        <div class="row">
                                                            <label class="col-xl-3"></label>
                                                            <div class="col-lg-9 col-xl-6">
                                                                <h3 class="section__title section__title-sm">Updates
                                                                    From Yokart:</h3>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                    ...
                                    <!--Begin:: Tab Content-->
                                    <div class="tab-pane " id="YK_contacts_view_tab_4" role="tabpanel">
                                        <div class="container">
                                            <form>
                                            ...
                                            <div class="notes scroll scroll--pull ps" data-scroll="true"
                                                ...
                                                <div class="notes__items">
                                                    ...
                                                    <div class="notes__item notes__item--clean">
                                                        ...
                                                        <div class="notes__content">
                                                            ...
                                                            <span class="notes__body">
                                                                Sed ut sit voluptatem accusantium doloremque laudantium,
