				...
				<div class="container  grid__item grid__item--fluid">
					<div class="card">
						<div class="card-body card__body--fit">
							<div class="grid wizard-v1 wizard-v1--white" id="wizard_v1" data-FATbitwizard-state="first">
								<div class="grid__item">
									<!--begin: Form Wizard Nav -->
									<div class="wizard-v1__nav">
										<div class="wizard-v1__nav-items">
											<!--doc: Replace A tag with SPAN tag to disable the step link click -->
											<div class="wizard-v1__nav-item" data-FATbitwizard-type="step" data-FATbitwizard-state="current">
												<div class="wizard-v1__nav-body" data-toggle="tab" href="#form_step_1">
											...
											<div class="wizard-v1__nav-item" data-FATbitwizard-type="step" data-FATbitwizard-state="pending">
												<div class="wizard-v1__nav-body" data-toggle="tab" href="#form_step_2">
													<div class="wizard-v1__nav-icon">
											...
											<div class="wizard-v1__nav-item" data-FATbitwizard-type="step" data-FATbitwizard-state="pending">
												<div class="wizard-v1__nav-body" data-toggle="tab" href="#form_step_3">
													<div class="wizard-v1__nav-icon">
											...
											<div class="wizard-v1__nav-item" data-FATbitwizard-type="step" data-FATbitwizard-state="pending">
												<div class="wizard-v1__nav-body" data-toggle="tab" href="#form_step_4">
													<div class="wizard-v1__nav-icon">
											...
											<div class="wizard-v1__nav-item" data-FATbitwizard-type="step" data-FATbitwizard-state="pending">
												<div class="wizard-v1__nav-body" data-toggle="tab" href="#form_step_5">
													<div class="wizard-v1__nav-icon">
								...
								<div class="grid__item grid__item--fluid wizard-v1__wrapper">
									...
									<form class="form" id="form" novalidate="novalidate">
										...
										<!--begin: Tab Step-1 -->
										<div class="tab-pane active" id="form_step_1">
										<!--begin: Form Wizard Step 1-->
										<div class="wizard-v1__content" data-FATbitwizard-type="step-content" data-FATbitwizard-state="current">
											<div class="heading heading--md">Setup Your Current Location</div>
										...
										<!--begin: Tab Step-2 -->
										<div class="tab-pane" id="form_step_2">
										<!--begin: Form Wizard Step 2-->
										<div class="wizard-v1__content" data-FATbitwizard-type="step-content">
											<div class="heading heading--md">Enter the Details of your Delivery</div>
											<div class="form__section form__section--first">
												<div class="wizard-v1__form">
													<div class="form-group">
													...
													<div class="wizard-v1__form-label">Package Dimensions</div>
													<div class="row">
														<div class="col-xl-4">
															<div class="form-group">
										...
										<!--begin: Tab Step-3 -->
										<div class="tab-pane" id="form_step_3"><!--begin: Form Wizard Step 3-->
										<div class="wizard-v1__content" data-FATbitwizard-type="step-content">
											<div class="heading heading--md">Select your Services</div>
											<div class="form__section form__section--first">
												<div class="wizard-v1__form">
													<div class="form-group">
										...
										<!--begin: Tab Step-4 -->
										<div class="tab-pane" id="form_step_4">
										<!--begin: Form Wizard Step 4-->
										<div class="wizard-v1__content" data-FATbitwizard-type="step-content">
											<div class="heading heading--md">Setup Your Delivery Location</div>
											<div class="form__section form__section--first">
												<div class="wizard-v1__form">
													<div class="form-group">
														<label>Address Line 1</label>
										...
										<!--begin: Tab Step-5 -->
										<div class="tab-pane" id="form_step_5">
