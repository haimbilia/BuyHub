    ...
    public function truncateTables($type = 'orders')
    {
        ...
        if ($type == 'orders') {
            $tables = array('tbl_orders', 'tbl_orders_lang', 'tbl_orders_status_history', 'tbl_order_cancel_requests', 'tbl_order_extras', 'tbl_order_payments', 
                ...
                'tbl_order_prod_charges_logs','tbl_orders_to_plugin_order','tbl_order_product_shipment_pickup','tbl_order_product_plugin_specifics','tbl_order_product_responses',
                'tbl_order_prod_charges_logs_lang','tbl_order_prod_charges_logs','tbl_coupons_hold_pending_order','tbl_order_product_specifics'
                );
            ...
            $tables = array('tbl_abusive_words', 'tbl_admin_auth_token', 'tbl_admin_password_reset_requests', 'tbl_admin_permissions', 'tbl_affiliate_commission_setting_history',
                ...
                'tbl_order_user_address', 'tbl_orders', 'tbl_orders_lang', 'tbl_orders_status_history', 'tbl_policy_points', 'tbl_policy_points_lang',
                ...
                'tbl_tracking_courier_code_relation', 'tbl_time_slots', 'tbl_user_collections', 'tbl_addresses', 'tbl_order_product_shipment', 'tbl_order_prod_charges_logs',
