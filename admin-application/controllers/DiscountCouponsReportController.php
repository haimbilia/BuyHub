...
class DiscountCouponsReportController extends AdminBaseController
{
    ...
    public function search($type = false)
    {
        ...
        $srch->addMultipleFields(array('coupon_code', 'couponhistory_id', 'couponhistory_coupon_id', 'couponhistory_order_id', 'order_no as couponhistory_order_no', 'couponhistory_user_id', 'couponhistory_amount', 'couponhistory_added_on', 'credential_username'));
