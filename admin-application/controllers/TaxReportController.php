...
class TaxReportController extends AdminBaseController
{
    ...
    public function search($type = false)
    {
        ...
        $srch->addMultipleFields(array('op_shop_name', 'op.op_selprod_user_id', 'o.order_no', 'o.order_id', 'op.op_id', 'opcharge.opcharge_id', 'opcharge.opcharge_type', 'SUM(opcharge.opcharge_amount) as totTax', 'count(op.op_id) as totChildOrders', 'seller.user_name as owner_name', 'seller_cred.credential_email as owner_email',));
