...
class DiscountCouponsController extends AdminBaseController
{
    ...
    public function usesHistory($coupon_id)
    {
        ...
        $srch->addMultipleFields(array('couponhistory_id', 'couponhistory_coupon_id', 'couponhistory_order_id', 'order_number as couponhistory_order_no', 'couponhistory_user_id', 'couponhistory_amount', 'couponhistory_added_on', 'credential_username'));
