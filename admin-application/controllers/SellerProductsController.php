...
class SellerProductsController extends AdminBaseController
{
    ...
    public function searchThresholdLevelProducts()
    {
        ...
        /* $cnd = $srch->addCondition('earch_tpl_name', 'LIKE', 'threshold_notification_vendor_custom');
        $cnd->attachCondition('earch_tpl_name', 'LIKE', 'threshold_notification_vendor', 'OR'); */
