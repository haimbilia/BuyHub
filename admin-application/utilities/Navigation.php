...
class Navigation
{
    public static function setLeftNavigationVals($template)
    {
        ...
        $supReqSrchObj->addCondition('usuprequest_status', '=', 'mysql_func_' . applicationConstants::NO, 'AND', true);
        ...
        $catReqSrchObj->addCondition('scatrequest_status', '=', 'mysql_func_' . applicationConstants::NO, 'AND', true);
        ...
        $categoryReqSrchObj = ProductCategory::getSearchObject(false, 0, false, 'mysql_func_' . ProductCategory::REQUEST_PENDING, 'AND', true);
        ...
        $drReqSrchObj->addCondition('withdrawal_status', '=', 'mysql_func_' . applicationConstants::NO, 'AND', true);
        ...
        $orderRetReqSrchObj->addCondition('orrequest_status', '=', 'mysql_func_' . applicationConstants::NO, 'AND', true);
        ...
        $blogContrSrchObj->addCondition('bcontributions_status', '=', 'mysql_func_' . applicationConstants::NO, 'AND', true);
