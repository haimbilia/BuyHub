    ...
    foreach ($fields as $key => $val) {
        ...
        switch ($key) {
            case 'dragdrop':
                ...
                break;
            case 'select_all':
                $td->appendElement('plaintext', array(), '<label class="checkbox"><input class="selectItemJs" type="checkbox" name="scompany_ids[]" value=' . $row['scompany_id'] . '><i class="input-helper"></i></label>', true);
                break;
            case 'listSerial':
