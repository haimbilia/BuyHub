				  ...
				  <?php echo $shopBannerFrm->getFormHtml();?>
					...
					<div class="row">
						<div class="profile__pic">
							<img src="<?php echo UrlHelper::generateFileUrl('Image','shopBanner',array($img['afile_record_id'],$img['afile_lang_id'],'PREVIEW'));?>" alt="">
						</div>
			...
			<div class="col-md-6">
				<div class="preview">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="profile__pic"><img src="<?php echo UrlHelper::generateFileUrl('Image','shopLogo',array($img['afile_record_id'],$img['afile_lang_id'],'SMALL'));?>" alt=""></div>
							<small class="text--small"><?php echo $bannerTypeArr[$img['afile_lang_id']];?></small>
							<div class="btngroup--fix">
