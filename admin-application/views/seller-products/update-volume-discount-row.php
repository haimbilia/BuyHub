...
<tr id="row-<?php echo $volDiscountId; ?>">
    ...
    <td>
        <div class="js--editCol contenteditable"><?php echo $data['voldiscount_min_qty']; ?></div>
    ...
    <td>
        <div class="js--editCol contenteditable"><?php echo number_format((float)$data['voldiscount_percentage'], 2, '.', ''); ?></div>
