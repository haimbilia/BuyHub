                ...
                <div class="tabs_panel_wrap">
                    ...
                    <div class="row">
                        <div class="selprod_threshold_stock_level_fld col-md-6">
                            <div class="field-set">
                                <div class="caption-wraper"><label class="field_label"><?php echo $frmSellerProduct->getField('selprod_threshold_stock_level')->getCaption(); ?> <i class="fa fa-info-circle" data-bs-toggle="tooltip" data-placement="top" title="<?php echo Labels::getLabel('LBL_Alert_stock_level_hint_info', $adminLangId); ?>"></i></label></div>
                                <div class="field-wraper">
                            ...
                            <table id="shipping" class="table table-bordered mb-4">
                                <thead>
                                    <tr>
                                        ...
                                        ?>
                                        <th width="20%"><?php echo Labels::getLabel('LBL_Selling_Price', $adminLangId); ?> <i class="fa fa-info-circle" data-bs-toggle="tooltip" data-placement="top" title="<?php echo $selPriceTitle; ?>"></i></th>
                                        <th width="20%"><?php echo Labels::getLabel('LBL_Quantity', $adminLangId); ?></th>
                                        <th width="20%"><?php echo Labels::getLabel('LBL_SKU', $adminLangId); ?> <i class="fa fa-info-circle" data-bs-toggle="tooltip" data-placement="top" title="<?php echo Labels::getLabel('LBL_Stock_Keeping_Unit', $adminLangId) ?>"></i></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
