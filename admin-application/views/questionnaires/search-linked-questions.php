            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $li->appendElement('a', array(
                        'href' => "javascript:void(0)", 'class' => 'button small green', 'title' => Labels::getLabel('LBL_Remove', $adminLangId), "onclick" => "removeQuestion(" . $row['questionnaire_id'] . "," . $row['question_id'] . ")"
                    ), '<i class="ion-close-round icon"></i>', true);
                }
                break;
            default:
