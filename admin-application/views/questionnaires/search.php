            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $li->appendElement('a', array(
                        ...
                        "onclick" => "questionnaireForm(" . $row['questionnaire_id'] . ")"
                    ), '<i class="far fa-edit icon"></i>', true);
                    $li = $ul->appendElement("li");
                    $li->appendElement(
                        'a',
                        array('href' => UrlHelper::generateUrl('Questionnaires', 'questions', array($row['questionnaire_id'])), 'class' => 'button small green', 'title' => Labels::getLabel('LBL_Link_Questions', $adminLangId)),
                        '<i class="ion-levels icon"></i>',
                        true
                    );
                    $li = $ul->appendElement("li");
                    $li->appendElement(
