                ...
                if ($canEdit) {
                    ...
                    if (!$row['qtq_question_id']) {
                        $li->appendElement('a', array(
                            'href' => "javascript:void(0)", 'class' => 'button small green', 'title' => Labels::getLabel('LBL_Add', $adminLangId), "onclick" => "addQuestion(" . $questionnaire_id . "," . $row['question_id'] . ")"
                        ), '<i class="ion-ios-circle-filled icon"></i>', true);
                    } else {
