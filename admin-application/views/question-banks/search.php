            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $li->appendElement('a', array(
                        ...
                        "onclick" => "questionBankForm(" . $row['qbank_id'] . ")"
                    ), '<i class="far fa-edit icon"></i>', true);

                    $li = $ul->appendElement("li");
                    $li->appendElement(
                        'a',
                        array('href' => UrlHelper::generateUrl('Questions', 'index', array($row['qbank_id'])), 'class' => 'button small green', 'title' => Labels::getLabel('LBL_Questions', $adminLangId)),
