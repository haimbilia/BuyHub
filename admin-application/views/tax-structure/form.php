                                                ...
                                                <div class="field-set">
                                                    <div class="field-wraper">
                                                        <div class="field_cover d-flex">
                                                            ...
                                                            <button type="button" data-id="<?php echo $combTaxCount; ?>" class="btn btn--secondary ripplelink remove-combined-form--js ms-2" title="<?php echo Labels::getLabel('LBL_Remove', $adminLangId); ?>"><i class="ion-minus-round"></i></button>
                                                            <button type="button" class="btn btn--secondary ripplelink add-combined-form--js ms-2" title="<?php echo Labels::getLabel('LBL_Add', $adminLangId); ?>"><i class="ion-plus-round"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('click', '.add-combined-form--js', function(event) {
            ...
            combTaxCount++;
            var rowHtml = '<div class="col-md-12 combined-tax-row' + combTaxCount + '"><div class="field-set"><div class="field-wraper"><div class="field_cover d-flex"><input type="text" name="taxstr_component_name[' + combTaxCount + '][<?php echo $siteDefaultLangId; ?>]" value=""><button type="button" data-id="' + combTaxCount + '" class="btn btn--secondary ripplelink remove-combined-form--js ms-2" title="<?php echo Labels::getLabel('LBL_Remove', $adminLangId); ?>"><i class="ion-minus-round"></i></button><button type="button" class="btn btn--secondary ripplelink add-combined-form--js ms-2" title="<?php echo Labels::getLabel('LBL_Add', $adminLangId); ?>"><i class="ion-plus-round"></i></button></div></div></div></div>';
