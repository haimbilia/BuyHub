    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            ...
            case 'vendor':
                ...
                /* $txt .= '<br/><strong>'.Labels::getLabel('LBL_Phone',$adminLangId).':   </strong>'.$row['op_shop_owner_phone_dcode'] . $row['op_shop_owner_phone']; */
            ...
            case 'buyer_name':
                ...
                $txt .= '<br/><strong>' . Labels::getLabel('LBL_Phone', $adminLangId) . ':  </strong>' . $row['buyer_phone_dcode'] . $row['buyer_phone'];
                $td->appendElement('plaintext', array(), $txt, true);
                break;
