	...
	foreach ($arr_flds as $key=>$val){
		...
		switch ($key){
			...
			case 'buyer_detail':
				...
				$txt .= '<br/><strong>'.Labels::getLabel('LBL_P',$adminLangId).': </strong>'.$row['buyer_phone_dcode'] . $row['buyer_phone'];
			...
			case 'vendor_detail':
				...
				$txt .= '<br/><strong>'.Labels::getLabel('LBL_P',$adminLangId).': </strong>'.$row['seller_phone_dcode'] . $row['seller_phone'];
				$td->appendElement('plaintext', array(), $txt, true);
			break;
			case 'reuqest_detail':
