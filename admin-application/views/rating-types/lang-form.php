...
$langFld = $frm->getField('rtlang_lang_id');
$langFld->setfieldTagAttribute('onChange', "ratingTypesLangForm(" . $rt_id . ", this.value);");
?>
                ...
                <div class="tabs_nav_container responsive flat">
                    <ul class="tabs_nav">
                        <li><a href="javascript:void(0);"
                                onclick="ratingTypesForm(<?php echo $rt_id ?>);"><?php echo Labels::getLabel('LBL_General', $adminLangId); ?></a>
                        </li>
                        <li class="<?php echo (0 == $rt_id) ? 'fat-inactive' : ''; ?>">
                            ...
                            <div class="row justify-content-end"> 
                                <div class="col-auto mb-4">
                                    <input class="btn btn-brand" 
                                        ...
                                        onClick="ratingTypesLangForm(<?php echo $rt_id; ?>, <?php echo $rt_lang_id; ?>, 1)">
                                </div>
                            </div>
                        <?php } ?> 
