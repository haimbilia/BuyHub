         ...
         <div id="imageupload_div" class="padd15">
            ...
            <ul class="grids--onefifth ui-sortable" id="<?php if ($canEdit) { ?>sortable<?php } ?>">
                ...
                <li id="<?php echo $row['afile_id']; ?>">
                    <div class="logoWrap">
                        <div class="logothumb"> <img src="<?php echo UrlHelper::generateFileUrl('image', 'product', array($row['afile_record_id'], "THUMB",$row['afile_id']), CONF_WEBROOT_URL); ?>" title="<?php echo $row['afile_name'];?>"
